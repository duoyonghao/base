...
public class HaspStatus {
	...
	/**
	 * Input/Output error occurred in secure storage area of HASP SL key OR a USB
	 * error occurred when communicating with a HASP HL key
	 */
	...
	/**
	 * HASP SL key incompatible with machine hardware; HASP SL key is locked to
	 * different hardware. OR: In the case of a V2C file, conflict between HASP SL
	 * key data and machine hardware data; HASP SL key locked to different hardware
	 */
	...
	/**
	 * Trying to install a V2C file with an update counter that is out of sequence
	 * with the update counter on Sentinel HASP protection key. The update counter
	 * value in the V2C file is lower than the value in Sentinel HASP protection
	 * key.
	 */
	...
	/**
	 * Trying to install a V2C file with an update counter that is out of sequence
	 * with update counter in Sentinel HASP protection key. The first value in the
	 * V2C file is greater than the value in Sentinel HASP protection key.
	 */
	...
	/**
	 * Unknown Recipient; update can only be applied to the Recipient specified in
	 * detach(), and not to this computer
	 */
	...
	/**
	 * Extension of license not allowed as number of detached licenses is greater
	 * than current concurrency count
	 */
	public static final int HASP_EXTENSION_NOT_ALLOWED = 73;

	/**
	 * Detach of license not allowed as product contains VM disabled feature and
	 * host machine is a virtual machine
	 */
	public static final int HASP_DETACH_DISABLED = 74;

	/**
	 * Rehost of license not allowed as container contains VM disabled feature and
	 * host machine is a virtual machine
	 */
	public static final int HASP_REHOST_DISABLED = 75;

	/**
	 * Format SL-AdminMode or migrate SL-Legacy to SL-AdminMode not allowed as
	 * container has detached license
	 */
