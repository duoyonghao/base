...
public class KQDS_Ck_Goods_DetailAct
{
  ...
  public ModelAndView toGoodsgJ(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public String delleteGoodsYz(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String selectDetailAll(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
      ...
      for (String seqId : arr) {
        ...
        {
          KqdsCkGoodsDetail en = (KqdsCkGoodsDetail)this.logic.loadObjSingleUUID(TableNameUtil.KQDS_CK_GOODS_DETAIL, seqId);
          goodsname = goodsname + en.getGoodsname() + ",";
        }
      }
      ...
      if ((supplier == null) || (supplier.equals(""))) {
        if ((current != null) && (!current.equals("")) && (current.equals("1")))
        {
          ...
          for (int i = 0; i < list1.size(); i++) {
            if (i == list1.size() - 1) {
              str.append("'" + ((JSONObject)list1.get(i)).getString("seq_id") + "'");
            } else {
              str.append("'" + ((JSONObject)list1.get(i)).getString("seq_id") + "',");
            }
          }
          ...
          {
            JSONObject obj = (JSONObject)goodSupplierMap.get(good.get("seq_id"));
            String supplierId = "";
            String suppliername = "";
            if (obj != null)
            {
  ...
  public String selectGoodsDetailList(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
      ...
      List<JSONObject> list = jsonOb.getJSONArray("rows");
      if ((flag != null) && (flag.equals("exportTable")))
      {
  ...
  public String selectGoodsGjList(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String saveGoodsGjTx(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
