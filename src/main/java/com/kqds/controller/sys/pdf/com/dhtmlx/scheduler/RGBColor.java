...
public class RGBColor {
  static Hashtable<String, double[]> parsedColors = (Hashtable)new Hashtable<>();
  ...
  public static double[] getColor(String color) {
    ...
    result[0] = Integer.parseInt(r, 16) / 255.0D;
    result[1] = Integer.parseInt(g, 16) / 255.0D;
    result[2] = Integer.parseInt(b, 16) / 255.0D;
