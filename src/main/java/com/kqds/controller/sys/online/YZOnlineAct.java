...
public class YZOnlineAct
{
  ...
  public String cancelLogOut(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    YZUtility.DEAL_SUCCESS(null, null, response, this.logger);
    return null;
  ...
  public String checkOnline(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    YZUtility.DEAL_SUCCESS(null, null, response, this.logger);
    return null;
  ...
  public String getOnlineTree(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
      ...
      {
        JSONObject personinfo = (JSONObject)personList.get(x);
        loginTime = personinfo.getString("loginTime");
        seqId = personinfo.getString("seqId");
        String deptId = personinfo.getString("deptId");
        String sex = personinfo.getString("sex");
        userState = personinfo.getString("user_state");
      ...
      for (Object loginTime = personList.iterator(); ((Iterator)loginTime).hasNext();)
      {
        JSONObject person = (JSONObject)((Iterator)loginTime).next();
