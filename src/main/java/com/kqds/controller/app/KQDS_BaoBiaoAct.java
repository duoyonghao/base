    ...
    try {
      ...
      if (!YZUtility.isNullorEmpty(starttime)) {
        if (starttime.length() == 4) {
          starttime = String.valueOf(starttime) + "-01-01" + ConstUtil.TIME_START;
        } else if (starttime.length() == 7) {
          starttime = String.valueOf(starttime) + "-01" + ConstUtil.TIME_START;
        } else {
      ...
      if (!YZUtility.isNullorEmpty(endtime)) {
        if (endtime.length() == 4) {
          endtime = String.valueOf(endtime) + "-12-31" + ConstUtil.TIME_END;
        } else if (endtime.length() == 7) {
          endtime = String.valueOf(endtime) + "-01" + ConstUtil.TIME_START;
