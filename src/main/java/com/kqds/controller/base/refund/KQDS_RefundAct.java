...
public class KQDS_RefundAct
{
  ...
  public ModelAndView toCost_TkIndex(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView toTkSq(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    ModelAndView mv = new ModelAndView();
  ...
  public ModelAndView toTkSqEdit(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public ModelAndView toTkSqDetail(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    String refundId = request.getParameter("refundId");
    ...
    throws Exception
  {
    try
    {
      ...
      for (int i = 0; i < personlist.size(); i++) {
        PushUtil.saveTx4NewTuiFei((JSONObject)personlist.get(i), dp, request);
      }
  ...
  public String updateTk(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
      ...
      personlist = this.personLogic.getAllShowZjlPerson(ChainUtil.getCurrentOrganization(request), request);
      for (int i = 0; i < personlist.size(); i++) {
        PushUtil.saveTx4NewTuiFei((JSONObject)personlist.get(i), tkorder, request);
      }
      String listdata = request.getParameter("listDetail");
      JSONArray jArray = JSONArray.fromObject(listdata);
      Collection collection = JSONArray.toCollection(jArray, KqdsRefundDetail.class);
  ...
  public String yzTuiKuanJF(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
    ...
    throws Exception
  {
    try
    {
      ...
      List<KqdsRefund> en = (List)this.logic.loadList(TableNameUtil.KQDS_REFUND, map);
      if (en == null) {
      ...
      if (ConstUtil.REFUND_STATUS_4 == dp.getStatus().intValue())
      {
        ...
        PushUtil.saveTx4TuiFeiConfirm((KqdsRefund)en.get(0), person, request);
        ...
        for (Iterator localIterator1 = list.iterator(); localIterator1.hasNext(); localIterator2.hasNext())
        {
          ...
          localIterator2 = list1.iterator(); continue;jsonObject2 = (JSONObject)localIterator2.next();
      ...
      if ((ConstUtil.REFUND_STATUS_2 == dp.getStatus().intValue()) || (ConstUtil.REFUND_STATUS_3 == dp.getStatus().intValue()))
      {
        ...
        if (2 == dp.getStatus().intValue())
        {
          ...
          List<KqdsRefundDetail> list = (List)this.logic.loadList(TableNameUtil.KQDS_REFUND_DETAIL, map2);
        ...
        for (int i = 0; i < personlist.size(); i++) {
          PushUtil.saveTx4TuiFeiSH((JSONObject)personlist.get(i), person, request);
        }
      }
  ...
  private void setIntegralMoney(String costno, String usercode, String refundid, String perId, HttpServletRequest request)
    throws Exception
  {
    Map<String, String> map2 = new HashMap();
    map2.put("usercode", usercode);
    ...
    if (KqdsBigDecimal.compareTo(costIntegral, BigDecimal.ZERO) > 0)
    {
      ...
      List<KqdsRefundDetail> list = (List)this.logic.loadList(TableNameUtil.KQDS_REFUND_DETAIL, map);
  ...
  public void updateCostDetailType(String listdata, HttpServletRequest request)
    throws Exception
  {
    JSONArray jArray = JSONArray.fromObject(listdata);
    Collection collection = JSONArray.toCollection(jArray, KqdsRefundDetail.class);
  ...
  private BigDecimal realQfDetail(String qfbh)
    throws Exception
  {
  ...
  private String addOrder(String costno, BigDecimal tkje, String refundid, YZPerson person, HttpServletRequest request)
    throws Exception
  {
    KqdsCostorder tkorder = (KqdsCostorder)this.logic.loadObjSingleUUID(TableNameUtil.KQDS_COSTORDER, costno);
  ...
  private void addOrderDetail(String newcostno, String refundid, BigDecimal tkje, YZPerson person, HttpServletRequest request)
    throws Exception
  {
    Map<String, String> map = new HashMap();
    map.put("refundid", refundid);
    ...
    for (KqdsRefundDetail detail : list)
    {
      ...
      if (detail.getTknum().intValue() == 0) {
        orderdetail.setNum(0 - detail.getNum().intValue());
      } else {
        orderdetail.setNum(0 - detail.getTknum().intValue());
      }
  ...
  private void editQfStatus(String qfbh, HttpServletRequest request)
    throws Exception
  {
    Map<String, String> map = new HashMap();
    map.put("qfbh", qfbh);
  ...
  private void addPayOrder(String newcostno, String oldcostno, String refundid, BigDecimal tkje, YZPerson person, HttpServletRequest request)
    throws Exception
  {
    Map<String, String> map = new HashMap();
    map.put("costno", oldcostno);
    
    List<KqdsPaycost> listpay = (List)this.logic.loadList(TableNameUtil.KQDS_PAYCOST, map);
