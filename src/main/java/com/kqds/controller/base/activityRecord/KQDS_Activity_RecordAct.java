...
public class KQDS_Activity_RecordAct
{
    ...
    throws Exception
  {
    try
    {
      ...
      {
        this.logic.updateSingleUUID(TableNameUtil.KQDS_ACTIVITY_RECORD, dp);
      ...
      else
      {
        ...
        this.logic.saveSingleUUID(TableNameUtil.KQDS_ACTIVITY_RECORD, dp);
    ...
    throws Exception
  {
    try
    {
      ...
      KqdsActivityRecord en = (KqdsActivityRecord)this.logic.loadObjSingleUUID(TableNameUtil.KQDS_ACTIVITY_RECORD, seqId);
      this.logic.deleteSingleUUID(TableNameUtil.KQDS_ACTIVITY_RECORD, seqId);
    ...
    throws Exception
  {
    try
    {
      ...
      List<JSONObject> list = this.logic.selectNoPage(TableNameUtil.KQDS_ACTIVITY_RECORD, map, organization);
    ...
    throws Exception
  {
    ...
    try
    {
      response.setHeader("Content-Disposition", "attachment;filename=" + new String("模板.xls".getBytes(), "iso-8859-1"));
    }
    ...
    throws Exception
  {
    try
    {
      ...
      list = this.logic.selectTrscColumn(TableNameUtil.KQDS_ACTIVITY_RECORD, map);
    ...
    throws Exception
  {
    try
    {
      ...
      {
        KqdsActivityRecord actity = (KqdsActivityRecord)this.logic.loadObjSingleUUID(TableNameUtil.KQDS_ACTIVITY_RECORD, seqIdArr[i]);
