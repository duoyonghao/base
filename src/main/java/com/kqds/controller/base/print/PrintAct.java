...
public class PrintAct
{
  ...
  public String zhongZhiBingliPdf4Print(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public String bingLiPdf4Print(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    response.setContentType("application/pdf");
    try
  ...
  public String feiYongPdf4Print(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    response.setContentType("application/pdf");
    try
