...
public class UtilAct
{
  ...
  public String importArea(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String intTableHeader(HttpServletRequest request, HttpServletResponse response)
    throws IOException
  {
  ...
  public String changeUseFlag(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
