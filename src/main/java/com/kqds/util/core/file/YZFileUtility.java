...
public class YZFileUtility {
  ...
  private static void loadLine2Array(InputStream in, int startLine, int endLine, List<String> rtList, String charSet) throws Exception {
  ...
  public static void load2Map(String fileName, Map<String, String> rtMap) throws Exception {
    ArrayList<E> propList = new ArrayList();
