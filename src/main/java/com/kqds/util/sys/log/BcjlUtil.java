...
public class BcjlUtil
{
  ...
  public static void LogBcjl(String operName, String bcmc, Object jlcontent, String tableName, HttpServletRequest request)
    throws Exception
  {
    LogBcjlWithUserCodeAndRegno(operName, bcmc, jlcontent, null, null, true, tableName, request);
  }
  
  public static void LogBcjlWithUserCode(String operName, String bcmc, Object jlcontent, String userCode, String tableName, HttpServletRequest request)
    throws Exception
  {
    LogBcjlWithUserCodeAndRegno(operName, bcmc, jlcontent, userCode, null, true, tableName, request);
  }
  
  public static void LogBcjlWithUserCodeAndRegno(String operName, String bcmc, Object jlcontent, String userCode, String regno, boolean ifShow, String tableName, HttpServletRequest request)
    throws Exception
  {
    ...
    dp.setRegno(regno);
    dp.setBcmc(bcmc);
    dp.setLogtype(Integer.valueOf(0));
    dp.setIp(YZUtility.getIpAddr(request));
