...
public class BcjlUtil {
  ...
  public static void LogBcjlWithUserCodeAndRegno(String operName, String bcmc, Object jlcontent, String userCode, String regno, boolean ifShow, String tableName, HttpServletRequest request) throws Exception {
