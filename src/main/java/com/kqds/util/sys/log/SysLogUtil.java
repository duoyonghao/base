...
public class SysLogUtil
{
  ...
  public static void log(String operName, String bcmc, Object jlcontent, String tableName, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void logNoRequest(String operName, String bcmc, Object jlcontent, String tableName, YZPerson person, String ip, HttpSession session)
    throws Exception
  {
    KqdsBcjl dp = new KqdsBcjl();
  ...
  private static void insertIntoDB(String operName, String bcmc, Object jlcontent, String tableName, String ip, YZPerson person, HttpSession session, KqdsBcjl dp)
    throws Exception
  {
