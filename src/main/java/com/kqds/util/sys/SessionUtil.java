...
public class SessionUtil
{
  ...
  public static void setSysPara4UserLogin(HttpServletRequest request)
    throws Exception
  {
  ...
  public static void getCostField(HttpServletRequest request)
    throws Exception
  {
  ...
  public static void getMemberField(HttpServletRequest request)
    throws Exception
  {
  ...
  public static String getVisualstaff(HttpServletRequest request)
    throws Exception
  {
    return request.getSession().getAttribute("visualstaff").toString();
  }
  
  public static void setUserInfo4UserLogin(YZPerson person, HttpSession session, String ip, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void setHosInfo4UserLogin(HttpServletRequest request, HttpSession session, YZPerson person)
    throws Exception
  {
