...
public class BarcodeUtil {
  public static String generateBarCode128(String strBarCode, String dimension, String barheight) {
    try {
      ...
      JBarcode productBarcode = new JBarcode((BarcodeEncoder)Code128Encoder.getInstance(), WidthCodedPainter.getInstance(), EAN13TextPainter.getInstance());
  ...
  public static String generateBarCode(String strBarCode, String dimension, String barheight) {
    try {
      ...
      JBarcode productBarcode = new JBarcode((BarcodeEncoder)EAN13Encoder.getInstance(), WidthCodedPainter.getInstance(), EAN13TextPainter.getInstance());
