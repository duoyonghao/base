...
public class CacheUtil
{
  ...
  private static RedisTemplate redisTemplate = (RedisTemplate)CacheContextUtil.getBean("redisTemplate", RedisTemplate.class);
  private static StringRedisTemplate stringRedisTemplate = (StringRedisTemplate)CacheContextUtil.getBean("stringRedisTemplate", StringRedisTemplate.class);
  ...
  public static boolean del(String... key)
  {
    ...
    try
    {
      ...
      String[] arrayOfString = key;int j = key.length;
      for (int i = 0; i < j; i++)
      {
  ...
  public static <T> List<T> sortPageList(String key, String subKey, String by, boolean isDesc, boolean isAlpha, int off, int num)
    throws Exception
  {
    ...
    String str;
    for (Iterator localIterator = cks.iterator(); localIterator.hasNext(); str = (String)localIterator.next()) {}
    return result;
  }
