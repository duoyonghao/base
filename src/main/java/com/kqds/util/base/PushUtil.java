...
public class PushUtil
{
  ...
  private static void saveTx(String type, String receiver, String content, String url, String isnow, String pushtime, String organization)
    throws Exception
  {
  ...
  public static void saveTx4OutProcessingSheetBack(KqdsOutprocessingSheet en, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4OutProcessingSheetSubmit(KqdsOutprocessingSheet dp, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4OutProcessingSheetFG(KqdsOutprocessingSheet dp1, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4OutProcessingSheetNew(KqdsOutprocessingSheet en, JSONObject person, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4OutProcessingSheetEdit(KqdsOutprocessingSheet en, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4NewCostOrder(String receiver, HttpServletRequest request)
    throws Exception
  {
    saveTx("开单", receiver, "有一条新的开单记录,请注意收费", EMPTY_PUSH_URL, IS_NOW_PUSH_0, EMPTY_PUSH_TIME, ChainUtil.getCurrentOrganization(request));
  }
  
  public static void saveTx4NewExtension(String receiver, String visittime, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4ExtensionTimeOut(JSONObject extension)
    throws Exception
  {
  ...
  public static void saveTx4ModifyHosOrder(KqdsHospitalOrder dp, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4NewHosOrder(KqdsHospitalOrder dp, HttpServletRequest request)
    throws Exception
  {
    String pushurl = "/KQDS_Net_OrderAct/toYyzx2.act?doctors=" + dp.getAskperson() + "&regdept=" + dp.getRegdept();
  ...
  public static void saveTx4ModifyRoomOrder(KqdsRoom dp, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4NewRoomOrder(KqdsRoom dp, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4Jzqk(KqdsJzqk dp, KqdsReg reg, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void selectTx4NewVisit(KqdsVisit dp, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4NewVisit(KqdsVisit dp, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4ModifyVisit(KqdsVisit dp, HttpServletRequest request)
    throws Exception
  {
    deleteVistPushInfo(dp.getUsercode(), dp.getVisitor());
  ...
  public static void saveTx4VisitTimeOut(JSONObject visit)
    throws Exception
  {
  ...
  private static void deleteVistPushInfo(String usercode, String reciveuser)
    throws Exception
  {
    pushUtil.logic.deleteVistPushInfo(usercode, reciveuser);
  }
  
  public static void saveTx4MemberRefund(JSONObject zjl, YZPerson sqr, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4MemberSH(JSONObject caiwu, YZPerson zjl, HttpServletRequest request)
    throws Exception
  {
    String pushurl = "/KQDS_MemberAct/toember_TkList.act";
  ...
  public static void saveTx4MemberConfirm(KqdsMemberRecordSh dp, YZPerson zjl, HttpServletRequest request)
    throws Exception
  {
    String pushurl = "/KQDS_MemberAct/toember_TkList.act";
  ...
  public static void saveTx4PayCost(KqdsPaycost dp, HttpServletRequest request)
    throws Exception
  {
    String pushurl = "";
  ...
  public static void saveTx4TuiFeiConfirm(KqdsRefund dp, YZPerson zjl, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4TuiFeiSH(JSONObject sfr, YZPerson zjl, HttpServletRequest request)
    throws Exception
  {
    String pushurl = "/KQDS_RefundAct/toCost_TkList.act";
  ...
  public static void saveTx4NewTuiFei(JSONObject zjl, KqdsRefund dp, HttpServletRequest request)
    throws Exception
  {
    String pushurl = "/KQDS_RefundAct/toCost_TkList.act";
  ...
  public static void saveTx4NewReg(KqdsReg dp, HttpServletRequest request)
    throws Exception
  {
  ...
  public static void saveTx4ModifyReg(KqdsReg dp, String regsortname, HttpServletRequest request)
    throws Exception
  {
    if (!YZUtility.isNullorEmpty(dp.getAskperson())) {
  ...
  public static void saveTx4CKTopAlarm(YZPerson dp, String alarmContent, String organization)
    throws Exception
  {
    saveTx("库存报警", dp.getSeqId(), alarmContent, EMPTY_PUSH_URL, IS_NOW_PUSH_0, EMPTY_PUSH_TIME, organization);
  }
  
  public static void saveTx4CKDownAlarm(YZPerson dp, String alarmContent, String organization)
    throws Exception
  {
    saveTx("库存报警", dp.getSeqId(), alarmContent, EMPTY_PUSH_URL, IS_NOW_PUSH_0, EMPTY_PUSH_TIME, organization);
  }
