...
public class UserCodeUtil {
  ...
  public static String getUserCode(String organization) throws Exception {
    ...
    num++;
    if (num < 10) {
      numstr = String.valueOf(organization) + "00000" + num;
    } else if (num > 9 && num < 100) {
      numstr = String.valueOf(organization) + "0000" + num;
    } else if (num > 99 && num < 1000) {
      numstr = String.valueOf(organization) + "000" + num;
    } else if (num > 999 && num < 10000) {
      numstr = String.valueOf(organization) + "00" + num;
    } else if (num > 9999 && num < 100000) {
      numstr = String.valueOf(organization) + "0" + num;
    } else if (num > 99999) {
      numstr = String.valueOf(organization) + num;
    } 
    return numstr;
  }
