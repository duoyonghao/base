...
public class YZSysProps
{
  ...
  {
    return getString("rootDir") + File.separator + getString("webRootDir") + File.separator + getString("jspRootDir");
  }
  
  public static String getWebInfPath()
  {
    return getString("rootDir") + File.separator + getString("webRootDir") + File.separator + getString("jspRootDir") + File.separator + "WEB-INF";
  }
  ...
  public static String getUploadCatchPath()
  {
    ...
    if (cachPath == null) {
      cachPath = getString("rootDir") + File.separator + "catch";
    }
  ...
  public static String getAttachPath()
  {
    ...
    if (attachPath == null) {
      attachPath = getString("rootDir") + File.separator + "attach";
    }
    if ((attachPath.indexOf(":") == 1) || (attachPath.indexOf("/") == 0)) {
      return attachPath;
    }
    attachPath = getString("rootDir") + File.separator + attachPath;
    return attachPath;
  }
