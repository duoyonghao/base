...
{
  public static DataTableEntity getDataTableEntity(ResultSet rs, boolean isLowerCase)
    throws Exception
  {
  ...
  public static Object getColumnValByIndex(ResultSet rs, int dbType, int i)
    throws Exception
  {
    Object value = null;
