...
public class YZPerson {
  ...
  public String toString() {
    return "YZPerson [seqId=" + this.seqId + ", userId=" + this.userId + ", userName=" + this.userName + ", password=" + this.password + 
      ", userPriv=" + this.userPriv + ", deptId=" + this.deptId + ", userNo=" + this.userNo + ", notLogin=" + this.notLogin + 
      ", isLeave=" + this.isLeave + ", createtime=" + this.createtime + ", createuser=" + this.createuser + ", sex=" + this.sex + 
      ", lastVisitTime=" + this.lastVisitTime + ", myStatus=" + this.myStatus + ", recordaccount=" + this.recordaccount + 
      ", recordpwd=" + this.recordpwd + ", deptIdOther=" + this.deptIdOther + ", userPrivOther=" + this.userPrivOther + 
