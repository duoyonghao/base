...
public class KqdsMachiningRepairType
  implements Serializable
{
  ...
  public String toString()
  {
    return 
      ...
      "KqdsMachiningRepairType [seqId=" + this.seqId + ", toothId=" + this.toothId + ", typeOne=" + this.typeOne + ", typeOneName=" + this.typeOneName + ", typeSecond=" + this.typeSecond + ", typeSecondName=" + this.typeSecondName + ", organization=" + this.organization + ", createuser=" + this.createuser + ", createtime=" + this.createtime + ", remark=" + this.remark + "]";
  }
