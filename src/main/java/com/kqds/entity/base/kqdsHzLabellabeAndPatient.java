...
public class kqdsHzLabellabeAndPatient
  implements Serializable
{
  ...
  public String toString()
  {
    return 
      ...
      "kqdsHzLabellabeAndPatient [seqId=" + this.seqId + ", labelOneId=" + this.labelOneId + ", labelOneName=" + this.labelOneName + ", labelTwoId=" + this.labelTwoId + ", labelTwoName=" + this.labelTwoName + ", labelThreeId=" + this.labelThreeId + ", labelThreeName=" + this.labelThreeName + ", userSeqId=" + this.userSeqId + ", userId=" + this.userId + ", userName=" + this.userName + ", createUser=" + this.createUser + ", createTime=" + this.createTime + ", remark=" + this.remark + ", status=" + this.status + ", opinion=" + this.opinion + ", reservedth=" + this.reservedth + ", reservedf=" + this.reservedf + ", organization=" + this.organization + "]";
  }
}
