...
public class KqdsCkGoods {
  ...
  public String toString() {
    return "KqdsCkGoods [seqId=" + this.seqId + ", goodsdetailid=" + this.goodsdetailid + ", sshouse=" + this.sshouse + 
      ", goodsprice=" + this.goodsprice + ", nums=" + this.nums + ", numsexport=" + this.numsexport + ", goodspriceexport=" + 
      this.goodspriceexport + ", organization=" + this.organization + ", kcmoney=" + this.kcmoney + "]";
  }
}
