...
public class KqdsMachiningRecord
  implements Serializable
{
  ...
  public String toString()
  {
    return 
      ...
      "KqdsMachiningRecord [seqId=" + this.seqId + ", worksheetId=" + this.worksheetId + ", orderNumber=" + this.orderNumber + ", systemNumber=" + this.systemNumber + ", userCode=" + this.userCode + ", userName=" + this.userName + ", status=" + this.status + ", operationalContext=" + this.operationalContext + ", createuser=" + this.createuser + ", createtime=" + this.createtime + ", material=" + this.material + ", remark=" + this.remark + "]";
  }
}
