...
public class KqdsCkGoodsInDetail {
  ...
  public String toString() {
    return "KqdsCkGoodsInDetail [seqId=" + this.seqId + ", goodsuuid=" + this.goodsuuid + ", inprice=" + this.inprice + ", innum=" + 
      this.innum + ", yxdate=" + this.yxdate + ", sqremark=" + this.sqremark + ", incode=" + this.incode + ", organization=" + 
      this.organization + ", createuser=" + this.createuser + ", createtime=" + this.createtime + ", rkmoney=" + this.rkmoney + 
      ", ph=" + this.ph + ", zczh=" + this.zczh + ", cd=" + this.cd + ", goodsInSeqId=" + this.goodsInSeqId + ", auditStatus=" + 
      this.auditStatus + ", phnum=" + this.phnum + ", goodsId=" + this.goodsId + ", updateuser=" + this.updateuser + 
      ", updatetime=" + this.updatetime + ", beforeph=" + this.beforeph + "]";
  }
}
