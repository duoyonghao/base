...
public class KqdsCommunicationRecord implements Serializable {
  ...
  public String toString() {
    return "CommunicationRecord [seqId=" + this.seqId + ", content=" + this.content + ", status=" + this.status + ", organization=" + 
      this.organization + ", createuser=" + this.createuser + ", createtime=" + this.createtime + ", remark=" + this.remark + 
      "]";
  }
}
