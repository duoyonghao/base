  ...
  implements Serializable
{
  ...
  public String toString()
  {
    return 
      ...
      "KqdsUserdocument [seqId=" + this.seqId + ", usercode=" + this.usercode + ", username=" + this.username + ", sex=" + this.sex + ", birthday=" + this.birthday + ", age=" + this.age + ", profession=" + this.profession + ", idcardno=" + this.idcardno + ", phonenumber1=" + this.phonenumber1 + ", phonenumber2=" + this.phonenumber2 + ", guider=" + this.guider + ", userimpress=" + this.userimpress + ", introducer=" + this.introducer + ", platenumber=" + this.platenumber + ", costlevel=" + this.costlevel + ", dress=" + this.dress + ", firstword=" + this.firstword + ", province=" + this.province + ", city=" + this.city + ", address=" + this.address + ", devchannel=" + this.devchannel + ", createtime=" + this.createtime + ", createuser=" + this.createuser + ", askperson=" + this.askperson + ", isdelete=" + this.isdelete + ", organization=" + this.organization + ", medicalhistory=" + this.medicalhistory + ", drugllergy=" + this.drugllergy + ", remark=" + this.remark + ", experience=" + this.experience + ", habit=" + this.habit + ", email=" + this.email + ", type=" + this.type + ", xueli=" + this.xueli + ", qq=" + this.qq + ", doctor=" + this.doctor + ", important=" + this.important + ", nexttype=" + this.nexttype + ", totalpay=" + this.totalpay + ", developer=" + this.developer + ", doorstatus=" + this.doorstatus + ", glr=" + this.glr + ", glrremark=" + this.glrremark + ", xgr=" + this.xgr + ", xgtime=" + this.xgtime + ", town=" + this.town + ", area=" + this.area + ", invoice=" + this.invoice + ", kefu=" + this.kefu + ", usersort=" + this.usersort + ", openid=" + this.openid + ", bindstatus=" + this.bindstatus + ", pym=" + this.pym + ", integral=" + this.integral + ", blcode=" + this.blcode + ", barcode=" + this.barcode + ", iscreateLclj=" + this.iscreateLclj + ", accepttool=" + this.accepttool + ", familyship=" + this.familyship + ", hobby=" + this.hobby + ", activity=" + this.activity + ", introduce=" + this.introduce + ", clipAddress=" + this.clipAddress + ", nation=" + this.nation + ", certOrg=" + this.certOrg + ", effDate=" + this.effDate + ", expDate=" + this.expDate + "]";
  }
}
