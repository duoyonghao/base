...
public class KqdsMachiningType implements Serializable {
  ...
  public String toString() {
    return "KqdsMachiningType [seqId=" + this.seqId + ", typename=" + this.typename + ", parentId=" + this.parentId + ", isCategory=" + 
      this.isCategory + ", createuser=" + this.createuser + ", createtime=" + this.createtime + ", useflag=" + this.useflag + 
      ", organization=" + this.organization + ", remark=" + this.remark + "]";
  }
}
