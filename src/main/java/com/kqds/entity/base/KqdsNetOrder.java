...
public class KqdsNetOrder {
  ...
  public void setAccepttool(String accepttool) {
    this.accepttool = (accepttool == null) ? null : accepttool.trim();
  }
  ...
  public void setJzxx(String jzxx) {
    this.jzxx = (jzxx == null) ? null : jzxx.trim();
  }
  ...
  public String getDaoyi() {
    return this.daoyi;
  }
  
  public void setDaoyi(String daoyi) {
    this.daoyi = (daoyi == null) ? null : daoyi.trim();
  }
