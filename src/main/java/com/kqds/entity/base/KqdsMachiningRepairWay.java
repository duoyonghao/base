...
public class KqdsMachiningRepairWay implements Serializable {
  ...
  public String toString() {
    return "KqdsMachiningRepairWay [seqId=" + this.seqId + ", worksheetId=" + this.worksheetId + ", upleftTooth=" + 
      this.upleftTooth + ", leftLowerTooth=" + this.leftLowerTooth + ", upperRightTooth=" + this.upperRightTooth + 
      ", lowRightTooth=" + this.lowRightTooth + ", organization=" + this.organization + ", createuser=" + this.createuser + 
