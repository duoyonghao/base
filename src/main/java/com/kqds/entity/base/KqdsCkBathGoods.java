...
public class KqdsCkBathGoods implements Serializable {
  ...
  public String toString() {
    return "KqdsCkBathGoods [seqId=" + this.seqId + ", sshouse=" + this.sshouse + ", goodsprice=" + this.goodsprice + ", nums=" + 
      this.nums + ", numsexport=" + this.numsexport + ", goodspriceexport=" + this.goodspriceexport + ", organization=" + 
      this.organization + ", kcmoney=" + this.kcmoney + ", goodsdetailid=" + this.goodsdetailid + ", goodsname=" + 
      this.goodsname + ", goodscode=" + this.goodscode + ", goodstype=" + this.goodstype + ", goodsnorms=" + this.goodsnorms + 
      ", goodsunit=" + this.goodsunit + ", createuser=" + this.createuser + ", createtime=" + this.createtime + ", sortno=" + 
      this.sortno + ", kuwei=" + this.kuwei + ", remark=" + this.remark + ", minnums=" + this.minnums + ", mingj=" + this.mingj + 
      ", maxnums=" + this.maxnums + ", maxgj=" + this.maxgj + ", pym=" + this.pym + "]";
  }
