...
public class MsgPushTask implements Job {
  ...
  public void doTask() throws Exception {
    ...
    for (Map.Entry<String, Session> entry : (Iterable<Map.Entry<String, Session>>)Online_User_List.Websockt_Session_MAP.entrySet()) {
      ...
      logger.debug(String.valueOf(userId) + "推送成功，推送内容" + pushText);
