...
public class YZOnlineLogic
{
  ...
  public boolean isLogin(String userTmpId)
    throws Exception
  {
    int count = 0;
    for (Entry<String, HttpSession> entry : SessionUtil.Session_MAP.entrySet())
  ...
  public void addOnline(YZPerson person, String sessionToken, HttpSession session, HttpServletRequest request)
    throws Exception
  {
