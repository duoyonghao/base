...
public class YZDeptLogic extends BaseLogic {
  ...
  public JSONObject getOneByNameAndCode(String deptName, String deptCode) throws Exception {
    ...
    return (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".getOneByNameAndCode", json);
  }
  ...
  public List<JSONObject> getDeptSeqIdByTypeAndOrg(String organization, String dept_types) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getDeptSeqIdByTypeAndOrg", json);
    return list;
  }
  
  public List<YZDept> getHosList(String organization) throws Exception {
    List<YZDept> list = (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getHosList", organization);
    return list;
  }
  
  public String getAllDeptIds() throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getAllDeptIds", null);
  ...
  public String getCurrHosDeptIds(YZDept dept) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getCurrHosDeptIds", organization);
    StringBuffer bf = new StringBuffer();
    for (JSONObject dp : list)
      bf.append(dp.getString("seq_id")).append(","); 
    return bf.toString();
  ...
  public int deleteBySeqIds(String seqids, HttpServletRequest request) throws Exception {
    ...
    int count = ((Integer)this.dao.delete(String.valueOf(TableNameUtil.SYS_DEPT) + ".deleteBySeqIds", idList)).intValue();
  ...
  public int countByDeptCode(YZDept dept) throws Exception {
    ...
    int num = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".countByDeptCode", json)).intValue();
    return num;
  }
  ...
  public int countByDeptNameCurrHos(YZDept dept) throws Exception {
    ...
    json.put("seqId", dept.getSeqId());
    int num = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".countByDeptNameCurrHos", json)).intValue();
    return num;
  }
  
  public List<YZDept> getDeptListBySeqIds(String seqIds) throws Exception {
    List<String> idList = YZUtility.ConvertString2List(seqIds);
    List<YZDept> deptlist = (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getDeptListBySeqIds", idList);
    return deptlist;
  }
  ...
  public List<YZDept> getSubDeptListBySeqId(String deptParent, String organization) throws Exception {
    ...
    json.put("organization", organization);
    List<YZDept> deptlist = (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getSubDeptListBySeqId", json);
    return deptlist;
  }
  ...
  public List<YZDept> getSubOrgDeptListBySeqId(String deptParent, String organization, String depttype) throws Exception {
    ...
    List<YZDept> deptlist = (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getSubOrgDeptListBySeqId", json);
    return deptlist;
  }
  
  public boolean IsHaveChild(String deptParent) throws Exception {
    int count1 = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".IsHaveChild", deptParent)).intValue();
    return (count1 > 0);
  }
  
  public boolean IsHaveChildPerson(String id) throws Exception {
    int count1 = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".IsHaveChild", id)).intValue();
    int count2 = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".IsHaveChildPerson", id)).intValue();
  ...
  public void getSelectDeptTreeJson(String deptParent, StringBuffer sb, int level, String organization) throws Exception {
    ...
    json.put("deptParent", deptParent);
    json.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getSelectDeptTreeJson", json);
  ...
  public void getSelectDeptTreeJsonPaiban(String deptParent, StringBuffer sb, int level, String organization) throws Exception {
    ...
    if (deptParent.length() == 36)
      json.put("deptType", deptType); 
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getSelectDeptTreeJsonPaiban", json);
    for (int i = 0; i < list.size(); i++) {
      String flag = "&nbsp;├";
      if (i == list.size() - 1)
        flag = "&nbsp;└"; 
  ...
  public String getTopDeptName(String deptcode) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getTopDeptName", deptcode);
  ...
  public List<YZDept> getDeptListByDeptType(String dept_types, String organization) throws Exception {
    ...
    for (i = (arrayOfString1 = typeArr).length, b = 0; b < i; ) {
      String deptType = arrayOfString1[b];
      if (!YZUtility.isNullorEmpty(deptType)) {
        JSONObject json = new JSONObject();
        json.put("deptType", deptType);
        json.put("organization", organization);
        List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getDeptListByDeptType", json);
    ...
    List<String> idlist = new ArrayList<>(seqIdSet);
  ...
  public List<YZDept> getAllDeptByOrganization(String organization) throws Exception {
    ...
    List<YZDept> list = (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getAllDeptByOrganization", map);
    return list;
  }
  ...
  public String getDeptNamesBySeqIds(String ids) throws Exception, Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getDeptNamesBySeqIds", idList);
    for (JSONObject job : list) {
  ...
  public YZDept getTopDeptByCode(String deptcode) throws Exception {
    List<YZDept> list = (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getTopDeptByCode", deptcode);
    if (list == null || list.size() == 0)
      return new YZDept(); 
    return list.get(0);
  }
  ...
  public YZDept getDeptByTypeAndName(String deptType, String deptName) throws Exception {
    ...
    json.put("deptType", deptType);
    json.put("deptName", deptName);
    List<YZDept> list = (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getDeptByTypeAndName", json);
    if (list == null || list.size() == 0)
      return new YZDept(); 
    return list.get(0);
  }
  ...
  public String getMaxDeptNO(String organization) throws Exception {
    JSONObject json = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".getMaxDeptNO", organization);
    if (json == null)
      return "1"; 
  ...
  public List<JSONObject> findMarket(String marketing) throws Exception {
    ...
    return (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".findMarket", map);
  }
  
  public List<JSONObject> selectBeanListByMap(String s) throws Exception {
    Map<String, String> map = new HashMap<>();
    map.put("s", s);
    return (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getSelectByseqId", map);
  }
  ...
  public YZDept findmarketing(String isyx, String depttype, String shouli) throws Exception {
    ...
    return (YZDept)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".findmarketing", map);
  }
  
  public List<JSONObject> findDeptByDeptType(Map<String, String> map) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".findDeptByDeptType", map);
    return list;
  }
  
  public List<JSONObject> findAllDeptByDeptType(String organization) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".findAllDeptByDeptType", organization);
    return list;
  }
  
  public JSONObject findDeptNameBySeqId(String seqId) throws Exception {
    JSONObject deptName = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_DEPT) + ".findDeptNameBySeqId", seqId);
    return deptName;
  }
  
  public List<YZDept> findDeptList(Map<String, String> map) throws Exception {
    return (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".findDeptList", map);
  }
  
  public List<YZDict> getListALL(Map<String, String> map) throws Exception {
    return (List<YZDict>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".findDeptListAll", map);
  }
  
  public List<YZDept> getSelectOrganization() throws Exception {
    return (List<YZDept>)this.dao.findForList(String.valueOf(TableNameUtil.SYS_DEPT) + ".getSelectOrganization", null);
  }
  ...
  public String getDeptSeqIdByUserSeqIdAndOrganization(String askperson, String organization) throws Exception {
    ...
    map.put("organization", organization);
    JSONObject person = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.SYS_PERSON) + ".getDeptSeqIdByUserSeqIdAndOrganization", map);
