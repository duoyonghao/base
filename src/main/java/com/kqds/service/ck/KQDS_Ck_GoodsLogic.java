...
public class KQDS_Ck_GoodsLogic extends BaseLogic {
  ...
  public JSONObject selectNoHouseListSfc(String table, Map<String, String> map, BootStrapPage bp, JSONObject json, String organization) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_DETAIL) + ".selectNoHouseListSfc", map);
  ...
  public JSONObject selectListSfc(String table, Map<String, String> map, BootStrapPage bp, JSONObject json, String organization) throws Exception {
    ...
    json.put("sort", sort);
    PageHelper.offsetPage(bp.getOffset(), bp.getLimit());
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_DETAIL) + ".selectListSfc", map);
  ...
  public int rkNumsWithOneTime(String sshouse, String goodsuuid, String starttime, String organization) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_IN) + ".rkNumsWithOneTime", jobj);
  ...
  public BigDecimal rkMoneyWithOneTime(String sshouse, String goodsuuid, String starttime, String organization) throws Exception {
    ...
    jobj.put("sshouse", sshouse);
    jobj.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_IN) + ".rkMoneyWithOneTime", jobj);
    if (list != null && list.size() > 0) {
  ...
  public int rkNums(String sshouse, String goodsuuid, String starttime, String endtime, String organization) throws Exception {
    ...
    jobj.put("sshouse", sshouse);
    jobj.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_IN) + ".rknums", jobj);
    if (list != null && list.size() > 0)
      rknums = YZUtility.isNullorEmpty(((JSONObject)list.get(0)).getString("rknums")) ? 0 : ((JSONObject)list.get(0)).getInt("rknums"); 
    return rknums;
  }
  ...
  public BigDecimal rkMoney(String sshouse, String goodsuuid, String starttime, String endtime, String organization) throws Exception {
    ...
    jobj.put("sshouse", sshouse);
    jobj.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_IN) + ".rkmoney", jobj);
    if (list != null && list.size() > 0) {
      JSONObject json = list.get(0);
      String d = YZUtility.isNullorEmpty(json.getString("rkmoney")) ? "0.00" : json.getString("rkmoney");
      rkmoney = new BigDecimal(d);
  ...
  public int ckNumsWithOneTime(String sshouse, String goodsuuid, String starttime, String organization) throws Exception {
    ...
    jobj.put("sshouse", sshouse);
    jobj.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_OUT) + ".ckNumsWithOneTime", jobj);
    if (list != null && list.size() > 0)
      rknums = YZUtility.isNullorEmpty(((JSONObject)list.get(0)).getString("rknums")) ? 0 : ((JSONObject)list.get(0)).getInt("rknums"); 
    return rknums;
  }
  ...
  public BigDecimal ckMoneyWithOneTime(String sshouse, String goodsuuid, String starttime, String organization) throws Exception {
    ...
    jobj.put("sshouse", sshouse);
    jobj.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_OUT) + ".ckMoneyWithOneTime", jobj);
    if (list != null && list.size() > 0) {
      JSONObject json = list.get(0);
  ...
  public int ckNums(String sshouse, String goodsuuid, String starttime, String endtime, String organization) throws Exception {
    ...
    jobj.put("sshouse", sshouse);
    jobj.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_OUT) + ".cknums", jobj);
    if (list != null && list.size() > 0)
      rknums = YZUtility.isNullorEmpty(((JSONObject)list.get(0)).getString("rknums")) ? 0 : ((JSONObject)list.get(0)).getInt("rknums"); 
    return rknums;
  }
  ...
  public BigDecimal ckMoney(String sshouse, String goodsuuid, String starttime, String endtime, String organization) throws Exception {
    ...
    jobj.put("sshouse", sshouse);
    jobj.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS_OUT) + ".ckmoney", jobj);
    if (list != null && list.size() > 0) {
      JSONObject json = list.get(0);
      String d = YZUtility.isNullorEmpty(json.getString("ckmoney")) ? "0.00" : json.getString("ckmoney");
      ckmoney = new BigDecimal(d);
  ...
  public void updateCkGoodsByGoodsno(KqdsCkGoods dp) throws Exception {
    this.dao.update(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".updateCkGoodsByGoodsno", dp);
  }
  
  public KqdsCkGoods findCkGoodsByDetailid(String detailid) throws Exception {
    KqdsCkGoods kqdsCkGoods = (KqdsCkGoods)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".findCkGoodsByDetailid", detailid);
    return kqdsCkGoods;
  }
  
  public int ckNums1(String goodsuuid) throws Exception {
    int i = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".cknums", goodsuuid)).intValue();
    return i;
  }
  
  public int ckNums2(String goodsuuid) throws Exception {
    int i = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".cknum", goodsuuid)).intValue();
    return i;
  }
  
  public void updatetCkByKsllReplaceMent(List<KqdsCkGoods> list) throws Exception {
    this.dao.batchUpdate(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".updatetCkByKsllReplaceMent", list);
  }
  
  public void updatetCkByKsllReplaceMents(List<KqdsCkGoods> list) throws Exception {
    this.dao.batchUpdate(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".updatetCkByKsllReplaceMents", list);
  }
  ...
  public List<JSONObject> findAllCkGoodsByGoodscode(String goodscode, String organization) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".findAllCkGoodsByGoodscode", map);
    return list;
  }
  
  public JSONObject getNumber(Map<String, String> map) throws Exception {
    return (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_CK_GOODS_DETAIL) + ".getNumber", map);
  }
  
  public String getTypeName(Map<String, String> map) throws Exception {
    JSONObject jsonObject = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_CK_GOODS_TYPE) + ".findHouse", map);
  ...
  public void unallowable(Map<String, String> map) throws Exception {
    this.dao.update(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".unallowable", map);
  }
  
  @Transactional
  public JSONObject findGoodsById(String seqId) throws Exception {
    return (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_CK_GOODS) + ".findGoodsById", seqId);
  }
}
