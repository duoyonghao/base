                    ...
                    for (JSONObject jsonObject : list) {
                        for (JSONObject jsonObject1 : nameList) {
                            if (jsonObject.getString("usercode").equals(jsonObject1.getString("usercode"))) {
                                ...
                                if (!YZUtility.isNullorEmpty(jsonObject1.getString("uid"))) {
                                    jsonObject.put("uid", jsonObject1.getString("uid"));
                                }
                                jsonObject.put("kefu", jsonObject1.getString("kefu"));
                                jsonObject.put("kefuname", jsonObject1.getString("kefuname"));
                                jsonObject.put("contagion", jsonObject1.getString("contagion"));
                            }
                        }
                    }
                }
