...
public class KQDS_BCJLLogic extends BaseLogic {
  ...
  public JSONObject selectWithPage(String table, BootStrapPage bp, Map<String, String> map) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_BCJL) + ".selectWithPage", map);
  ...
  public List<JSONObject> selectWithPageLzjl(String table, Map<String, String> map) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_BCJL) + ".selectWithPageLzjl", map);
    return list;
  }
  
  public List<JSONObject> getListByJlName(String jlNmae) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_BCJL) + ".getListByJlName", jlNmae);
    return list;
  }
}
