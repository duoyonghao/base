...
public class KQDS_UserDocumentLogic extends BaseLogic {
  ...
  public int getMaxBlcode(String table) throws Exception {
    int maxblcode = 0;
    String blcode = "";
    JSONObject json = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getmaxblcode", blcode);
  ...
  public KqdsUserdocument getSingUserByPhoneNumber(String phonenumber) throws Exception {
    ...
    KqdsUserdocument user = (KqdsUserdocument)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getSingUserByPhoneNumber", phonenumber);
    return user;
  }
  
  public JSONObject getSingUserNameAndCodeByPhoneNumber(String phonenumber) throws Exception {
    phonenumber = YZAuthenticator.encryKqdsPhonenumber(phonenumber);
    JSONObject json = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getSingUserNameAndCodeByPhoneNumber", phonenumber);
    return json;
  }
  
  public List<JSONObject> selectNoPymList(Connection conn) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectNoPymList", null);
    return list;
  }
  ...
  public void setUserDocAskPerson(HttpServletRequest request, String usercode, String askperson) throws Exception {
    ...
    List<KqdsUserdocument> userlist = (List<KqdsUserdocument>)this.dao.loadList(TableNameUtil.KQDS_USERDOCUMENT, map);
  ...
  public KqdsUserdocument getSingleUserByUsercode(String usercode) throws Exception {
    ...
    map.put("usercode", usercode);
    map.put("isdelete", "0");
    List<KqdsUserdocument> list = (List<KqdsUserdocument>)this.dao.loadList(TableNameUtil.KQDS_USERDOCUMENT, map);
  ...
  public JSONObject getBaseUserInfoByUsercode(String userCode) throws Exception {
    ...
    for (JSONObject mobj : mlist) {
      ...
      if (YZUtility.isNullorEmpty(discountdate)) {
        ...
        if ((new Date()).getTime() <= sdf.parse(String.valueOf(discountdate) + " 23:59:59").getTime())
          flag = true; 
      } 
      if (Integer.parseInt(discountStr) < discount && flag)
        discount = Integer.parseInt(discountStr); 
    } 
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getBaseUserInfoByUsercode", userCode);
    if (list.size() == 0)
    ...
    if (userinfo.get("hobby") != null) {
      ...
      for (int i = 0; i < hobbyArray.length; i++) {
        ...
        if (json == null)
          break; 
        hobbyName = String.valueOf(hobbyName) + json.get("dictName").toString() + ";";
      } 
    ...
    List<kqdsHzLabellabeAndPatient> findForList = (List<kqdsHzLabellabeAndPatient>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_Hz_LabellabeAndPatient) + ".findLabelList", userCode);
    userinfo.put("labelList", findForList);
    return userinfo;
  }
  
  public int countByUserCode(String userCode) throws Exception {
    int count = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".countByUserCode", userCode)).intValue();
    return count;
  }
  
  public String selectDoctorByusercode(String table, String usercode) throws Exception {
    String doctor = "";
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectDoctorByusercode", usercode);
    if (list != null && list.size() > 0)
  ...
  public String selectusercodeByusername(String table, String username) throws Exception {
    String usercode = "";
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectusercodeByusername", username);
    if (list != null && list.size() > 0)
  ...
  public List<JSONObject> getMaxUserCode(String table, String organization) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getMaxUserCode", organization);
    return list;
  }
  ...
  public List<JSONObject> selectWithNopage(String table, Map<String, String> map, String typechoose, String visualstaff, YZPerson person) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithNopage", map);
  ...
  public List<JSONObject> selectWithNopageReg(String table, Map<String, String> map, String typechoose, String visualstaff, YZPerson person) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithNopageReg", map);
    return list;
  }
  ...
  public List<JSONObject> selectWithNopageGh(String table, Map<String, String> map) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithNopageGh", map);
    return list;
  }
  ...
  public JSONObject selectWithNopageGhLike(String table, Map<String, String> map, BootStrapPage bp) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithNopageGhLike", map);
  ...
  public List<JSONObject> selectWithNopageGhPermission(String table, Map<String, String> map) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithNopageGhPermission", map);
    return list;
  }
  
  public List<JSONObject> selectByUserCodes(String table, String usercodes) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectByUserCodes", usercodes);
    return list;
  }
  ...
  public JSONObject selectWithNopage2(BootStrapPage bp, String table, String visualstaff, Map<String, String> map, String organization, JSONObject json, String flag) throws Exception {
    ...
    if (flag != null && flag.equals("exportTable")) {
      List<JSONObject> list1 = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithNopage3", map);
      for (JSONObject job : list1) {
      ...
      PageInfo<JSONObject> pageInfo1 = new PageInfo(list1);
      JSONObject jSONObject = new JSONObject();
      jSONObject.put("total", Long.valueOf(pageInfo1.getTotal()));
      jSONObject.put("rows", list1);
      return jSONObject;
    } 
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithNopage2", map);
    ...
    if (str.length() > 0) {
      ...
      List<JSONObject> areaList = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findAreaByUsercode", map1);
      if (areaList.size() > 0)
        for (JSONObject jsonObject : list) {
      ...
      List<JSONObject> nameList = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findXxcxNameByUsercode", map1);
      if (nameList.size() > 0)
        for (JSONObject jsonObject : list) {
  ...
  public int checkIdcardnoBySeqIdAndIdcardno(Map<String, String> map, String table) throws Exception {
    int num = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".checkIdcardnoBySeqIdAndIdcardno", map)).intValue();
    return num;
  }
  ...
  public int checkphonenumber(String seqId, Map<String, String> map, String table) throws Exception {
    ...
    int num = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".checkphonenumber", map)).intValue();
    return num;
  }
  ...
  public List<KqdsUserdocument> selectUserdocumentByPhonenumber(String phoneNumber) throws Exception {
    ...
    List<KqdsUserdocument> list = (List<KqdsUserdocument>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectUserdocumentByPhonenumber", dataMap);
    return list;
  }
  ...
  public int checkBlcode(String seqId, String blcode, String table) throws Exception {
    ...
    int num = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".checkBlcode", map)).intValue();
    return num;
  }
  ...
  public int updateUserName(String usercode, String oldname, String newname, String table, int type, HttpServletRequest request) throws Exception {
    ...
    if (table.equals(TableNameUtil.KQDS_MEMBER)) {
      num = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateFlagBySeqIds1", json)).intValue();
    } else if (table.equals("KQDS_MEMBER_RECORD_SZR")) {
      num = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateFlagBySeqIds2", json)).intValue();
    } else if (type == 1) {
      num = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateFlagBySeqIds3", json)).intValue();
    } else {
      num = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateFlagBySeqIds4", json)).intValue();
    } 
    return num;
  }
  ...
  public int updateUser(String usercode1, String usercode2, String username2, String table, int type, HttpServletRequest request) throws Exception {
    ...
    if (table.equals(TableNameUtil.KQDS_COSTORDER_DETAIL) || table.equals(TableNameUtil.KQDS_MEDICALRECORD) || table.equals(TableNameUtil.KQDS_OUTPROCESSING_SHEET) || 
      ...
      num = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateUser1", json)).intValue();
    } else if (type == 1) {
      num = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateUser2", json)).intValue();
    } 
    return num;
  }
  
  public String getSfuser() throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getSfuser", null);
    String bqs = "";
    for (JSONObject rs : list)
      bqs = String.valueOf(bqs) + rs.getString("usercode") + ","; 
    if (bqs.endsWith(","))
  ...
  public JSONObject getusercodeBYsjhm(String sjhm) throws Exception {
    JSONObject jobj = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getusercodeBYsjhm", sjhm);
    return jobj;
  }
  
  public String getSsje(String usercode) throws Exception {
    String ssje = "0";
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getSsje", usercode);
    if (list != null && list.size() > 0) {
  ...
  public List<JSONObject> getSsjeReg(String regno) throws Exception {
    ...
    Map<String, String> map = new HashMap<>();
    map.put("regno", regno);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getSsjeReg", map);
    if (list != null && list.size() > 0)
      for (JSONObject rs : list) {
        BigDecimal paymoney = new BigDecimal(YZUtility.isNullorEmpty(rs.getString("paymoney")) ? "0.00" : rs.getString("paymoney"));
        BigDecimal zs = new BigDecimal(YZUtility.isNullorEmpty(rs.getString("zs")) ? "0.00" : rs.getString("zs"));
  ...
  public BigDecimal getSsjeOne(String costno) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getSsjeOne", costno);
    if (list != null && list.size() > 0) {
      JSONObject rs = list.get(0);
      BigDecimal paymoney = new BigDecimal(YZUtility.isNullorEmpty(rs.getString("paymoney")) ? "0.00" : rs.getString("paymoney"));
      BigDecimal zs = new BigDecimal(YZUtility.isNullorEmpty(rs.getString("zs")) ? "0.00" : rs.getString("zs"));
  ...
  public BigDecimal getJFjeOne(String costno) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getJFjeOne", costno);
    if (list != null && list.size() > 0) {
      JSONObject rs = list.get(0);
  ...
  public JSONObject userManger4Wdzx(String table, YZPerson person, Map<String, String> map, String visualstaff, String organization, BootStrapPage bp) throws Exception {
    ...
    if ("a361daeb-be3c-4dab-a63d-3d718177c81e".equals(person.getSeqId())) {
      returnlist1 = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4WdzxNetNum", map);
    } else {
      returnlist1 = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4WdzxNum", map);
    } 
    PageHelper.offsetPage(bp.getOffset(), bp.getLimit());
    List<JSONObject> returnlist = null;
    if ("a361daeb-be3c-4dab-a63d-3d718177c81e".equals(person.getSeqId())) {
      returnlist = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4WdzxNet", map);
    } else {
      returnlist = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4Wdzx", map);
    } 
  ...
  public JSONObject userManger4Kfzx(String table, YZPerson person, Map<String, String> map, String ywhf, String visualstaff, String organization, BootStrapPage bp, JSONObject json, Double time1, Double time2, String labelID) throws Exception {
      ...
      if (organization.equals("HUDH")) {
        ...
        for (String string : c) {
          if (!labelID.equals("")) {
            ...
            for (j = (arrayOfString1 = id).length, b = 0; b < j; ) {
        ...
        Set<String> c = CacheUtil.getZSetByScore(String.valueOf(organization) + ":label:key", time1.doubleValue(), time2.doubleValue());
        List<String> labelAll = new ArrayList<>();
        for (String string : c) {
          if (!labelID.equals("")) {
            int i = 0;
        ...
        for (String string : labelAll) {
          String mm = (String)CacheUtil.getMapKey(String.valueOf(organization) + ":label:value", string);
          if (mm != null && !mm.equals(""))
            usercodeAll.add(mm); 
        } 
      } 
      ...
      if (organization.equals("HUDH")) {
        ...
        if (c.size() > 0)
          for (String string : c) {
            ...
            for (j = (arrayOfString = id).length, b = 0; b < j; ) {
        ...
        Set<String> c = CacheUtil.keys(String.valueOf(organization) + ":labelQuery:*" + id[0] + "*");
        if (c.size() > 0)
          for (String string : c) {
            int i = 0;
            byte b;
        ...
        for (String string : labelAll) {
          String mm = (String)CacheUtil.getMapKey(String.valueOf(organization) + ":label:value", string.substring(16, string.length()));
          if (mm != null && !mm.equals(""))
            usercodeAll.add(mm); 
        } 
      } 
    ...
    if (usercodeAll.size() > 0 && usercodeAll != null) {
      ...
      List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4KfzxNumByUsercodes", map);
      PageHelper.offsetPage(bp.getOffset(), bp.getLimit());
      returnlist = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4KfzxByUsercodes", map);
      PageInfo<JSONObject> pageInfo1 = new PageInfo(returnlist);
      JSONObject jSONObject = new JSONObject();
      jSONObject.put("total", Long.valueOf(pageInfo1.getTotal()));
      jSONObject.put("rows", returnlist);
      jSONObject.put("nums", list);
      return jSONObject;
    } 
    if ((usercodeAll.size() == 0 && labelID != null && !labelID.equals("") && returnlist.size() == 0) || (usercodeAll.size() > 0 && labelID != null && !labelID.equals("") && returnlist.size() == 0)) {
      ...
      list.add(jobj);
      jSONObject1.put("total", Integer.valueOf(0));
      jSONObject1.put("rows", returnlist);
      jSONObject1.put("nums", list);
      return jSONObject1;
    } 
    List<JSONObject> returnlist1 = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4KfzxNum", map);
    PageHelper.offsetPage(bp.getOffset(), bp.getLimit());
    returnlist = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4Kfzx", map);
    PageInfo<JSONObject> pageInfo = new PageInfo(returnlist);
    JSONObject jobj1 = new JSONObject();
    jobj1.put("total", Long.valueOf(pageInfo.getTotal()));
    jobj1.put("rows", returnlist);
  ...
  public JSONObject userManger4Yxzx(String table, YZPerson person, Map<String, String> map, String visualstaff, String organization, BootStrapPage bp) throws Exception {
    ...
    List<JSONObject> returnlist1 = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4YxzxNum", map);
    PageHelper.offsetPage(bp.getOffset(), bp.getLimit());
    List<JSONObject> returnlist = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".userManger4Yxzx", map);
    for (JSONObject job : returnlist) {
      String proviceName = job.getString("provincename");
      if (proviceName.equals(""))
        job.replace("provincename", job.getString("province_name")); 
  ...
  public List<JSONObject> jingQueChaXun4Net(String queryinput, String queryInputName) throws Exception {
    ...
    List<JSONObject> returnlist = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".jingQueChaXun4Net", map);
    for (JSONObject job : returnlist) {
      String cjstatus = job.getString("cjstatus");
      if ("1".equals(cjstatus)) {
        cjstatus = "已成交";
  ...
  public JSONObject selectWithPage(BootStrapPage bp, Map<String, String> map) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectWithPage", map);
    PageInfo<JSONObject> pageInfo = new PageInfo(list);
    JSONObject jobj = new JSONObject();
    jobj.put("total", Long.valueOf(pageInfo.getTotal()));
    jobj.put("rows", list);
  ...
  public List<JSONObject> selectListByBirth(int month, int day, String organization) throws Exception {
    ...
    map.put("day", (new StringBuilder(String.valueOf(day))).toString());
    map.put("organization", organization);
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".selectListByBirth", map);
    return list;
  }
  
  public JSONObject getUserInfoByUserCode(String usercode) throws Exception {
    JSONObject result = (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".getUserInfoByUserCode", usercode);
    return result;
  }
  
  public int deleteuser(String userCodes) throws Exception {
    int count = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateusers", userCodes)).intValue();
    return count;
  }
  
  public int checkuser(String userCode) throws Exception {
    int count = ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_MEMBER_RECORD) + ".checkuser", userCode)).intValue();
    return count;
  }
  ...
  public void updateUserDoc(KqdsUserdocument dp, KqdsUserdocument en, KqdsNetOrder netorder, YZPerson person, HttpServletRequest request) throws Exception {
    ...
    if (ConstUtil.USER_TYPE_1 == dp.getType().intValue()) {
      ...
      if (!YZUtility.isNullorEmpty(wdseqId)) {
        ...
        List<KqdsNetOrder> orderList = (List<KqdsNetOrder>)this.dao.loadList(TableNameUtil.KQDS_NET_ORDER, map);
  ...
  public void isCreateLclj(String seqId, @Param("iscreateLclj") String iscreateLclj) throws Exception {
    ...
    this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".isCreateLclj", map);
  }
  ...
  public int findIntroducerNum(String usercode) throws Exception {
    int introducerNum = ((Integer)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findIntroducerNum", usercode)).intValue();
    return introducerNum;
  }
  
  public void saveKpatient(kqdsHzLabellabeAndPatient kPatient) throws Exception {
    this.dao.save(String.valueOf(TableNameUtil.KQDS_Hz_LabellabeAndPatient) + ".saveKpatient", kPatient);
  }
  
  public void deleteLabel(String userCode) throws Exception {
    this.dao.delete(String.valueOf(TableNameUtil.KQDS_Hz_LabellabeAndPatient) + ".deleteLabel", userCode);
  }
  
  public void deleteLabelByUsercode(Map<String, String> map) throws Exception {
    this.dao.delete(String.valueOf(TableNameUtil.KQDS_Hz_LabellabeAndPatient) + ".deleteLabelByUsercode", map);
  }
  
  public String selectLabelByUsercode(Map<String, String> map) throws Exception {
    String threeid = (String)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_Hz_LabellabeAndPatient) + ".selectLabelByUsercode", map);
    return threeid;
  }
  ...
  public void mergeMessage(String blcode, String usercode) throws Exception {
    ...
    this.dao.update(String.valueOf(TableNameUtil.HUDH_LCLJ_ORDERTRACK) + ".mergeMessage", map);
  }
  
  public List<JSONObject> findKqdsUserdocumentByUsercodes(String usercodes) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findKqdsUserdocumentByUsercodes", usercodes);
    return list;
  }
  
  public List<JSONObject> findByUsercode(String usercode) throws Exception {
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findByUsercode", usercode);
    return list;
  }
  ...
  public List findDevchannel(Map<String, String> map) throws Exception {
    return (List)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findDevchannel", map);
  }
  
  public JSONObject findDevchannelAll(Map<String, String> map) throws Exception {
    return (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findDevchannelAll", map);
  }
  
  public JSONObject findConsumptionInterval(Map<String, String> map) throws Exception {
    return (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findConsumptionInterval", map);
  }
  
  public JSONObject findLabel(String userCode) throws Exception {
    Map<String, String> map = new HashMap<>();
    map.put("userCode", userCode);
    return (JSONObject)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_Hz_LabellabeAndPatient) + ".findLabel", map);
  }
  
  public String findOrganizationBySeqid(String seqid) throws Exception {
    return (String)this.dao.findForObject(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".findOrganizationBySeqid", seqid);
  }
  
  public int updateBlcode(Map<String, String> map) throws Exception {
    return ((Integer)this.dao.update(String.valueOf(TableNameUtil.KQDS_USERDOCUMENT) + ".updateBlcode", map)).intValue();
  }
}
