...
public class KQDS_hz_labelLogic {
  ...
  public Integer saveLabel(KqdsLabel label) throws Exception {
    return (Integer)this.dao.save(String.valueOf(TableNameUtil.KQDS_HZ_label) + ".saveLabel", label);
  }
  
  public List<KqdsLabel> findLabel(String parentId) throws Exception {
    Map<String, String> map = new HashMap<>();
    map.put("parentId", parentId);
    return (List<KqdsLabel>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_HZ_label) + ".findLabel", map);
  }
  
  public List<KqdsLabel> findLabelCondition(String parentId) throws Exception {
    Map<String, String> map = new HashMap<>();
    map.put("parentId", parentId);
    return (List<KqdsLabel>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_HZ_label) + ".findLabelCondition", map);
  }
  ...
  public Integer deLabel(String[] seqId) throws Exception {
    ...
    for (int i = 0; i < seqId.length; i++) {
      ...
      status = (Integer)this.dao.delete(String.valueOf(TableNameUtil.KQDS_HZ_label) + ".deLabel", map);
    } 
    return status;
  }
  ...
  public Integer updateLabel(KqdsLabel kLabel) throws Exception {
    return (Integer)this.dao.delete(String.valueOf(TableNameUtil.KQDS_HZ_label) + ".updateLabel", kLabel);
  }
  
  public List<JSONObject> findLabelAll() throws Exception {
    return (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_HZ_label) + ".findLabelAll", null);
  }
  
  public List<JSONObject> fingLabelByCondition(Map<String, String> map) throws Exception {
    return (List<JSONObject>)this.dao.findForList(String.valueOf(TableNameUtil.KQDS_HZ_label) + ".fingLabelByCondition", map);
  }
  ...
  public JSONObject findParentId(String paString) throws Exception {
    ...
    List<JSONObject> list = (List<JSONObject>)this.dao.findForList("KQDS_HZ_label.findParentId", dataMap);
    json.put("list", list);
    return json;
  }
}
