...
@Service
public class KQDS_TreatItem_TcLogic
  extends BaseLogic
{
  @Autowired
  ...
  public void newAddTc(String tctype, String tcname, Map<String, String> map, HttpServletRequest request)
    throws Exception
  {
    ...
    List<KqdsTreatitemTcType> list = (List)loadList(TableNameUtil.KQDS_TREATITEM_TC_TYPE, map);
  ...
  public int getCountByItemnos(String itemnos)
    throws Exception
  {
    int count = ((Integer)this.dao.findForObject(TableNameUtil.KQDS_TREATITEM_TC + ".getCountByItemnos", YZUtility.ConvertStringIds4Query(itemnos))).intValue();
    return count;
  }
  
  public int checkTc(String parentid, String tcname, String seqid)
    throws Exception
  {
    ...
    int count = ((Integer)this.dao.findForObject(TableNameUtil.KQDS_TREATITEM_TC + ".checkTc", map1)).intValue();
    return count;
  }
  
  public int selectTcxmCount(String table, String tcnameid)
    throws Exception
  {
    int num = ((Integer)this.dao.findForObject(TableNameUtil.KQDS_TREATITEM_TC + ".selectTcxmCount", tcnameid)).intValue();
    return num;
  }
  ...
  public JSONObject selectWithPage(String table, BootStrapPage bp, Map<String, String> map)
    throws Exception
  {
    List<JSONObject> list = (List)this.dao.findForList(TableNameUtil.KQDS_TREATITEM_TC + ".selectWithPage", map);
  ...
  public JSONObject selectWithPageBytctypeAndname(String table, BootStrapPage bp, String tcnameid)
    throws Exception
  {
    List<JSONObject> list = (List)this.dao.findForList(TableNameUtil.KQDS_TREATITEM_TC + ".selectWithPageBytctypeAndname", tcnameid);
    PageInfo<JSONObject> pageInfo = new PageInfo(list);
    JSONObject jobj = new JSONObject();
    jobj.put("total", Long.valueOf(pageInfo.getTotal()));
    jobj.put("rows", list);
  ...
  public List<JSONObject> selectNoPageBytctypeAndname(String table, BootStrapPage bp, String tcnameid)
    throws Exception
  {
    List<JSONObject> list = (List)this.dao.findForList(TableNameUtil.KQDS_TREATITEM_TC + ".selectNoPageBytctypeAndname", tcnameid);
    return list;
  }
  
  public List<KqdsTreatitemTcType> getTcNameListByTcType(String tctypeid, String createuser, String organization)
    throws Exception
  {
    Map<String, String> map1 = new HashMap();
    ...
    List<KqdsTreatitemTcType> list = (List)this.dao.findForList(TableNameUtil.KQDS_TREATITEM_TC + ".getTcNameListByTcType", map1);
    return list;
  }
  
  public int countTcNameByTcType(String tctypeid, String createuser, String organization)
    throws Exception
  {
    Map<String, String> map1 = new HashMap();
    map1.put("createuser", createuser);
    map1.put("parentid", tctypeid);
    map1.put("organization", organization);
    int count = ((Integer)this.dao.findForObject(TableNameUtil.KQDS_TREATITEM_TC + ".countTcNameByTcType", map1)).intValue();
    return count;
  }
  
  public List<KqdsTreatitemTcType> getTcTypeList(String organization)
    throws Exception
  {
    List<KqdsTreatitemTcType> list = (List)this.dao.findForList(TableNameUtil.KQDS_TREATITEM_TC + ".getTcTypeList", organization);
    return list;
  }
}
