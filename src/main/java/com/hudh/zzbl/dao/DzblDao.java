...
public class DzblDao {
     ...
     * @return: JSONObject
     */
    public List<JSONObject> findFamiliarBookByLcId(
            String id)
            throws
            Exception {
        return (List<JSONObject>) dao.findForList("HUDH_DZBL_FamiliarBook.findFamiliarBookById", id);
    }

    public JSONObject findFamiliarBook(
            String id)
            throws
            Exception {
