  ...
  implements Serializable
{
  ...
  private String removableDenture;
  private String fixedDenture;
  
  public String getRemovableDenture()
  {
    return this.removableDenture;
  }
  ...
  public String toString()
  {
    return 
      ...
      "FamiliarBook [SEQ_ID=" + this.SEQ_ID + ", LcljId=" + this.LcljId + ", LcljNum=" + this.LcljNum + ", plantingSystem=" + this.plantingSystem + ", modelNumber=" + this.modelNumber + ", upleftToothBitOne=" + this.upleftToothBitOne + ", uperRightToothBitOne=" + this.uperRightToothBitOne + ", leftLowerToothBitOne=" + this.leftLowerToothBitOne + ", lowRightToothBitOne=" + this.lowRightToothBitOne + ", upleftToothBitTwo=" + this.upleftToothBitTwo + ", uperRightToothBitTwo=" + this.uperRightToothBitTwo + ", leftLowerToothBitTwo=" + this.leftLowerToothBitTwo + ", lowRightToothBitTwo=" + this.lowRightToothBitTwo + ", assistOperation=" + this.assistOperation + ", remarks=" + this.remarks + ", PatientSignature=" + this.PatientSignature + ", PatientTime=" + this.PatientTime + ", doctorSignature=" + this.doctorSignature + ", doctorTime=" + this.doctorTime + ", createtime=" + this.createtime + ", createuser=" + this.createuser + ", reservedField1=" + this.reservedField1 + ", reservedField2=" + this.reservedField2 + ", reservedField3=" + this.reservedField3 + "]";
  }
}
