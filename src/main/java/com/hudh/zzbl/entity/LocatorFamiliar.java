...
public class LocatorFamiliar implements Serializable {
  ...
  public String toString() {
    return "LocatorFamiliar [seqId=" + this.seqId + ", lcljId=" + this.lcljId + ", lcljNum=" + this.lcljNum + ", name=" + this.name + 
      ", age=" + this.age + ", sex=" + this.sex + ", address=" + this.address + ", phone=" + this.phone + ", allergy=" + this.allergy + 
      ", diagnose=" + this.diagnose + ", treatmentParts=" + this.treatmentParts + ", treatmentTime=" + this.treatmentTime + 
      ", profession=" + this.profession + ", classify=" + this.classify + ", doctorSignature=" + this.doctorSignature + 
      ", doctorTime=" + this.doctorTime + ", patientSignature=" + this.patientSignature + ", patientTime=" + 
      this.patientTime + ", createtime=" + this.createtime + ", remark=" + this.remark + ", beiyong1=" + this.beiyong1 + 
      ", beiyong2=" + this.beiyong2 + ", beiyong3=" + this.beiyong3 + "]";
  }
}
