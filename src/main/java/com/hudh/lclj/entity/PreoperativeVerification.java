...
public class PreoperativeVerification implements Serializable {
  ...
  public String getInfectious_diseases() {
    return this.infectious_diseases;
  }
  ...
  public String toString() {
    return "PreoperativeVerification [SEQ_ID=" + this.SEQ_ID + ", lclj_Id=" + this.lclj_Id + 
      ", order_number=" + this.order_number + ", patient_name=" + this.patient_name + 
      ", patient_sex=" + this.patient_sex + ", patient_age=" + this.patient_age + 
      ", blood_pressure=" + this.blood_pressure + ", pulse=" + this.pulse + ", blood_glucose=" + 
      this.blood_glucose + ", cruor_function=" + this.cruor_function + ", infectious_diseases=" + 
      this.infectious_diseases + ", consultation_opinion=" + this.consultation_opinion + 
      ", pullout_tooth=" + this.pullout_tooth + ", plant_tooth=" + this.plant_tooth + 
      ", assist_operation=" + this.assist_operation + ", plant_system=" + this.plant_system + 
      ", nurseSignature=" + this.nurseSignature + ", doctorSignature=" + this.doctorSignature + 
      ", signaturetime=" + this.signaturetime + ", operationAlltext=" + this.operationAlltext + 
      ", beiyong1=" + this.beiyong1 + ", beiyong2=" + this.beiyong2 + ", beiyong3=" + this.beiyong3 + 
