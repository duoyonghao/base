...
public class LcljApprovedMemo implements Serializable {
  ...
  public String toString() {
    return "LcljApprovedMemo [SeqId=" + this.SeqId + ", LcljId=" + this.LcljId + ", nodeId=" + this.nodeId + ", nodeName=" + 
      this.nodeName + ", nodetime=" + this.nodetime + ", regtime=" + this.regtime + ", nexttime=" + this.nexttime + 
      ", recesort=" + this.recesort + ", regsort=" + this.regsort + ", regdoctor=" + this.regdoctor + ", remark=" + this.remark + 
      ", updatetime=" + this.updatetime + ", updateuser=" + this.updateuser + ", status=" + this.status + "]";
  }
}
