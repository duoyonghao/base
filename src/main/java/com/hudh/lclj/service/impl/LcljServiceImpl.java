...
public class LcljServiceImpl implements ILcljService {
  ...
  public void updateOperateNoteInfo(String orderTrackId, String flowLink, String operateName, String remake) throws Exception {
  ...
  private String setRemakeToJsonStr(String jsonStr, String operateName, String remake) {
    Map<Object, Object> childClazzMap = new HashMap<>();
  ...
  public void updateOperateStatus(String ordernumber, String operateName) throws Exception {
    ...
    if (list != null && list.size() > 0) {
      ...
      LcljOrderTrack lcljob = list1.get(0);
  ...
  public void updateOperationFlowStatus(String operateName, String orderTrackId, String flowLink) throws Exception {
    ...
    if ("手术".equals(flowLink)) {
      ...
      for (LcljOperate lcljOperate : list) {
        ...
        if (lcljOperate.getIsComplate().equals("未完成"))
          flagStu = false; 
      } 
      String jsonStri = JSON.toJSONString(list);
      lcljOrderImplemen.setSs(jsonStri);
