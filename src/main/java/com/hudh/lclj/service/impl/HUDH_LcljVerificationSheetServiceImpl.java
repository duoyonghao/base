...
@Service
public class HUDH_LcljVerificationSheetServiceImpl
  implements HUDH_LcljVerificationSheetService
{
  @Autowired
  ...
  @Transactional
  public void Update(LcljApprovedMemo bean)
    throws Exception
  {
  ...
  @Transactional
  public List<JSONObject> getCheckRecord(Map<String, String> map, YZPerson person)
    throws Exception
  {
  ...
  public List<JSONObject> getAwaitCheckRecord(Map<String, String> map, YZPerson person)
    throws Exception
  {
