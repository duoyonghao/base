...
public class HUDH_LcljVerificationSheetServiceImpl implements HUDH_LcljVerificationSheetService{
	...
	/**   
	  ...
	  * @param bean   
	 * @throws Exception 
	  * @see HUDH_LcljVerificationSheetService#insert(LcljApprovedMemo)
	  */  
	@Override
	@Transactional
	...
	/**   
	  ...
	  * @param bean   
	 * @throws Exception 
	  * @see HUDH_LcljVerificationSheetService#Update(LcljApprovedMemo)
	  */  
	@Override
	@Transactional
...
//		dao.update(TableNameUtil.HUDH_LCLJ_CHECKRECORD+".Update", bean);
	...
	/**   
	  ...
	  * @return   
	 * @throws Exception 
	  * @see HUDH_LcljVerificationSheetService#getCheckRecord(String)
	  */  
	@Override
	@Transactional
...
//		return (List<JSONObject>)dao.findForList(TableNameUtil.HUDH_LCLJ_CHECKRECORD+".findLcljCheckrecordById", map);
	...
	/**   
	  ...
	  * @param id   
	 * @throws Exception 
	  * @see HUDH_LcljVerificationSheetService#delCheckRecord(String)
	  */  
	@Override
	@Transactional
