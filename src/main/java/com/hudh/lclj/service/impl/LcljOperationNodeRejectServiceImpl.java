...
public class LcljOperationNodeRejectServiceImpl implements ILcljOperationNodeRejectService {
	...
	/**   
	  ...
	  * @param dp   
	 * @throws Exception 
	  * @see ILcljOperationNodeRejectService#insertOperationNodeReject(LcljOperateRejectRecord)
	  */  
	@Override
	...
	/**   
	  ...
	  * @return   
	 * @throws Exception 
	  * @see ILcljOperationNodeRejectService#findOperationNodeRejectByOrderNumber(String)
	  */  
	@Override
