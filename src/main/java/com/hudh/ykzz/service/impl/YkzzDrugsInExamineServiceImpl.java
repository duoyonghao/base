...
@Service
public class YkzzDrugsInExamineServiceImpl
  implements IYkzzDrugsInExamineService
{
  @Autowired
  ...
  public int insertDrugsInExamine(YkzzDrugsInExamine ykzzDrugsInExamine, HttpServletRequest request)
    throws Exception
  {
