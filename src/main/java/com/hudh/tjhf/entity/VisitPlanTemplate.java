...
public class VisitPlanTemplate implements Serializable {
  ...
  public String toString() {
    return "VisitPlanTemplate [SEQ_ID=" + this.SEQ_ID + ", managarId=" + this.managarId + ", plandays=" + this.plandays + 
      ", visittype=" + this.visittype + ", ismandatory=" + this.ismandatory + ", isautomatic=" + this.isautomatic + 
      ", visitstaff=" + this.visitstaff + ", accepttype=" + this.accepttype + ", organization=" + this.organization + 
      ", remark=" + this.remark + ", createuser=" + this.createuser + ", createtime=" + this.createtime + ", spare1=" + 
      this.spare1 + ", spare2=" + this.spare2 + "]";
  }
}
