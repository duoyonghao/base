...
public class AddVisitServcieImpl implements IAddVisitService {
	...
	/**   
	  ...
	  * @param attribute   
	 * @throws Exception 
	  * @see IAddVisitService#saveVisitTemalate(List)
	  */  
	@Override
	...
	/**   
	  ...
	  * @param list   
	 * @throws Exception 
	  * @see IAddVisitService#saveVisitPlanTemalate(List)
	  */  
	@Override
	...
	/**   
	  ...
	  * @return   
	 * @throws Exception 
	  * @see IAddVisitService#findTemplate()
	  */  
	@Override
	...
	/**   
	  ...
	  * @return   
	 * @throws Exception 
	  * @see IAddVisitService#findvisitPlanTemplate(String)
	  */  
	@Override
	...
	/**   
	  ...
	  * @return
	  * @throws Exception   
	  * @see IAddVisitService#findoperator(String)
	  */  
	...
	/**   
	  ...
	  * @return   
	 * @throws Exception 
	  * @see IAddVisitService#findvisitTemplate(Map)
	  */  
	@Override
