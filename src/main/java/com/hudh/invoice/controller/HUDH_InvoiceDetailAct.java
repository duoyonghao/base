...
public class HUDH_InvoiceDetailAct
{
  ...
  public String insertInvoiceDetail(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String updateInvoiceDetail(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String updateDishonourInvoiceDetail(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String updateDishonourInvoiceDetailAll(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String selectInvoiceDetailByUsercode(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public String selectInvoiceDetailValueByUsercode(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
  ...
  public ModelAndView toInvoiceLeading(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
  ...
  public String selectInvoiceDetailByTime(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    try
    {
      ...
      {
        List<JSONObject> json = data.getJSONArray("rows");
        if (json.size() > 0) {
          for (int i = 0; i < json.size(); i++)
          {
            ((JSONObject)json.get(i)).put("number", i + 1);
            if (((JSONObject)json.get(i)).get("dishonour").equals("1"))
            {
              ((JSONObject)json.get(i)).put("cancellation", "是");
              ((JSONObject)json.get(i)).put("invalid_person", ((JSONObject)json.get(i)).getString("updateuser"));
              ((JSONObject)json.get(i)).put("invalid_time", ((JSONObject)json.get(i)).getString("updatetime"));
            }
            else
            {
              ((JSONObject)json.get(i)).put("cancellation", "否");
              ((JSONObject)json.get(i)).put("modifier", ((JSONObject)json.get(i)).getString("updateuser"));
              ((JSONObject)json.get(i)).put("filemtime", ((JSONObject)json.get(i)).getString("updatetime"));
            }
            ((JSONObject)json.get(i)).put("invoice_kind", "普通发票");
            ((JSONObject)json.get(i)).put("invoice_code", "11001800304");
            ((JSONObject)json.get(i)).put("invoice_month", ((JSONObject)json.get(i)).getString("invoice_time").substring(0, 7));
          }
        }
