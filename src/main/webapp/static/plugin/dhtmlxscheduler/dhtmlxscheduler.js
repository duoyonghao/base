...
scheduler.init = function(a, b, c) {
    ...
    this.set_actions(); (function() {
        ...
        function() {
            var g = a();
            if (!b(c, g)) window.clearTimeout(scheduler._resize_timer),
...
scheduler._init_lightbox_events = function() {
    ...
    this.getLightbox().onkeydown = function(a) {
        ...
        case scheduler.keys.edit_save:
            ...
            // scheduler.save_lightbox(); /** 回车不自动保存 2018-02-23 yangsen **/
            break;
...
scheduler._dp_init = function(a) {
    ...
    function(b) { ! this._loading && this._validId(b) && a.setUpdated(b, !0, "inserted")
    });
