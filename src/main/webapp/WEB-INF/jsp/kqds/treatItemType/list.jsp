...
function edit(id) {
    var index = layer.open({
        ...
        // 点击遮罩关闭层
        area: ['700px', '380px'],
        content: contextPath+'/KQDS_TreatItem_TcBackAct/toTypeEdit.act?seqId=' + id
    });
}
...
function() {
    layer.open({
        ...
        //点击遮罩关闭层
        area: ['700px', '380px'],
        content: contextPath+'/KQDS_TreatItem_TcBackAct/toTypeNewAdd.act?parentCode=' + static_parentcode + '&organization=' + organization
    });
});
</script>
</body>
