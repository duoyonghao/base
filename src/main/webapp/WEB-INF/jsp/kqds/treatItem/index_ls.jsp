...
$(function(){
	...
	if(data){
		...
		for (var i = 0; i < tabList.length; i++) {
			...
			var tabUrl = "<%=contextPath%>/KQDS_TreatItemBackAct/toList.act?organization=" + tabList[i].deptCode;
		...
		var tabUrl = "<%=contextPath%>/KQDS_TreatItemBackAct/toList.act?organization=";
        var tabHtml = '<li target="tabIframe" src="' + tabUrl + '" class="">公用项目</li>';
        $(".layui-tab-title").append(tabHtml);
	}
	setHeight();
