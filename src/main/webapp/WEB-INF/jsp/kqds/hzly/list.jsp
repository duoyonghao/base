...
function edit(id) {
    var index = layer.open({
        ...
        // 点击遮罩关闭层
        area: ['700px', '380px'],
        content: contextPath+'/YZDictAct/toHzlyEdit.act?seqId=' + id
    });
}
...
function() {
    layer.open({
        ...
        //点击遮罩关闭层
        area: ['700px', '380px'],
        content: contextPath+'/YZDictAct/toHzlyNewAdd.act?parentCode=' + static_parentcode + '&organization=' + organization
    });
});
</script>
</body>
