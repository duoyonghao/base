...
$(function(){
	...
	if(data){
		...
		for (var i = 0; i < tabList.length; i++) {
			...
			var tabUrl = "<%=contextPath%>/KQDS_OutProcessing_UnitBackAct/toList.act?organization=" + tabList[i].deptCode;
		...
		var tabUrl = "<%=contextPath%>/KQDS_OutProcessing_UnitBackAct/toList.act?organization=";
        var tabHtml = '<li target="tabIframe" src="' + tabUrl + '" class="">公用加工厂</li>';
        $(".layui-tab-title").append(tabHtml);
	}
	/*自适应tabIframe1的高度*/
	setHeight();
