	...
	<div class="container"><!--提供内边距 让内容不顶头显示-->
		...
		<div class="fixedBottomDiv"><!--底部三个按钮所在父元素 固定在底部样式  -->
			<div class="clear2"></div>
         	...
         	<a class="kqdsCommonBtn" id="back" href="javascript:void(0);" onclick="location='<%=contextPath%>/YZPrivAct/toList.act?organization=<%=organization%>'">返回</a>
...
function submitForm() {
    ...
    if (serverData) {
        layer.alert('操作成功', {
                ...
                window.location.href = contextPath + "/YZPrivAct/toList.act";
            }
        });
    }
}
