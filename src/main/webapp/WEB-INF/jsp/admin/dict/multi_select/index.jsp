...
var static_single_select_dictid = null;
var static_single_select_dictname = null;
var static_single_select_dictObj = null;
var static_single_select_dictDescObj = null;
// 取父页面的值
var static_select_dictid_val = null;
var static_select_dictname_val = null;
var static_select_parentCode_val = null;

var dictRetNameArray = parent.dictRetNameArrayMulti; // 多选
if (dictRetNameArray && dictRetNameArray.length == 2) {
    static_single_select_dictid = dictRetNameArray[0];
    static_single_select_dictname = dictRetNameArray[1];
    static_single_select_dictObj = parent.$("#" + static_single_select_dictid);
    static_single_select_dictDescObj = parent.$("#" + static_single_select_dictname);
} else {
    static_single_select_dictObj = parent.$("#dict");
    static_single_select_dictDescObj = parent.$("#dictDesc");
}
...
function setSelectVal() {
    ...
    $(static_single_select_dictObj).val(seqIds);
    $(static_single_select_dictDescObj).val(names);

    // 重新取值，赋值
    static_select_dictid_val = $(static_single_select_dictObj).val(); // id
    static_select_dictname_val = $(static_single_select_dictDescObj).val(); // name
    
    static_select_parentCode_val = $(static_single_select_dictObj).attr("parentCode");
}
...
function initUL() {
    var idArray = static_select_dictid_val.split(',');
    var nameArray = static_select_dictname_val.split(',');
    $("#pul").empty();
...
function zTreeInit4All() {
    var url = '<%=contextPath%>/YZDictAct/getDictTree4All.act?dictIds=' + static_select_dictid_val + '&parentCode=' + static_select_parentCode_val;
    var treeNodes = null;
    $.axse(url, null,
    function(data) {
