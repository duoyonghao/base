        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<%=contextPath %>/admin/index/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<%=contextPath %>/admin/index/dist/img/user3-128x128.jpg" alt="user image" class="offline">
...
<!-- Bootstrap 3.3.7 -->
<script src="<%=contextPath %>/admin/index/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- Morris.js charts -->
...
<script src="<%=contextPath %>/static/js/admin/index/dict/pages/dashboard.js"></script>
