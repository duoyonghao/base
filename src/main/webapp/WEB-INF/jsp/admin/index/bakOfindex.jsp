              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      <div class="pull-left">
                        <img src="<%=contextPath%>/static/image/index/dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      <div class="pull-left">
                        <img src="<%=contextPath%>/static/image/index/dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              <!-- chat item -->
              <div class="item">
                <img src="<%=contextPath%>/static/image/index/dist/img/user4-128x128.jpg" alt="user image" class="online">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<%=contextPath%>/static/image/index/dist/img/user3-128x128.jpg" alt="user image" class="offline">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<%=contextPath%>/static/image/index/dist/img/user2-160x160.jpg" alt="user image" class="offline">
