                    ...
                    <div style="float: right;width: 80%;">
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="preoperatives" id="imaging-examine" type="checkbox" value="影像学检查" /><label
                                        for="imaging-examine">影像学检查</label>
                                </li>
                                <li>
                                ...
                                <li style="display: -webkit-inline-box;">
                                    <input onclick="hui()" name="preoperatives" id="consultation" type="checkbox" value="会诊" /><label
                                        for="consultation">会诊:</label>
                                    <ul id="huizhen">

                                        <li>(
                                            <input name="preoperatives" id="dentistry" type="checkbox" value="综合科" /><label
                                                for="dentistry">综合科</label>
                                        </li>
                                        <li>
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="preoperatives" id="ecg-examine" type="checkbox" value="心电图检查" /><label
                                        for="ecg-examine">心电图检查</label>
                                </li>
                                <li>
                                ...
                                <li style="display: -webkit-inline-box;">
                                    <input onclick="paizhao()" name="preoperatives" id="picture" type="checkbox" value="拍照" /><label
                                        for="picture">拍照:</label>
                                    <ul id="pho">

                                        <li>(
                                            <input name="preoperatives" id="intraoral" type="checkbox" value="口外" /><label
                                                for="intraoral">口外</label>
                                        </li>
                                        <li>
                                            <input name="preoperatives" id="para-oral" type="checkbox" value="口内" /><label
                                                for="para-oral">口内</label>
                                        </li>
                                        <li>
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="preoperatives" id="digital-face" type="checkbox" value="数字化面扫" /><label
                                        for="digital-face">数字化面扫</label>
                                </li>
                                <li>
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="preoperatives" id="periodontal" type="checkbox" value="牙周治疗" /><label
                                        for="periodontal">牙周治疗</label>
                                </li>

                                <li style="display: -webkit-inline-box;">
                                    <input onclick="shuqian()" name="preoperatives" id="preoperative" type="checkbox" value="术前取模" /><label
                                        for="preoperative">术前取模</label>
                                    <ul id="qumo">

                                        <li>(
                                            <input name="preoperatives" id="occlusio" type="checkbox" value="定咬合" /><label
                                                for="occlusio">定咬合</label>
                                        </li>
                                        <li>
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                ...
                                <li>
                                    <input name="preoperatives" id="risk-assess" type="checkbox" value="美学风险评估" /><label
                                        for="risk-assess">美学风险评估</label>
                                </li>
                            </ul>
                        </div>
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li style="display: -webkit-inline-box;">
                                    ...
                                    <ul id="daoban">
                                        ...
                                        <li>(
                                            <input name="preoperatives" id="toothType" type="checkbox" value="牙支持式" /><label
                                                for="toothType">牙支持式</label>
                                        </li>
                                        <li>
                        ...
                        <div class="" style="margin-left: 10px;">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="preoperatives" id="extraction" type="checkbox" value="拔牙" /><label
                                        for="extraction">拔牙</label>
                                </li>
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li style="display: -webkit-inline-box;">
                                    <input onclick="gaozhi()" name="preoperatives" id="inform" type="checkbox" value="告知" /><label
                                        for="inform">告知：</label>
                                    <ul id="gaozhi">
                                        ...
                                        <li>
                                            <input name="preoperatives" id="treat" type="checkbox" value="治疗计划" /><label
                                                for="treat">治疗计划</label>
                                        </li>
                                        <li>
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="preoperatives" id="pay" type="checkbox" value="缴费" /><label for="pay">缴费</label>
                                </li>
                                <li>
                                    <input name="preoperatives" id="soperationTime" type="checkbox"
                                        value="预约手术时间" /><label for="soperationTime">预约手术时间</label>
                                    <input id="appointmenttime" type="text" class="consent_time inputheight inputheight2"
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="preoperatives" id="explains" type="checkbox" value="交待手术日注意事项 " /><label
                                        for="explains">种植系统 </label>
                                </li>
                                <li>
                                    <input name="preoperatives" id="spreoperative" type="checkbox" value="术前用药" /><label
                                        for="spreoperative">术前用药</label>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<%-- 
            <div style="border-top: 1px solid #b3b3b3;">
                <div class="lookInfoWrap">
                <jsp:include page="/static/css/hudh/lclj/flowdetail/toothbitimg.jsp"><jsp:param value="0" name="index"/></jsp:include>
                </div>
            ...
            <div class="row" style="margin-right:0;margin-left:0;border-bottom:1px solid #b3b3b3">
                <div style="border-top:1px solid #b3b3b3;height: 200px;">
                    ...
                    <div style="width: 80%;float: right;">
                        ...
                        <ul class="loseTooth_option" style="display: inline-grid;">
                            <li>
                                <input name="bicon" id="ICX" type="checkbox" value="ICX " /><label for="ICX">ICX </label>
                            </li>
                            <li>
                                <label for="spreoperative">
                                <div id="diagnosis_continer" class="container-fluid">
                                ...
                                <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="nobelccleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="nobelccrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="nobelccleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="nobelccrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <ul class="loseTooth_option" style="display: inline-grid;">
                            <li>
                                <input name="bicon" id="Pmc" type="checkbox" value="Pmc" /><label for="Pmc">Pmc </label>
                            </li>
                            <li>
                                <label for="spreoperative">
                                <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="pmcleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="pmcrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="pmcleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="pmcrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div style="height: 50px;">
                    ...
                    <div  style="width: 80%;float: right;">
                        <ul class="loseTooth_option" style="margin-left: 10px;">
                            ...
                            <li style="line-height: 50px;margin-right:10px;">
                                <input name="abutment" id="angle" type="checkbox" value="角度基台" /><label for="angle">角度基台
                                </label>
                            </li>
                            <li style="line-height: 50px;margin-right:10px;">
                ...
                <div style="height:150px;">
                    ...
                    <div style="width: 80%;float: right;border-bottom: 1px solid #b3b3b3;">
                        ...
                        <div style="width: 80%;float: right;">
                            <ul class="loseTooth_option">
                                ...
                                <li>(</li>
                                <li>
                                    <input name="paraoperative" id="hiao1" type="checkbox" value="海奥1" /><label for="hiao1">海奥
                                    </label>
                                </li>
                                <li>
                                    <input name="paraoperative" id="bioOss1" type="checkbox" value="Bio-oss1" /><label
                                        for="bioOss1">Bio-oss</label>
                                </li>
                                <li>)</li>
                                <li>
                        ...
                        <div style="width: 80%;float: right;">
                            <ul class="loseTooth_option">
                                ...
                                <li>(</li>
                                <li>
                                    <input name="paraoperative" id="hiao2" type="checkbox" value="海奥2" /><label for="hiao2">海奥
                                    </label>
                                </li>
                                <li>
                                    <input name="paraoperative" id="bioOss2" type="checkbox" value="Bio-oss2" /><label
                                        for="bioOss2">Bio-oss</label>
                                </li>
                                <li>)</li>
                                <li>
                            </ul>
                    ...
                    <div style="width: 80%;float: right;">
                        <ul class="loseTooth_option" style="margin-left: 10px;">
                            ...
                            <li style="margin-right: 10px;">
                                <input name="paraoperative" id="tissuePatch" type="checkbox" value="组织补片" /><label
                                    for="tissuePatch">组织补片
                                </label>
                            </li>
                            <li style="margin-right: 10px;">
                                <input name="paraoperative" id="boneSplitting" type="checkbox" value="骨劈开" /><label
                                    for="boneSplitting">骨劈开</label>
                            </li>
                            <li style="margin-right: 10px;">
                    ...
                    <div style="width: 80%;float: right;">
                        <ul class="loseTooth_option" style="margin-left: 10px;">
                            ...
                            <li style="margin-right: 10px;">
                                <input name="paraoperative" id="boneExtrusion" type="checkbox" value="骨挤压" /><label
                                    for="boneExtrusion">骨挤压 </label>
                            </li>
                            <li style="margin-right: 10px;">
                                <input name="paraoperative" id="boneGraft" type="checkbox" value="自体骨移植" /><label
                                    for="boneGraft">自体骨移植</label>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div style="height: 50px;">
                    ...
                    <div style="width: 80%;float: right;">
                        <ul class="loseTooth_option" style="margin-left:10px;">
                            ...
                            <li style="line-height: 50px;margin-right:10px;">
                                <input name="modus" id="early" type="checkbox" value="早期种植" /><label for="early">早期种植
                                </label>
                            </li>
                            <li style="line-height: 50px;margin-right:10px;">
                       ...
                       <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row" style="margin-top: 17px;">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="temporarytleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="temporarytrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="temporarytleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="temporarytrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row" style="margin-top: 17px;">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="commonleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="commonrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="commonleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="commonrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row" style="margin-top: 17px;">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="instantlyleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="instantlyrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="instantlyleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="instantlyrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row" style="margin-top: 17px;">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="atonceleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="atoncerightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="atonceleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="atoncerightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                ...
                <div style="height: 413px;">
                    ...
                    <div style="width: 80%;float: right;">
                                ...
                                <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="imagingleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="imagingrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="imagingleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="imagingrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div id="diagnosis_continer" class="container-fluid">
                                    <div class="row">
                                            ...
                                            <div class="zl_toothMapdiv">
	                                                <ul class="tooth_map" style="width: 100%;height: 45px;margin-left: 1%;">
                                                    <li>
                                                        <input id="lianguanleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="lianguanrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="lianguanleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                    <li>
                                                        <input id="lianguanrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                        ...
                        <div class="preoperative">
                            <ul class="loseTooth_option">
                                <li>
                                    <input name="repair" id="overdenture" type="checkbox" value="种植覆盖义齿" /><label
                                        for="overdenture">种植覆盖义齿</label>
                                </li>
                            </ul>
                        </div>
                        <div class="next">
                            <div class="preoperative">
                                <ul class="loseTooth_option">
                                    <li>
                                        <input name="repair" id="locator" type="checkbox" value="Locator式" /><label
                                            for="locator">Locator式</label>
                                    </li>
                            ...
                            <div class="preoperative">
                                <ul class="loseTooth_option">
                                    <li>
                                        <input name="repair" id="attachment" type="checkbox" value="磁性附着体" /><label
                                            for="attachment">磁性附着体</label>
                                    </li>
                                </ul>
                            ...
                            <li style="display: -webkit-inline-box;">
                                ...
                                <ul id="caizhi">
                                    ...
                                    <li>(
                                        ...
                                        <input name="repair" id="steelCrown" type="checkbox" value="松风塑钢牙冠" /><label
                                            for="steelCrown">松风塑钢牙冠</label>
                                    </li>
                                    <li>
                                        <input name="repair" id="resinTooth" type="checkbox" value="树脂牙" /><label
                                            for="resinTooth">树脂牙</label>
                                    </li>(品牌))
                                </ul>
                            </li>
                        </div>
                                ...
                                <ul class="loseTooth_option">
                                    ...
                                    <li>
                                        <input name="repair" id="cadcam" type="checkbox"
                                            value="CAD/CAM纯钛桥架+树脂牙冠" /><label for="cadcam">CAD/CAM纯钛桥架+树脂牙冠</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div style="height: 50px;border-bottom: 1px solid #b3b3b3;border-top: 1px solid #b3b3b3;">
            <ul class="loseTooth_option" style="margin-left:10px;">
                <li style="line-height: 49px; margin-right: 10px;">
                    <input name="alternative" id="denture" type="checkbox" value="活动义齿修复 " /><label for="denture">活动义齿修复
                    </label>
                </li>
                <li style="line-height: 49px; margin-right: 10px;" >
                ...
                <div style="width: 100%;float: right;">
                    <ul class="loseTooth_option">
                        <li>
                            ...
                            <input name="pathType" class="page_input_radio" id="implantRepair" type="radio" value="1"
                ...
                <div id="others" class="one" style="margin-left: 10px;">
                        ...
                        <ul class="loseTooth_option">
                            ...
                            <li>
                                <input name="clinical" id="abutmentBone" type="checkbox"
                                    value="基台+植骨（内提、骨挤压、骨劈开）" /><label for="abutmentBone">基台+植骨（内提、骨挤压、骨劈开）</label>
                            </li>
                    ...
                    <div style="width: 100%;float: right;">
                        <ul class="loseTooth_option">
                            ...
                            <li>
                                <input name="clinical" id="fourboneGrafts" type="checkbox" value="四类骨移植" /><label
                                    for="fourboneGrafts">四类骨移植</label>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;float: right;">
                        <ul class="loseTooth_option">
                            ...
                            <li>
                                <input name="clinical" id="screwbonegraft" type="checkbox"
                                    value="螺丝+植骨（内提、骨挤压、骨劈开）" /><label for="screwbonegraft">螺丝+植骨（内提、骨挤压、骨劈开）</label>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;float: right;">
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="singlePiece" type="checkbox" value="单颗美学修复（即刻修复）" /><label
                                    for="singlePiece">单颗美学修复（即刻修复）</label>
                            </li>
                            <li>
                    ...
                    <div style="width: 100%;float: right;">
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="singlescrew" type="checkbox" value="单颗美学修复（覆盖螺丝）" /><label
                                    for="singlescrew">单颗美学修复（覆盖螺丝）</label>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;float: right;">
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="afterMore" type="checkbox" value="后牙多颗即刻负重（复合基台）" /><label
                                    for="afterMore">后牙多颗即刻负重（复合基台）</label>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;float: right;">
            ...
            <div class="article_two item">
                ...
                <div id="others" class="two" style="margin-left: 10px">
                    ...
                    <div style="width: 100%;float: right;">
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="composite" type="checkbox" value="下颌+复合基台+即刻负重" /><label
                                    for="composite">下颌+复合基台+即刻负重</label>
                            </li>
                            <li>
                        ...
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="deferredLoad" type="checkbox"
                                    value="下颌+覆盖螺丝+延期负重+过渡期活动牙" /><label for="deferredLoad">下颌+覆盖螺丝+延期负重+过渡期活动牙</label>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;float: right;">
                    ...
                    <div style="width: 100%;float: right;">
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="focus" type="checkbox" value="重点位大量植骨、骨劈开+同期种植+螺丝1" /><label
                        ...
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="All-on-X" type="checkbox"
                                    value="All-on-X即刻负重+个别值体覆盖螺丝" /><label for="All-on-X">All-on-X即刻负重+个别值体覆盖螺丝</label>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="locatorHalfdown" type="checkbox"
                                    value="Locator半口（下颌螺丝）" /><label for="locatorHalfdown">Locator半口（下颌螺丝）</label>
                            </li>
                            <li>
                        ...
                        <ul class="loseTooth_option">
                            <li>
                                <input name="clinical" id="locatorAbutmentdown" type="checkbox"
                                    value="Locator半口（下颌基台）" /><label for="locatorAbutmentdown">Locator半口（下颌基台）</label>
                            </li>
                            <li>
                                <input name="clinical" id="locatorAbutmentup" type="checkbox"
                                    value="Locator半口（上颌基台）" /><label for="locatorAbutmentup">Locator半口（上颌基台）</label>
                            </li>
                        </ul>
                    </div>
                </div>
