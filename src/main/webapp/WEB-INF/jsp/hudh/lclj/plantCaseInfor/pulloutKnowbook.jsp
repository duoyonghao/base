			...
			<div class="row" style="">
				<div class="col-md-12 col-sm-12 col-xs-12 colDefined" style="padding:0px;">
					...
					<div class="rpInfo_import margintop1" style="width: 100%;overflow: hidden;">
						...
						<div style="float:left;width:82.5%;position: relative;">
							<span id="allergy" class="textAuto_element allergy" placeholder='请输入过敏药物' onkeyup="diagnoseTextBorder(this.id);" style="font-size: 16px;font-weight: bold;color: #00a6c0;" contenteditable="true"></span>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row" style="">
				<div class="col-md-12 col-sm-12 col-xs-12 colDefined" style="padding:0px;">
					...
					<div class="rpInfo_import" style="width: 100%;overflow: hidden;">
						...
						<div style="float:left;width:82.5%;position: relative;">
							<span id="treatmentparts" class="textAuto_element treatmentparts" placeholder='请输入治疗部位' onblur="importTextLengthCheck(this.id,120);" onkeyup="diagnoseTextBorder(this.id);" style="font-size: 16px;font-weight: bold;color: #00a6c0;" contenteditable="true"></span>
						</div>
					</div>
				</div>
			</div>
			<div class="row" style="margin-bottom: 1%;">
				<div class="col-md-12 col-sm-12 col-xs-12 colDefined" style="padding:0px;">
					...
					<div class="rpInfo_import" style="width: 100%;overflow: hidden;">
						...
						<div style="float:left;width:82.5%;position: relative;">
							<span id="diagnose" class="textAuto_element diagnose" placeholder='请输入诊断明细' onkeyup="diagnoseTextBorder(this.id);" style="font-size: 16px;font-weight: bold;color: #00a6c0;" contenteditable="true"></span>
						</div>
					</div>
				</div>
			</div>
