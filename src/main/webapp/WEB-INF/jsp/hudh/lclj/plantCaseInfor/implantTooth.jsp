...
<!--startprint-->
	<div id="content">
		...
		<div class="consent_text consent_textInput margin">
			<font>2、我同意医生采用下述治疗方案（详见治疗方案确认书）</font>
			<div>
			<font class="top">首次种植牙位为</font>
			<ul class="tooth_map">
				<li>
			...
			<div style="margin-top: 13px;">
			  <div style="float: left;margin-right: 37px;">
				  <span>种植系统</span>
				  <span class="plantingsystemselectText"></span>
	...
	<script type="text/javascript">
		...
		function update(){
			...
			var repairselect = JSON.stringify($("#repairselect").val()); //修复方式
		...
		function save() {
			...
			//新增参数
			var plantingsystemselect = JSON.stringify($("#plantingsystemselect").val()); //种植体系
			var repairselect = JSON.stringify($("#repairselect").val())
			console.log(repairselect,"repairselect")
