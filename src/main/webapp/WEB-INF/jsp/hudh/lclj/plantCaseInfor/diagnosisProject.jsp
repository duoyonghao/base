        ...
        if(form){
            ...
            if (form.id) {
                ...
                for (var key in form) {
                    ...
                    $("#remark").text(form["remark"]);//textarea赋值
                    $("#remark").trigger("keyup");
                    $("#replaceBox").text(form["remark"]);//textarea替换框赋值
                ...
                if (form.doctorsignature != "" && form.doctorsignature != null) {
                ...
                if (form.patientsignature != "" && form.patientsignature != null) {
