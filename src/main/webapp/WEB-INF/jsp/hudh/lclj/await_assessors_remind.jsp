...
var pageurl = '<%=contextPath%>/HUDH_LcljCheckRecordAct/getAwaitCheckRecord.act';
$(function() {		
	inittable();
});
...
// 		             }
				console.log(JSON.stringify(row)+"------row");
			    		 window.location.href=contextPath+'/ClinicPathControllerAct/toLcljPageFetchInfo.act?menuId=600309&&userId='+row.blcode+'&&username='+row.username;	 
