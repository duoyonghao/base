...
<div id="repair_continer" class="container-fluid">
    ...
    <%--<div class="row restore" style="border-bottom: 2px solid #776c6c;margin-top:20px;">
        &lt;%&ndash;<img id="logoImg" src="<%=contextPath%>/static/image/kqdsFront/jiagong/logoName.png">
        <i class="line"></i>&ndash;%&gt;
    ...
    <!-- 患者详细信息 -->
    <div class="row patient" style="border-top: 2px solid #776c6c;border-bottom: 2px solid #776c6c;">
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="toothMapdiv_B">
                                    ...
                                    <ul class="tooth_map">
                                        <li>
                                            <input id="dentiumleftup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="dentiumrightup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="dentiumleftdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="dentiumrightdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="toothMapdiv_B">
                                    ...
                                    <ul class="tooth_map">
                                        <li>
                                            <input id="nobelactiveleftup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="nobelactiverightup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="nobelactiveleftdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="nobelactiverightdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="toothMapdiv_B">
                                    ...
                                    <ul class="tooth_map">
                                        <li class="lodopPrintborder">
                                            <input id="camlogleftup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="camlogrightup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li class="lodopPrintborder">
                                            <input id="camlogleftdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="camlogrightdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="toothMapdiv_B">
                                    ...
                                    <ul class="tooth_map">
                                        <li>
                                            <input id="hiossenleftup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="hiossenrightup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="hiossenleftdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="hiossenrightdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="toothMapdiv_B">
                                    ...
                                    <ul class="tooth_map">
                                        <li>
                                            <input id="nobelpmcleftup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="nobelpmcrightup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="nobelpmcleftdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="nobelpmcrightdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="toothMapdiv_B">
                                    ...
                                    <ul class="tooth_map">
                                        <li>
                                            <input id="zimmerleftup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="zimmerrightup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="zimmerleftdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="zimmerrightdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="toothMapdiv_B">
                                    ...
                                    <ul class="tooth_map">
                                        <li>
                                            <input id="bbleftup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="bbrightup" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                                            <input id="bbleftdown" onblur="TextLengthCheck(this.id,10);"
                                                   class="tooth_input" type="text">
                                        </li>
                                        <li>
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="toothMapdiv_B">
                                ...
                                <ul class="tooth_map">
                                    <li>
                                        <input id="rbrdleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                               type="text">
                                    </li>
                                    <li>
                                        <input id="rbrdrigthup" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="rbrdleftdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="rbrdrigthdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="toothMapdiv_B">
                                ...
                                <ul class="tooth_map">
                                    <li>
                                        <input id="invidenleftup" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="invidenrightup" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="invidenleftdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="invidenrightdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="toothMapdiv_B">
                                ...
                                <ul class="tooth_map">
                                    <li>
                                        <input id="locatorleftup" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="locatorrightup" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="locatorleftdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="locatorrightdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="toothMapdiv_B">
                                ...
                                <ul class="tooth_map">
                                    <li class="lodopPrintborder">
                                        <input id="srrleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                               type="text">
                                    </li>
                                    <li>
                                        <input id="srrrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                               type="text">
                                    </li>
                                    <li class="lodopPrintborder">
                                        <input id="srrleftdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="srrrightdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            ...
                            <div class="toothMapdiv_B">
                                ...
                                <ul class="tooth_map">
                                    <li>
                                        <input id="retainerleftup" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="retainerrightup" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="retainerleftdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                    <li>
                                        <input id="retainerrightdown" onblur="TextLengthCheck(this.id,10);"
                                               class="tooth_input" type="text">
                                    </li>
                                </ul>
                            </div>
    ...
    <div class="row" style="background: #f5f5f5;padding:0 16px;">
                ...
                <div class="zl_toothMapdiv">
                    <div class="col-md-12 col-sm-12 col-xs-12 colDefined" style="width:100%;padding:0px;">
                        ...
                        <ul class="moreSelect_div">
                            ...
                            <li style="width:80px;"><label><input type="checkbox" name="singlecompselect"
                                                                  value="塑钢牙PVC"/><span>塑钢牙PVC</span></label></li>
                            <li style="width:80px;"><label><input type="checkbox" name="singlecompselect"
                                                                  value="树脂牙"/><span>树脂牙</span></label></li>
                            <li style="width:120px;"><label><input type="checkbox" name="singlecompselect"
                                                                   value="钴铬支架Co-Cr"/><span>钴铬支架Co-Cr</span></label>
                            </li>
                            <li style="width:80px;"><label><input type="checkbox" name="singlecompselect" value="纯钛支架"/><span>纯钛支架</span></label>
                            </li>
                            <li style="width:100px;"><label><input type="checkbox" name="singlecompselect"
                                                                   value="维他灵支架"/><span>维他灵支架</span></label></li>
                            <li style="width:80px;"><label><input type="checkbox" name="singlecompselect"
                                                                  value="其他"/><span>其他</span></label></li>
                        </ul>
                    </div>
                    <!-- <div class="overstriking">1.全口/半口半固定</div> -->
                    <ul class="tooth_map" style="width: 30%;margin-left: 3%;">
                        <li>
                            <input id="singlecompleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="singlecomprightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="singlecompleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="singlecomprightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                    </ul>
                </div>
                ...
                <div class="zl_toothMapdiv">
                    <div class="col-md-12 col-sm-12 col-xs-12 colDefined" style="width:100%;padding:0px;">
                        ...
                        <ul class="moreSelect_div">
                            ...
                            <li><label><input type="checkbox" name="sfsincomselect"
                                              value="聚合瓷牙"/><span>聚合瓷牙</span></label></li>
                            <li><label><input type="checkbox" name="sfsincomselect" value="塑钢牙PVC"/><span>塑钢牙PVC</span></label>
                            </li>
                            <li><label><input type="checkbox" name="sfsincomselect"
                                              value="全瓷牙"/><span>全瓷牙</span></label></li>
                            <li><label><input type="checkbox" name="sfsincomselect"
                                              value="树脂牙"/><span>树脂牙</span></label></li>
                            <li><label><input type="checkbox" name="sfsincomselect"
                                              value="纯钛支架"/><span>纯钛支架</span></label></li>
                            <li><label><input type="checkbox" name="sfsincomselect" value="其他"/><span>其他</span></label>
                            </li>
                        </ul>
                    </div>
                    ...
                    <ul class="tooth_map" style="width: 30%;margin-left: 3%; ">
                        <li>
                            <input id="sfsincomleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="sfsincomrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="sfsincomleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="sfsincomrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                    </ul>
                </div>
                ...
                <div class="zl_toothMapdiv">
                    <div class="col-md-12 col-sm-12 col-xs-12 colDefined" style="width:100%;padding:0px;">
                        ...
                        <ul class="moreSelect_div">
                            ...
                            <li><label><input type="checkbox" name="localplantselect"
                                              value="钴铬烤瓷"/><span>钴铬烤瓷</span></label></li>
                            <li><label><input type="checkbox" name="localplantselect"
                                              value="聚合瓷"/><span>聚合瓷</span></label></li>
                            <li><label><input type="checkbox" name="localplantselect" value="国产氧化锆"/><span>国产氧化锆</span></label>
                            </li>
                            <li><label><input type="checkbox" name="localplantselect"
                                              value="Lava"/><span>Lava</span></label></li>
                            <li><label><input type="checkbox" name="localplantselect" value="泽康氧化锆"/><span>泽康氧化锆</span></label>
                            </li>
                            <li><label><input type="checkbox" name="localplantselect"
                                              value="威兰德锆"/><span>威兰德锆</span></label></li>
                            <li><label><input type="checkbox" name="localplantselect"
                                              value="杜莎拉姆"/><span>杜莎拉姆</span></label></li>
                            <li><label><input type="checkbox" name="localplantselect"
                                              value="瑞典瓷"/><span>瑞典瓷</span></label></li>
                            <li><label><input type="checkbox" name="localplantselect"
                                              value="其他"/><span>其他</span></label></li>
                        </ul>
                    </div>
                    <ul class="tooth_map" style="width: 30%;margin-left: 3%;">
                        <li>
                            <input id="localplantleftup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="localplantrightup" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="localplantleftdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                        <li>
                            <input id="localplantrightdown" onblur="TextLengthCheck(this.id,10);" class="tooth_input"
                                   type="text">
                        </li>
                    </ul>
                </div>
        ...
        <div class="row">
            ...
            <div class="consent_remark">
                ...
                <textarea id="requirerestor" rows="" cols="" autoHeight="true"
                          style="border: 1px solid #ddd;margin:15px 10px 5px 10px;overflow-y: hidden;"></textarea>
            </div>
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 colDefined">
            <div class="zl_signature" style="display: flex;justify-content: space-between;">
                ...
                <input id="operationdoctortime" type="text" class="consent_time signature_time inputheight2"
                       readonly="readonly" placeholder="请选择日期" style="width:20%;min-width: 70px;"/>
            </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-4 colDefined">
            <div class="zl_signature" style="display: flex;justify-content: space-between;">
                ...
                <input id="doctortime" type="text" class="consent_time signature_time inputheight2" readonly="readonly"
                       placeholder="请选择日期" style="width:20%;min-width: 70px;"/>
            </div>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-4 colDefined">
            <div class="zl_signature" style="display: flex;justify-content: space-between;">
...
//			var smallParticle = $("#smallParticle").val();
        ...
        //B&B
        var bbleftup = $("#bbleftup").val();
        var bbrightup = $("#bbrightup").val();
        var bbleftdown = $("#bbleftdown").val();
        var bbrightdown = $("#bbrightdown").val();
...
//			var titaniumMesh = $("#titaniumMesh").val();
        ...
        var param = {
            ...
            bbleftup: bbleftup,
            bbleftdown: bbleftdown,
            bbrightup: bbrightup,
            bbrightdown: bbrightdown,
            ...
            //operationDoctorsignature : operationDoctorsignature,//手术医生签名
            operationDoctorTime: operationDoctorTime,//手术医生签名时间
            //repairDoctorsignature : repairDoctorsignature,//修复医生签名
