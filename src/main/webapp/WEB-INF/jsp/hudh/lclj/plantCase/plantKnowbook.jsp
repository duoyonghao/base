...
<div id="content">
	...
	<div class="consent_text consent_textInput margin">
		...
		<ul class="tooth_map">
			<li>
				<input id="uplefttoothbittwo" oninput="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
			</li>
			<li>
				<input id="uperrighttoothbittwo" oninput="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
			</li>
			<li>
				<input id="leftlowertoothbittwo" oninput="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
			</li>
			<li>
				<input id="lowrighttoothbittwo" oninput="TextLengthCheck(this.id,10);" class="tooth_input" type="text">
			</li>
		</ul>
	...
	<div><font>替代方案:</font>&nbsp;&nbsp;<input type="checkbox" value="活动义齿修复" class="inputstyle" id="removabledenture"/>&nbsp;&nbsp;<label for="removabledenture">活动义齿修复</label>&nbsp;&nbsp;<input type="checkbox" class="inputstyle" id="fixeddenture" value="固定义齿修复"/>&nbsp;&nbsp;<label for="fixeddenture">固定义齿修复</label></div>
	<div class="consent_text">
	...
	<div id="consent_signature" style="width:100%;">
		<!-- 患者签名 -->
		<div class="signature_time" style="margin-top: 1%;float: left;width:50%;">
			<div class="signature_box" style="width: 100%;">
				<span id="patientSignature">患者签名:</span>
				<img id="patientimg" style=" width: 31%;height:auto;"/>
				<input id="patienttime" type="text" class="consent_time inputheight inputheight2" readonly="readonly" style="width: 41%;text-align: center;" placeholder="请选择日期"/>
			</div>

		</div>
		<!-- 医生签名 -->
		<div class="signature_time" style="margin-top: 1%;float:right;width:50%;">
			<div class="signature_box" style="width: 100%;">
				<span id="doctorSignature">医生签名:</span>
				<img id="img" style="width: 31%;height:auto;"/>
				<input id="doctortime" type="text" class="consent_time inputheight inputheight2" readonly="readonly" style="width: 41%;text-align: center;" placeholder="请选择日期"/>
			</div>
		</div>
	</div>
	<!--endprint-->
...
// 			LODOP.ADD_PRINT_HTM(10,10,"100%","100%",html);
    ...
    function update(){
        ...
        //console.log(JSON.stringify(param)+"------------修改参数bb");
