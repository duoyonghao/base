            ...
            <div class="row teethClean">
                <div class="col-md-1 col-sm-1 col-xs-1 colDefined">
                    ...
                    <div class="zl_optiondiv" style="line-height: 40px;">
                        <input type="checkbox" value="洁牙" name="treamentplan" id="treamentplanA"
                ...
                <div class="col-md-1 col-sm-1 col-xs-1 colDefined">
                    <!-- 选项框 -->
                    <div class="zl_optiondiv" style="line-height: 40px;">
                        <input type="checkbox" value="刮治" name="treamentplan" id="treamentplanB"
                               style="vertical-align: text-bottom;"/>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-4 colDefined">
                        ...
                        <div class="zl_toothMapdiv">
                            ...
                            <ul class="tooth_map" style="width:80%;height:80px;margin-left: 10%;">
                                <li>
                                    <input id="extractionleftup" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="extractionrightup" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="extractionleftdown" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="extractionrightdown" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 colDefined">
                        ...
                        <div class="zl_toothMapdiv">
                            ...
                            <ul class="tooth_map" style="width:80%;margin-left: 10%;">
                                <li>
                                    <input id="implantfirsttimelu" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="implantfirsttimeru" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="implantfirsttimeld" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="implantfirsttimerd" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4 colDefined">
                        ...
                        <div class="zl_toothMapdiv">
                            ...
                            <ul class="tooth_map" style="width:80%;margin-left: 10%;">
                                <li>
                                    <input id="implantsecondtimelu" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="implantsecondtimeru" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="implantsecondtimeld" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="implantsecondtimerd" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="writein_group periosteum">
                            <ul>
                                ...
                                <li style="margin-right: 50px;">
                                    <div class="zl_fillWritediv">
                                        <span>小</span>
                                        <input type="text" onblur="TextLengthCheck(this.id,10);"
                                               id="collagenmembsmall"/>
                                        <span>张</span>
                                    </div>
                                </li>
                                <li style="width: 22%;">
                        ...
                        <div class="zl_multiple auxiliary_operation">
                            ...
                            <ul>
                                ...
                                <li style="width: 15%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="上颌窦提升" name="implantassistantsurgery"
                                               id="implantassistantsurgeryA" style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 13%;">
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="内提" name="implantassistantsurgery"
                                               id="implantassistantsurgeryB" style="vertical-align: text-bottom;"/>
                                        <label for="implantassistantsurgeryB"><!-- ( -->内提</label>
                                    </div>
                                </li>
                                <li style="width: 13%;">
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="外提" name="implantassistantsurgery"
                                               id="implantassistantsurgeryC" style="vertical-align: text-bottom;"/>
                                        <!-- <span>)</span> -->
                                ...
                                <li>
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="骨劈开" name="implantassistantsurgery"
                                               id="implantassistantsurgeryD" style="vertical-align: text-bottom;"/>
                                ...
                                <li>
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="骨挤压" name="implantassistantsurgery"
                                               id="implantassistantsurgeryE" style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 15%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="自体骨移植" name="implantassistantsurgery"
                                               id="implantassistantsurgeryF" style="vertical-align: text-bottom;"/>
                        ...
                        <div class="zl_multiple">
                            ...
                            <ul>
                                ...
                                <li style="width: 15%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="局部" name="repairemethod" id="repairemethodA"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 13%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="连桥" name="repairemethod" id="repairemethodB"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 13%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="杆卡" name="repairemethod" id="repairemethodC"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 14%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="套筒" name="repairemethod" id="repairemethodD"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 14%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="球帽" name="repairemethod" id="repairemethodE"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 15%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="磁性修复" name="repairemethod" id="repairemethodF"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 15%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="Locator" name="repairemethod" id="repairemethodG"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 13%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="All-on-x" name="repairemethod" id="repairemethodH"
                                               style="vertical-align: text-bottom;"/>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 colDefined">
                        <div class="zl_multiple">
                            ...
                            <ul>
                                <li style="width: 15%;">
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="术前取模" name="modulodesign" id="modulodesignA"
                                               style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width: 17%;">
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="手术模板设计" name="modulodesign" id="modulodesignB"
                                               style="vertical-align: text-bottom;"/>
                        ...
                        <div class="zl_multiple">
                            ...
                            <ul style="width:100%;">
                                ...
                                <li style="width:14%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="无" name="tempordentcondition"
                                               id="tempordentconditionA" style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width:16%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="压膜临时牙" name="tempordentcondition"
                                               id="tempordentconditionB" style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width:14%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="活动牙" name="tempordentcondition"
                                               id="tempordentconditionC" style="vertical-align: text-bottom;"/>
                                ...
                                <li style="width:14%;">
                                    <!-- 选项框 -->
                                    <div class="zl_optiondiv">
                                        <input type="checkbox" value="旧义齿" name="tempordentcondition"
                                               id="tempordentconditionD" style="vertical-align: text-bottom;"/>
                    ...
                    <div class="col-md-7 col-sm-7 col-xs-7 colDefined">
                        ...
                        <div class="zl_toothMapdiv" style="    display: flex;">
                            ...
                            <ul class="tooth_map" style="width: 50%;height: 60px; margin-top: 13px;">
                                <li>
                                    <input id="treatmentotherorallu" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="treatmentotheroralru" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="treatmentotheroralld" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                                <li>
                                    <input id="treatmentotheroralrd" onblur="TextLengthCheck(this.id,10);"
                                           class="tooth_input" type="text">
                                </li>
                            </ul>
                            ...
                            <div class="zl_multiple">
                                ...
                                <ul>
                                    ...
                                    <li style="width:14%;">
                                        <!-- 选项框 -->
                                        <div class="zl_optiondiv">
                                            <input type="checkbox" value="Hiossem" name="implantsystem"
                                                   id="implantsystemE" style="vertical-align: text-bottom;"/>
                                    ...
                                    <li style="width:16%;">
                                        <!-- 选项框 -->
                                        <div class="zl_optiondiv">
                                            <input type="checkbox" value="Nobel-PMC" name="implantsystem"
                                                   id="implantsystemF" style="vertical-align: text-bottom;"/>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        /* for(var key in window.parent.consultSelectPatient){
            console.log(key+"---得到选中的患者信息---"+window.parent.consultSelectPatient[key]);
        }  */
        initZzblInfor();
    ...
    if (userAgent.indexOf("iPad") > -1) {
        $("#diagnosis_continer .zl_optiondiv").css('width', '150px');
        $(".zl_toothMapdiv>.toothExtraction>span").css('left', '110px');
        $(".assist").css('width', '18%');
    ...
    function initZzblInfor() {
        ...
        $.ajax({
            ...
            success: function (result) {
                //console.log(JSON.stringify(result)+"--------------添加成功后查询数据aaaaaa");
                var result;
                if (seqidFather) {
...
//	        	console.log(JSON.stringify(r)+"----------保存成功返回值！");
            layer.alert("修改成功！", {
                    ...
                    var ifreamSrc = window.parent.document.getElementById("myiframe").getAttribute("src"); //刷新父页面
                    var ifream = window.parent.document.getElementById("myiframe");
                    ifream.setAttribute("src", ifreamSrc);
    ...
    function save() {
        ...
        var implantSecondTimeRU = $("#implantsecondtimeru").val();
        var implantSecondTimeLD = $("#implantsecondtimeld").val();
        var implantSecondTimeRD = $("#implantsecondtimeru").val();
        var implantAssistantSurgery = showImplantAssistantSurgery();
        var treatmentOtherOralLU = $("#treatmentotherorallu").val();
        var treatmentOtherOralRU = $("#treatmentotheroralru").val();
        var treatmentOtherOralLD = $("#treatmentotheroralld").val();
