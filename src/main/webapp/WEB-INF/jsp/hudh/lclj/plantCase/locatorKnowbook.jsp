...
<!-- 				<div class="col-md-12 col-sm-12 col-xs-12 colDefined" style="padding:0px;"> -->
					<!-- 信息输入组合框 -->
<!-- 						<div class="rpInfo_import" style="width: 100%;overflow: hidden;"> -->
<!-- 							<span style="float:left;">地<font style="display:inline-block;margin-left: 2em;">址：</font></span> -->
<!-- 							<div style="float:left;width:91.5%;position: relative;"> -->
<!-- 								<span id="address" class="textAuto_element" onblur="importTextLengthCheck(this.id,60);" onkeyup="diagnoseTextBorder(this.id);" style="font-size: 16px;font-weight: bold;" contenteditable="true"></span> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- <!-- 				</div> --> 
<!-- 			</div> -->
		...
		<i class="line"></i>
		<div class="consent_text verify" style="font-weight: bold;text-indent: 0em; margin-top:7%;">
