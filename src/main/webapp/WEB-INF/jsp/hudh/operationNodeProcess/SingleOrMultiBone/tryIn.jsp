			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
										<li><label><i style="color: red;font-style: normal;">*</i>6、预约下次来院时间：<input class="" onfocus="popup();" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 108px;"/></label></li> 
										...
										<ul>
										  <li>
												<div class="preparation-ul">
													...
													<div><label><input name="upper_frame" type="radio" value="有" />有</label></div>
													<div><label><input name="upper_frame" type="radio" value="无" />无</label></div>
												</div>
											</li>
