			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>4、<input name="wearTooth" type="checkbox" value="4、戴牙" id="wearTooth"/>戴牙</label></li>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>5、拍X片：</span></div>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>6、<input name="isphotograph" type="checkbox" value="6、拍照" id="isphotograph"/>拍照</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li style="line-height: 24px;height: 60px;"><label><i style="color: red;font-style: normal;">*</i>7、<input name="announcements" type="checkbox" value="7、交代注意事项（口腔卫生维护、咬合力控制、定期复查、不适随诊）" id="announcements"/>交代注意事项<br>（口腔卫生维护、咬合力控制、定期复查、不适随诊）</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i>8、预约下次来院时间：<input class="" onfocus="popup();" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 108px;"/></label></li>
											<!-- <li><label>6、预约下次来院时间：<input class="time_initialize" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;"/></label></li>  -->
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<!-- <li><label><input name="isphotograph" type="checkbox" value="7、拍照" id="isphotograph"/>7、拍照</label></li> -->
											<!-- <li><label><input name="announcements" type="checkbox" value="8、交代注意事项（口腔卫生维护、咬合力控制、定期复查、不适随诊）" id="announcements"/>8、交代注意事项<br>（口腔卫生维护、咬合力控制、定期复查、不适随诊）</label></li> -->
											<!-- <li><label><input name="complete_case_record" type="checkbox" value="9、完成病历记录" id="complete_case_record"/>9、完成病历记录</label></li> -->
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>9、有无变异：</span></div>
													<div><label><input name="is_loose" type="radio" value="有" />有</label></div>
													<div><label><input name="is_loose" type="radio" value="无" />无</label></div>
												</div>
											</li>
											<li><label>10、<input name="tryHolderOrBasalCrowns" type="checkbox" value="10、请上级医师会诊" id="isphotograph"/>请上级医师会诊</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i>11、<input name="complete_case_record" type="checkbox" value="11、完成病历记录" id="complete_case_record"/>完成病历记录</label></li>
										</ul>
									</div>
								</td>																
							</tr>
...
function initWearTooth() {
	$.ajax({
		...
		success:function(data){
			//console.log(JSON.stringify(data)+"---------------faf");
			if (nodeSta == 2) {
