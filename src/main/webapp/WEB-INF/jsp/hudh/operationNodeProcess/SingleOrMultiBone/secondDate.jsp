			...
			<tbody>
							<tr>
								<td  style="width:25%;">
									<div style="">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>1、二期手术时间：<input class="time_initialize" readonly="readonly" placeholder="请选择日期" name="twoDateStitchesTime" type="text" id="twoDateStitchesTime" value="" style="width: 105px;"/></label></li>
											<li>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="complete_case_record" type="checkbox" value="12、临床路径录入" id="complete_case_record"/>12、临床路径录入</label></li>
										</ul>
									</div>	
								</td>																
							</tr>
...
function initSecondDate() {
	$.ajax({
		...
		success:function(data){
			...
			$("#observe_wound").val(data.observe_wound);//术区清洁情况
