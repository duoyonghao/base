			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="basalCrowns" type="checkbox" value="6、试基底冠、比色" id="basalCrowns"><i style="color: red;font-style: normal;">*</i>6、试基底冠、比色</label></li>
											<li><label><input name="announcements" type="checkbox" value="7、交代注意事项" id="announcements"/><i style="color: red;font-style: normal;">*</i>7、交代注意事项</label></li>
											<li><label><input name="complete_case_record" type="checkbox" value="8、完成病历记录" id="complete_case_record"/><i style="color: red;font-style: normal;">*</i>8、完成病历记录</label></li>
										</ul>
									</div>	
								</td>
								<td style="width:25%;">
