			...
			<tbody>
						<tr>
							<td style="width:25%;">
								<div style="">
									<ul>
										<li><label><i style="color: red;font-style: normal;">*</i>1、复查时间：<input class="time_initialize" name="operation_time" type="text" id="operation_time" value="" style="width: 105px;vertical-align:middle;" readonly="readonly" placeholder="请选择日期"/></label></li>
							...
							<td style="width:25%;">
								<div style="margin-left: 68px;">
									<ul>
										<!-- <li><label>7、<input name="preoperative_verification" type="checkbox" value="7、根据患者当时病情决定检查项目" id="preoperative_verification"/>根据患者当时病情决定检查项目</label></li> -->
										<!-- <li>
											<div class="preparation-ul">
												<div><span style="font-weight: bold;" class="">6、根据患者当时病情决定检查项目：</span></div>
												<div><label><input name="abutment_station" type="checkbox" value="全景片" />全景片</label></div>
												<div><label><input name="abutment_station" type="checkbox" value="CT" />CT</label></div>
										...
										<li><label><i style="color: red;font-style: normal;">*</i>5、<input name="announcements" type="checkbox" value="5、交代注意事项" id="announcements"/>交代注意事项</label></li> 
										<li>
											<div class="preparation-ul">
												<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>6、有无变异：</span></div>
												<div><label><input name="is_loose" type="radio" value="有" />有</label></div>
												<div><label><input name="is_loose" type="radio" value="无" />无</label></div>
											</div>
										</li>
										<!-- <li><label>6、<input name="nostitches" type="checkbox" value="5、非微创拆线"  id="nostitches">非微创拆线</label></li>
										<li>
											<div class="preparation-ul">
												<div><span style="font-weight: bold;" class="">7、是否松动：</span></div>
												<div><label><input name="is_loose" type="radio" value="是" />是</label></div>
												<div><label><input name="is_loose" type="radio" value="否" />否</label></div>
											</div>
										</li> -->
									</ul>
								</div>	
							...
							<td style="width:25%;">
								<div style="margin-left: 68px">
									<ul>
										<li><label>7、<input name="nostitches" type="checkbox" value="7、请上级会诊"  id="nostitches">请上级会诊</label></li>
										<li><label><i style="color: red;font-style: normal;">*</i>8、预约下次来院时间：<input class="" name="next_hospital_time" onfocus="popup();" type="text" value=""  id="next_hospital_time" style="width: 108px;vertical-align:middle;"/></label></li>
									</ul>
								</div>
							</td>
							<td style="width:25%;">
								<div style="margin-left: 68px">
									<ul>
										<li><label><i style="color: red;font-style: normal;">*</i>9、<input name="complete_case_record" type="checkbox" value="9、完成病历记录" id="complete_case_record"/>完成病历记录</label></li>
										<li><label><i style="color: red;font-style: normal;">*</i>10、<input name="enterLclj" type="checkbox" value="10、完成临床路径录入" id="enterLclj"/>完成临床路径录入</label></li>
									</ul>
								</div>
							</td>																
						</tr>							
...
// var repair_physician = parent.patientObj.repair_physician
$(function(){
 //时间选择
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
            ...
            //console.log(select_nostitches+"--------请上级会诊");
