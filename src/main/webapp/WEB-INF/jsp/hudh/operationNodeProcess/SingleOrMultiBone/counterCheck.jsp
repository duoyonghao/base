							...
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>1、二期拆线时间：<input class="time_initialize" name="twoDateStitchesTime" type="text" id="twoDateStitchesTime" value="" style="width: 105px;"/></label></li>
											<li><label>2、术区清洁情况：
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="is_stitches" type="checkbox" value="4、拆线" id="is_stitches">4、拆线</label></li>
											<li><label>5、预约下次来院时间：<input class="time_initialize" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;"/></label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="small_teeth" type="checkbox" value="9、影像学检查 ：曲面断层片 小牙片" id="small_teeth"/>9、影像学检查 ：曲面断层片 小牙片 </label></li>
											<li><label><input name="opration_record" type="checkbox" value="10、术者完成手术记录" id="opration_record"/>10、术者完成手术记录</label></li>
										</ul>
									</div>	
								</td>
