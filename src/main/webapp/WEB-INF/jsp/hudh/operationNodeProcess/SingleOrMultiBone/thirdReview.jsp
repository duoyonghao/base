			...
			<tbody>
							<tr>
								<td style="width:25%;">
									<div style="">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>1、复查时间：<input class="time_initialize" name="operation_time" type="text" id="operation_time" value="" readonly="readonly" placeholder="请选择日期" style="width: 105px;"/></label></li>
										...
										<ul>
											 <li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>4、根据患者当时病情决定检查项目：</span></div>
