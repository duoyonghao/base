			...
			<tbody>
							<tr style="width:25%;">
								<td>
									<div style="">
										<ul>
											<li><label><span style="color: red;">*</span>1、复查时间：<input name="operation_time" type="text" class="time_initialize" id="operation_time" value="" readonly="readonly" placeholder="请选择日期" style="width: 105px;vertical-align:middle;"/></label></li>
											<li><label><span style="color: red;">*</span>2、术区清洁情况：
											...
											<li><label><span style="color: red;">*</span>3、检查伤口愈合情况：
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><span style="color: red;">*</span>4、检查种植体骨结合情况：
											...
											<!-- <li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class="">5、检查咬合：</span></div>
											...
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><span style="color: red;">*</span>5、根据患者当时病情决定检查项目：</span></div>
											...
											<li><label><span style="color: red;">*</span>6、<input name="announcements" type="checkbox" value="6、交代注意事项" id="announcements"/>交代注意事项</label></li>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><span style="color: red;">*</span>7、有无变异：</span></div>
													<div><label><input name="is_loose" type="radio" value="有" />有</label></div>
													<div><label><input name="is_loose" type="radio" value="无" />无</label></div>
												</div>
											</li>
											<li><label>8、<input name="nostitches" type="checkbox" value="8、请上级会诊"  id="nostitches">请上级会诊</label></li>
											<li><label><span style="color: red;">*</span>9、预约下次来院时间：<input class="" name="next_hospital_time"  type="text" value="" onfocus="popup();" id="next_hospital_time" style="width: 108px;vertical-align:middle;"/></label></li> 	
										</ul>
									</div>
								</td>
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><span style="color: red;">*</span>10、<input name="complete_case_record" type="checkbox" value="10、完成病历记录" id="complete_case_record"/>完成病历记录</label></li>
											<li><label><span style="color: red;">*</span>11、<input name="enterLclj" type="checkbox" value="11、完成临床路径录入" id="enterLclj"/>完成临床路径录入</label></li>
										</ul>
									</div>
								</td>																
							</tr>							
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
			/* console.log(JSON.stringify(data)+"----------------fds"); */
			if (nodeSta == 2) {
			...
			/* 检查咬合赋值 */
			var checkOcclusion = data.checkocclusion;
			$("input[name='checkOcclusion']").each(function(){
				if($(this).val()==checkOcclusion){
