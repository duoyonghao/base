			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="completeTwoOperation" type="checkbox" value="4、完成二期手术" id="completeTwoOperation">4、完成二期手术</label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="small_teeth" type="checkbox" value="8、影像学检查 ：曲面断层片 小牙片" id="small_teeth"/>8、影像学检查 ：曲面断层片 小牙片 </label></li>
