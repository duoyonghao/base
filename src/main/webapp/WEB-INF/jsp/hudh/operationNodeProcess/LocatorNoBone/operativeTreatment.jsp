			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="confirmOcclusalRelationship" type="checkbox" value="14、确定咬合关系" id="confirmOcclusalRelationship"/>14、确定咬合关系</label></li>
											<li><label><input name="makeTransitionDenture" type="checkbox" value="15、制作过渡义齿" id="makeTransitionDenture"/>15、制作过渡义齿</label></li>
											<li><label><input name="doctorWrittenRecords" type="checkbox" value="16、取模医生书写病程记录" id="doctorWrittenRecords"/>16、取模医生书写病程记录</label></li>
										</ul>
									</div>	
								</td>
								...
								<!-- <td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="antimicrobial_use" type="checkbox" value="13、术后取模" id="antimicrobial_use"/>13、术后取模 </label></li>
											<li><label><input name="announcements" type="checkbox" value="11、交代注意事项" id="announcements"/>11、交代注意事项 </label></li>
											<li><label><input name="opration_record" type="checkbox" value="12、术者完成手术记录" id="opration_record"/>12、术者完成手术记录</label></li>
										</ul>
									</div>	
...
function initOperativeTreatment() {
	$.ajax({
		...
		success:function(data) {
			...
			var doctorWrittenRecords = $("#doctorWrittenRecords").find("input[type='checkbox']");
			select_doctorWrittenRecords = data.doctorwrittenrecords;
			if (select_doctorWrittenRecords) {
				$("#doctorWrittenRecords").attr("checked","checked");
			}
