								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<!-- <li><label><input name="panoramic_view_piece" type="checkbox" value="4、拍全景片" / id="panoramic_view_piece">4、拍全景片</label></li> -->
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="complete_case_record" type="checkbox" value="5、完成病历记录" id="complete_case_record"/>5、完成病历记录</label></li>
										</ul>
									</div>	
								</td>
