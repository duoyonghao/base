							...
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="wearTooth" type="checkbox" value="4、戴牙" id="wearTooth"/>4、戴牙</label></li>
											<li>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="isphotograph" type="checkbox" value="6、拍照" id="isphotograph"/>6、拍照</label></li>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="announcements" type="checkbox" value="7、交代注意事项（口腔卫生维护、咬合力控制、定期复查、不适随诊）" id="announcements"/>7、交代注意事项<br>（口腔卫生维护、咬合力控制、定期复查、不适随诊）</label></li>
