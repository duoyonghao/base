			...
			<tbody>
				<tr>
					<td style="width:25%">
						<div style="margin-left: 40px;">
							<ul>
								...
								<!-- <li><label>3、<input name="Consultation" type="checkbox" value="口腔专科检查" disabled="disabled"/><font class="examine_diagnose">口腔专科检查</font></label></li> -->
					...
					<td style="width:25%">
						<div style="margin-left: 40px;">
							<ul>
								...
								<li><label><input name="Consultation" type="checkbox" value="向患者交代诊疗过程" disabled="disabled"/><font class="">7、告知患者手术方案、治疗计划及诊疗流程</font></label></li>	
					...
					<td style="width:20%">
						<div style="margin-left: 40px;">
							<ul>
								...
								<li><label><input name="Consultation" type="checkbox" value="口腔清洁" disabled="disabled"/>14、口腔清洁</label></li>
							</ul>
						</div>
					</td>
					...
					<td style="width:25%">
						<div style="margin-left: 40px;">
							<ul>
								<li><label><input name="Consultation" type="checkbox" value="口腔清洁" disabled="disabled"/>15、必要时牙周治疗</label></li>
								<!-- <li><label><input name="Consultation" type="checkbox" value="牙周治疗" disabled="disabled"/>14、牙周治疗</label></li> -->
								<li><label>16、<input name="Consultation" type="checkbox" value="检验：血常规、血糖、感染性疾病、凝血4项" disabled="disabled"/>检验：血常规、血糖、感染性疾病、凝血功能4项</label></li>
								<li>
								...
								<li style="margin-top: 0px;"><label>18、安排预约手术时间：<input class="time_initialize operation_time" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;vertical-align: middle;"/></label></li> 
							</ul>
						</div>
					</td>
				</tr>
...
$(function(){
	...
	initSelectList("zlCasesLi",3); //诊疗方案
	// 下拉框
...
function initFlow() {
	$.ajax({
		...
		success:function(result){
			...
			//console.log(JSON.stringify(result)+"------------返回值");
...
// 			var disease_id = select_imagelogic.split(";");
			...
			var texture_html="<span style='font-weight: bold;'>17、牙冠材质：</span>";
