...
<!-- 											<label>8、<input name="antimicrobial_use" type="checkbox" value="8、微创" id="antimicrobial_use"/>微创</label> -->
											...
											<li><label><i style="color: red;font-style: normal;">*</i>10、<input name="enterLclj" type="checkbox" value="10、临床路径录入" id="enterLclj"/>临床路径录入</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i>11、<input name="collutory" type="checkbox" value="11、漱口液含漱、抗菌药物使用3-5天" id="collutory"/>漱口液含漱、抗菌药物使用3-5天</label></li>
										</ul>
									</div>	
								</td>
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>12、拍X片：</span></div>
...
<%--													<div><label><input name="intraoperativeMedication" type="radio" value="局部" /><font class="attention_topo">局部</font></label></div>--%>
											...
											<li><label>14、预约下次复查时间：<input class="time_initialize time_select" readonly="readonly" placeholder="请选择日期" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;vertical-align: middle;"/></label></li> 
											<li>
...
<%--													<font class="operation_record">术者完成手术记录</font></label>--%>
													<font class="operation_record" style="display: none;">1.术者完成手术记录</font>
													<input name="opration_record_new" type="radio" disabled value="种植牙手术记录" id="opration_record_new"/><font class="operationRecord">种植牙手术记录</font>
											</li>
										</ul>
									</div>	
								</td>
