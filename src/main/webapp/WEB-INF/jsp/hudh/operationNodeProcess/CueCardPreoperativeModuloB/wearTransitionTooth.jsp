							...
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="wearTooth" type="checkbox" value="4、戴过渡(临时/活动)牙" id="wearTooth"/>4、戴过渡(临时/活动)牙</label></li>
											<li><label><input name="is_stitches" type="checkbox" value="5、拆线" id="is_stitches"/>5、拆线</label></li>
											<!-- <li><label><input name="small_teeth" type="checkbox" value="6、影像学检查 ：曲面断层 小牙片" id="small_teeth"/>6、影像学检查 ：曲面断层 小牙片</label></li> -->
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>6、影像学检查  ：</span></div>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="isphotograph" type="checkbox" value="7、拍照" id="isphotograph"/>7、拍照</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="announcements" type="checkbox" value="8、交代注意事项<" id="announcements"/>8、交代注意事项</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i>9、预约下次来院时间：<input class="" onfocus="popup()" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 108px;vertical-align: middle;"/></label></li> 
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>12、种植体有无变异：</span></div>
													<div><label><input name="is_loose" type="radio" value="有" />有</label></div>
													<div><label><input name="is_loose" type="radio" value="无" />无</label></div>
												</div>
											</li>
											<li><label><input name="tryHolderOrBasalCrowns" type="checkbox" value="13、请上级医师会诊" id="isphotograph"/>13、请上级医师会诊</label></li>
										</ul>
									</div>
								</td>
							</tr>
