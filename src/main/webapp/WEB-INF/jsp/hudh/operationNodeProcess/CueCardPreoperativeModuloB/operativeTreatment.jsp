								...
								<td style="width:25%;">
									<div style="z-index: 9999999 ;">
										<ul>
											...
											<input class="time_select" name="operation_time" type="text" id="operation_time" value="" readonly="readonly" placeholder="请选择日期" style="width: 105px;vertical-align: middle;" readonly="readonly"/></label></li>
...
<!-- 													<label>8、<input name="antimicrobial_use" type="checkbox" value="8、微创" id="antimicrobial_use"/>微创</label> -->
								...
								<td style="width:25%;">
									<div style="">
										<ul>
										<li><label>9、<input name="wearteeth" type="checkbox" value="9、取模定咬合" id="wearteeth"/>取模定咬合</label></li>
											<li>
												<div class="preparation-ul">
													<div style="margin-top: 7px;"><label>10、<input name="before_Modulo_bite" id="before_Modulo_bite" type="checkbox" value="术中用药" />术中用药</label></div>
											...
											<li><label><input name="try_in" type="checkbox" value="11、术后当天取模、定咬合关系" id="try_in"/>11、术后当天取模、定咬合关系</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="enterLclj" type="checkbox" value="12、临床路径录入" id="enterLclj"/>12、临床路径录入</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="collutory" type="checkbox" value="13、漱口液含漱、抗菌药物使用3-5天" id="collutory"/>13、漱口液含漱、抗菌药物使用3-5天</label></li>
										</ul>
									</div>	
								</td>
								<td style="width:25%;">
									<div style="">
										<ul>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>14、拍X片：</span></div>
											...
											<li><div class="preparation-ul">
													<div><span style="font-weight: bold;margin-bottom: 5px;" class=""><i style="color: red;font-style: normal;">*</i>15、交代注意事项：</span></div>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="opration_record" type="checkbox" value="17、术者完成手术记录" id="opration_record"/><font class="operation_record">17、术者完成手术记录</font></label></li>
										</ul>
									</div>	
								</td>
							</tr>
...
function initOperativeTreatment() {
	$.ajax({
		...
		success:function(data) {
			//console.log(JSON.stringify(data)+"==========手术治疗");
			if(!data.seq_id){
				return;
			}
			if (nodeSta == 2) {
			...
			var wearteeth = $("#wearteeth").find("input[type='checkbox']");
			select_wearteeth = data.wearteeth;
			if (select_wearteeth) {
				$("#wearteeth").attr("checked","checked");
			}
