							...
							<tr>
								<td style="width:25%;">
									<div>
										<ul>
											...
											<!-- <li><label>4、预约下次来院时间：<input name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;"/></label></li> -->
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>4、术区清洁情况：
											...
											<li><label><i style="color: red;font-style: normal;">*</i>5、预约下次来院时间：<input class="" onfocus="popup()" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 108px;"/></label></li> 
											<li><label><i style="color: red;font-style: normal;">*</i><input name="announcements" type="checkbox" value="6、交代注意事项<" id="announcements"/>6、交代注意事项</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="wearTooth" type="checkbox" value="7、完成病历记录" id="wearTooth"/>7、戴牙</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="isphotograph" type="checkbox" value="8、拍照" id="isphotograph"/>8、拍照</label></li>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>9、种植体有无变异：</span></div>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="tryHolderOrBasalCrowns" type="checkbox" value="9、请上级医师会诊" id="isphotograph"/>10、请上级医师会诊</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="complete_case_record" type="checkbox" value="10、完成病历记录" id="complete_case_record"/>11、完成病历记录</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="enterLclj" type="checkbox" value="11、完成临床路径录入" id="enterLclj"/>12、完成临床路径录入</label></li>
										</ul>
									</div>
								</td>
							</tr>
...
var username = parent.patientObj.username; /*获取患者姓名  */
var usercode = parent.patientObj.blcode;   /*获取或者病历号 */
