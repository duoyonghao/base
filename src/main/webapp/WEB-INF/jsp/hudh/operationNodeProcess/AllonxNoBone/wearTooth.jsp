			...
			<tbody>
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<!-- <li><label><input name="panoramic_view_piece" type="checkbox" value="10、拍全景片（必要时小牙片）" id="panoramic_view_piece"/>2、拍全景片（必要时小牙片）</label></li> -->
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="wearTooth" type="checkbox" value="7、完成病历记录" id="wearTooth"/>7、戴牙</label></li>
											<li><label><input name="isphotograph" type="checkbox" value="8、拍照" id="isphotograph"/>8、拍照</label></li>
										</ul>
									</div>
								</td>
