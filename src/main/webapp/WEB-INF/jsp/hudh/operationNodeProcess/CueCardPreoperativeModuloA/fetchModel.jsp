			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>7、检查口腔清洁情况：
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="basalCrowns" type="checkbox" value="8、试基底冠、比色" id="basalCrowns">8、试基底冠、比色</label></li>
