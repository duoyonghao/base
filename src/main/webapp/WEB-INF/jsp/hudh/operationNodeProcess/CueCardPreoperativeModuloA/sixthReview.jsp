			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<!-- <li><label><input name="announcements" type="checkbox" value="5、交代术后注意事项" / id="announcements">5、交代术后注意事项</label></li>
											<li><label>6、预约下次来院时间：<input name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;"/></label></li> 
											<li><label><input name="complete_case_record" type="checkbox" value="6、完成病历记录" id="complete_case_record"/>7、完成病历记录</label></li> -->
											<li><label>5、预约下次来院时间：<input class="time_initialize" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;vertical-align:middle;"/></label></li> 
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="preoperative_verification" type="checkbox" value="8、根据患者当时病情决定检查项目" id="preoperative_verification"/>8、根据患者当时病情决定检查项目</label></li>
											<li><label><input name="announcements" type="checkbox" value="9、交代注意事项" id="announcements"/>9、交代注意事项</label></li> 
