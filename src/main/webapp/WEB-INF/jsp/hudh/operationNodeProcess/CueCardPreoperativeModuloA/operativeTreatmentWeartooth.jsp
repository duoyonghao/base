...
<!-- 													<label>8、<input name="antimicrobial_use" type="checkbox" value="8、微创" id="antimicrobial_use"/>微创</label> -->
								...
								<td style="width:25%;">
									<div style="">
										<ul>
										<li><label>9、<input name="wearteeth" type="checkbox" value="9、戴临时牙" id="wearteeth"/>戴临时牙</label></li>
											<li>
												<div class="preparation-ul">
								...
								<td style="width:25%;">
									<div style="">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="opration_record" type="checkbox" value="16、术者完成手术记录" id="opration_record"/><font class="operation_record">17、术者完成手术记录</font></label></li>
										</ul>
									</div>	
								</td>
							</tr>
