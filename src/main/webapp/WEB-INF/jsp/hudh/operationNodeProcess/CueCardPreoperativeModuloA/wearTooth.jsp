			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="tryHolderOrBasalCrowns" type="checkbox" value="10、请上级医师会诊" id="isphotograph"/>10、请上级医师会诊</label></li>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="enterLclj" type="checkbox" value="12、完成临床路径录入" id="enterLclj"/>12、完成临床路径录入</label></li>
										</ul>
									</div>
								</td>
							</tr>
