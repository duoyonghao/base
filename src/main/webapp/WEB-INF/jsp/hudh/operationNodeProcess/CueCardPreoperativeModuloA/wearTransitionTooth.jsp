										...
										<ul>
											...
											<li>
												<div class="preparation-ul">
													<div><i style="color: red;font-style: normal;">*</i><span style="font-weight: bold;" class="">6、影像学检查  ：</span></div>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li>
												<div class="preparation-ul">
													<div><i style="color: red;font-style: normal;">*</i><span style="font-weight: bold;" class="">12、种植体有无变异：</span></div>
