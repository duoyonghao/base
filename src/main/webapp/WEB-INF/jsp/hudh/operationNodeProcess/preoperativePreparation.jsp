			...
			<tbody>
				<tr>
					...
					<td>
						<div style="margin-left: 40px;">
							<ul>
								<!-- <li><label><input name="Consultation" type="checkbox" value="向患者交代诊疗过程" disabled="disabled"/><font class="diagnosis_case">5、向患者交代诊疗过程</font></label></li> -->
								<li class="positionLi zlCasesLi">
									<label class="zlCasesLiText"><input name="Consultation" type="checkbox" value="制定手术方案和治疗计划" /><font class="diagnosis_case" onclick="showHiddenClick(this,'zlCasesLi');">5、制定手术方案和治疗计划</font></label>
									<div class="caseContiner" style="display:none;">
					...
					<td>
						<div style="margin-left: 40px;">
							<ul>
								...
								<li><label><input name="Consultation" type="checkbox" value="制定手术方案和治疗计划" disabled="disabled"/><font class="diagnosis_case">12、制定手术方案和治疗计划</font></label></li>
