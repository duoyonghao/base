			...
			<tbody>
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="panoramic_view_piece" type="checkbox" value="2、拍全景片（必要时小牙片）" id="panoramic_view_piece"/>2、拍全景片（必要时小牙片）</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="announcements" type="checkbox" value="4、交代注意事项" id="announcements"/>4、交代注意事项</label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="complete_case_record" type="checkbox" value="7、完成病历记录" id="complete_case_record"/>7、完成病历记录</label></li>
											<li><label><input name="wearTooth" type="checkbox" value="8、完成病历记录" id="wearTooth"/>8、戴牙</label></li>
											<li><label><input name="isphotograph" type="checkbox" value="9、拍照" id="isphotograph"/>9、拍照</label></li>
										</ul>
									</div>
								</td>
