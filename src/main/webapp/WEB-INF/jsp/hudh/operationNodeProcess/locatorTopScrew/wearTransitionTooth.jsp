			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="wearTooth" type="checkbox" value="4、戴过渡牙" id="wearTooth"/>4、戴过渡牙</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<!-- <li><label>7、预约下次来院时间：<input class="time_initialize" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;vertical-align: middle;"/></label></li>  -->
