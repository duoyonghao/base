							...
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>1、复查时间：<input class="time_initialize" name="review_time" type="text" id="review_time" value="" style="width: 105px;"/></label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label>5、<input name="fixation_tooth_bridge" type="checkbox" value="5、固定牙桥" id="fixation_tooth_bridge"/>固定牙桥</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>6、<input name="announcements" type="checkbox" value="6、交代术后注意事项" id="announcements"/>交代术后注意事项</label></li>
											<li><label>7、预约下次来院时间：<input class="time_initialize" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;"/></label></li> 
											<li><label>8、<input name="complete_case_record" type="checkbox" value="8、完成病历记录及临床路径录入" id="complete_case_record"/>完成病历记录及临床路径录入</label></li>
										</ul>
									</div>	
								</td>
