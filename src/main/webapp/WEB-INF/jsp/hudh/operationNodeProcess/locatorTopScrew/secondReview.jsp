			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="complete_case_record" type="checkbox" value="6、完成病历记录及临床路径录入" id="complete_case_record"/>6、完成病历记录及临床路径录入</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="is_stitches" type="checkbox" value="7、拆线" id="is_stitches"/>7、拆线</label></li> 
										</ul>
									</div>	
								</td>
