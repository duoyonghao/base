							...
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>4、<input name="panoramic_view_piece" type="checkbox" value="4、取模定咬合" id="panoramic_view_piece"/>取模定咬合</label></li>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>6、检查口腔清洁情况：
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>11、预约下次来院时间：<input class="" onfocus="popup()" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 108px;"/></label></li> 
