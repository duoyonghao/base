			...
			<tbody>
							<tr>
								<td style="width:25%;">
									<div>
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>1、复查时间：<input class="time_initialize" name="review_time" type="text" id="operation_time" value="" readonly="readonly" placeholder="请选择日期" style="width: 105px;vertical-align:middle;"/></label></li>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>4、<input name="is_stitches" type="checkbox" value="4、拆线" id="is_stitches"/>拆线</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i>5、预约下次来院时间：<input class="" onfocus="popup()" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 108px;vertical-align:middle;"/></label></li> 
											<li><label><i style="color: red;font-style: normal;">*</i>6、<input name="nostitches" type="checkbox" value="5、非微创拆线"  id="nostitches">非微创拆线</label></li>
										</ul>
									</div>	
								</td>
										...
										<ul>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>7、是否松动：</span></div>
													<div><label><input name="is_loose" type="radio" value="是" />是</label></div>
													<div><label><input name="is_loose" type="radio" value="否" />否</label></div>
												</div>
											</li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="preoperative_verification" type="checkbox" value="8、根据患者当时病情决定检查项目" id="preoperative_verification"/>8、根据患者当时病情决定检查项目</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="announcements" type="checkbox" value="9、交代注意事项" id="announcements"/>9、交代注意事项</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="complete_case_record" type="checkbox" value="10、完成病历记录及临床路径录入" id="complete_case_record"/>10、完成病历记录及临床路径录入</label></li>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>11、有无变异：</span></div>
													<div><label><input name="assist_operation" type="radio" value="有" />有</label></div>
													<div><label><input name="assist_operation" type="radio" value="无" />无</label></div>
												</div>
											</li>
