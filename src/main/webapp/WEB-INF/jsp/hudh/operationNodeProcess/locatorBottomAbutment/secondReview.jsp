			...
			<tbody>
							<tr>
								<td style="width:25%;">
									<div>
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>1、复查时间：<input name="operation_time" type="text" class="time_initialize" id="operation_time" value="" readonly="readonly" placeholder="请选择日期" style="width: 105px;vertical-align:middle;"/></label></li>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>4、预约下次来院时间：<input class="" onfocus="popup()" name="next_hospital_time"  type="text" value="" id="next_hospital_time" style="width: 108px;vertical-align:middle;"/></label></li> 
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>5、检查咬合：</span></div>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="preoperative_verification" type="checkbox" value="6、根据患者当时病情决定检查项目" id="preoperative_verification"/>6、根据患者当时病情决定检查项目</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="complete_case_record" type="checkbox" value="8、完成病历记录及临床路径录入" id="complete_case_record"/>8、完成病历记录及临床路径录入</label></li>
										</ul>
									</div>
								</td>
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="connectingBridge" type="checkbox" value="10、请上级医师会诊" id="connectingBridge"/>10、请上级医师会诊</label></li>
										</ul>
									</div>
								</td>
							</tr>
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
			//console.log("songdong"+JSON.stringify(data));
			if (nodeSta == 2) {
