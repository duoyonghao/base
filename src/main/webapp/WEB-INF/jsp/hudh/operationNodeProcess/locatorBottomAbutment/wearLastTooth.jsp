			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="announcements" type="checkbox" value="7、交代注意事项：口腔卫生维护、咬合力控制、定期复查、不适随诊" id="announcements"/>7、交代注意事项：口腔卫生维护、<br>&nbsp&nbsp&nbsp咬合力控制、定期复查、不适随诊</label></li>
