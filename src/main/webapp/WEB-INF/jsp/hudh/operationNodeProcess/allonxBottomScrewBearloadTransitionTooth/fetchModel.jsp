			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>9、预约下次来院时间：<input name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;"/></label></li> 
											<li><label><input name="announcements" type="checkbox" value="10、交代注意事项<" id="announcements"/>10、交代注意事项</label></li>
											<li><label><input name="complete_case_record" type="checkbox" value="11、完成病历记录" id="complete_case_record"/>11、完成病历记录</label></li>
										</ul>
									</div>	
								</td>
