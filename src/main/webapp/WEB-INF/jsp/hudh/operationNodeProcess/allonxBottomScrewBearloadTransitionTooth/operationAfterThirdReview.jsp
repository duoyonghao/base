			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>4、预约下次来院时间：<input  class="time_initialize" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;vertical-align: middle;"/></label></li> 
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
			...
			//检查咬合
			checkOcclusion = data.checkOcclusion;
			if (checkOcclusion) {
