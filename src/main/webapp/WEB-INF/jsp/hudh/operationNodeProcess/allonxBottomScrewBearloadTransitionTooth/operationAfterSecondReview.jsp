			...
			<tbody>
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="is_stitches" type="checkbox" value="2、拍全景片" id="is_stitches"/>2、拍全景片</label></li>
											<li><label><input name="checkOcclusion" type="checkbox" value="3、检查咬合 " id="checkOcclusion"/>3、检查咬合 </label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="clean_toothbridge" type="checkbox" value="4、清洁牙桥" id="clean_toothbridge"/>4、清洁牙桥 </label></li>
											<li><label><input name="health_education" type="checkbox" value="5、卫生宣教" id="health_education"/>5、卫生宣教 </label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="complete_case_record" type="checkbox" value="8、完成病历记录及临床路径录入" id="complete_case_record"/>8、完成病历记录及临床路径录入</label></li>
										</ul>
									</div>	
								</td>
