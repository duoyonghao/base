							...
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>1、复查时间：<input name="review_time" type="text" id="review_time" value="" style="width: 105px;"/></label></li>
											<li><label>2、观察伤口及术区清洁情况：
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="is_stitches" type="checkbox" value="4、取面弓" id="is_stitches"/>4、取面弓</label></li>
											<li><label><input name="decision_bite" type="checkbox" value="5、定咬合" id="decision_bite"/>5、定咬合</label></li>
											<li><label><input name="upper_frame" type="checkbox" value="6、上颌架" id="upper_frame"/>6、上颌架</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label>8、预约下次来院时间：<input name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;"/></label></li> 
											<li><label><input name="complete_case_record" type="checkbox" value="9、完成病历记录及临床路径录入" id="complete_case_record"/>9、完成病历记录及临床路径录入</label></li>
										</ul>
									</div>	
								</td>
