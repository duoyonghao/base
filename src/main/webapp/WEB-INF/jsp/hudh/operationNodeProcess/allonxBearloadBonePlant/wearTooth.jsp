								...
								<td style="width: 25%;">
									<div>
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="panoramic_view_piece" type="checkbox" value="2、拍全景片（必要时小牙片）" id="panoramic_view_piece"/>2、拍全景片（必要时小牙片）</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>5、检查伤口愈合情况：
										...
										<ul>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>6、拍X片：</span></div>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="wearTooth" type="checkbox" value="10、戴前牙区临时牙" id="wearTooth"/>10、戴前牙区临时牙</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="isphotograph" type="checkbox" value="11、拍照" id="isphotograph"/>11、拍照</label></li>
										</ul>
									</div>
								</td>
