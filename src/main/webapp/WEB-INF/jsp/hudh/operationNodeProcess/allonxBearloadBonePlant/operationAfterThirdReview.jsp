							...
							<tr>
								<td style="width: 34%;">
									<div>
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="checkOcclusion" type="checkbox" value="2、检查咬合 " id="checkOcclusion"/>2、检查咬合 </label></li>
								...
								<td style="width: 33%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="health_education" type="checkbox" value="4、卫生宣教" id="health_education"/>4、卫生宣教 </label></li>
