							...
							<tr>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="is_stitches" type="checkbox" value="4、取面弓" id="is_stitches"/>4、取面弓</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="decision_bite" type="checkbox" value="5、定咬合" id="decision_bite"/>5、定咬合</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="upper_frame" type="checkbox" value="6、上颌架" id="upper_frame"/>6、上颌架</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="basalCrowns" type="checkbox" value="7、试基底冠、比色" id="basalCrowns"/>7、试基底冠、比色</label></li>
										</ul>
									</div>	
								</td>
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
			...
			//定咬合
			decision_bite = data.decision_bite;
			if (decision_bite) {
				$("#decision_bite").attr("checked","checked");
			}
			//上颌架
			upper_frame = data.upper_frame;
			if (upper_frame) {
				$("#upper_frame").attr("checked","checked");
			}
