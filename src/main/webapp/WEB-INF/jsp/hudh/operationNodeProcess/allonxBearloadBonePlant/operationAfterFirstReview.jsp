							...
							<tr>
										...
										<ul>
											...
											<li>
												<div class="preparation-ul">
													...
													<div><label><input name="intraoperativeMedication" type="checkbox" value="(1)、是" />(1)、是</label></div> 
													<div><label><input name="intraoperativeMedication" type="checkbox" value="(2)、否" />(2)、否</label></div>
												</div>
											</li>
										</ul>
									</div>	
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="accord" type="checkbox" value="4、精细调和、封洞 " id="accord"/>4、精细调和、封洞 </label></li>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="neonychium" type="checkbox" value="7、戴保护垫" id="neonychium"/>7、戴保护垫</label></li>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>8、有无变异：</span></div>
													<div><label><input name="is_loose" type="checkbox" value="有" />有</label></div> 
													<div><label><input name="is_loose" type="checkbox" value="无" />无</label></div>
												</div>
											</li>
											<li><label><input name="collutory" type="checkbox" value="9、请上级医师会诊" id="collutory"/>9、请上级医师会诊</label></li>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="enterLclj" type="checkbox" value="13、完成临床路径录入" id="enterLclj"/>13、完成临床路径录入</label></li>
										</ul>
									</div>	
								</td>
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
			...
			var temper = $("#temper").find("input[type='checkbox']");
			select_temper = data.temper;
			if (select_temper) {
				$("#temper").attr("checked","checked");
			}
			...
			// 3、检查螺丝是否松动：2019.12.29
			intraoperativemedication = data.intraoperativemedication;
			if(intraoperativemedication!=undefined){				
				$("input[name='intraoperativeMedication']").each(function(){
					var newintraoperativemedication=intraoperativemedication.substring(0,5);
					if($(this).val()==newintraoperativemedication){
						   $(this).attr("checked","checked");
					}
