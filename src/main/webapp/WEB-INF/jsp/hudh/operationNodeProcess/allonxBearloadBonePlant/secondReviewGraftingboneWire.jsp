			...
			<tbody>
							<tr>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="outside_bone_grafting" type="checkbox" value="6、同期一侧外提升植骨" id="outside_bone_grafting"/>6、同期一侧外提升植骨</label></li>
											<li>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="accord" type="checkbox" value="11、完成临床路径录入" id="accord"/>11、完成临床路径录入</label></li>
										</ul>
									</div>
								</td>
