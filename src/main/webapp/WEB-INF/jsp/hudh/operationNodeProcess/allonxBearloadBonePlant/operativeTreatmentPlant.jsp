							...
							<tr>
								<td style="width: 25%;">
									<div style="z-index: 9999999 ;">
										<ul>
											<li><label style="position:absolute,z-index:9999"><i style="color: red;font-style: normal;">*</i>1、手术时间：<input name="operation_time" type="text" id="operation_time" value="" readonly="readonly" placeholder="请选择日期" style="width: 105px;"/></label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="preoperation_one_houres" type="checkbox" value="2、术前1小时，口服抗菌药物" / id="preoperation_one_houres">2、术前1小时，口服抗菌药物</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="preoperative_verification" type="checkbox" value="3、术前核查" id="preoperative_verification"/>3、术前核查</label></li>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>4、麻醉方式：</span></div>
													<div><label><input name="assist_operation" type="checkbox" value="(1)、内提" />(1)、局部麻醉</label></div>
													<div><label><input name="assist_operation" type="checkbox" value="(2)、外提" />(2)、必要时加镇痛镇静治疗</label></div>
												</div>
											</li>
										</ul>
									</div>	
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>5、基台放置：</span></div>
											...
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>6、愈合帽放置：</span></div>
											...
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>7、术中用药：</span></div>
													<div><label><input name="intraoperativeMedication" type="checkbox" value="(1)、内提" />(1)、局麻药物</label></div>
													<div><label><input name="intraoperativeMedication" type="checkbox" value="(2)、外提" />(2)、必要时心血管临时用药</label></div>
												</div>
											</li>
										</ul>
									</div>	
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="operator" type="checkbox" value="8、手术" id="operator"/>8、手术</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="enterLclj" type="checkbox" value="9、临床路径录入" id="enterLclj"/>9、临床路径录入</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="collutory" type="checkbox" value="10、漱口液含漱、抗菌药物使用3-5天" id="collutory"/>10、漱口液含漱、抗菌药物使用3-5天</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="small_teeth" type="checkbox" value="11、拍X片：曲面断层,必要时小牙片" id="small_teeth"/>11、拍X片：曲面断层,必要时小牙片</label></li>
										</ul>
									</div>	
								</td>
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="antimicrobial_use" type="checkbox" value="12、抗菌药物使用3-5天" id="antimicrobial_use"/>12、抗菌药物使用3-5天</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="announcements" type="checkbox" value="13、交代注意事项" id="announcements"/>13、交代注意事项 </label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="opration_record" type="checkbox" value="14、术者完成手术记录" id="opration_record"/>14、术者完成手术记录</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="after_Modulo_bite" id="after_Modulo_bite" type="checkbox" value="15、术后当天取模、定咬合关系" id="after_Modulo_bite"/>15、术后当天取模、定咬合关系</label></li>
										</ul>
									</div>	
								</td>
...
function initOperativeTreatment() {
	$.ajax({
		...
		success:function(data) {
			...
			var operator = $("#operator").find("input[type='checkbox']");
			select_operator = data.operator;
			if (select_operator) {
				$("#operator").attr("checked","checked");
			}
			
			//术后当天取模、定咬合关系
			after_Modulo_bite = data.after_modulo_bite;
			if (after_Modulo_bite) {
				$("#after_Modulo_bite").attr("checked","checked");
			}
