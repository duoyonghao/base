			...
			<tbody>
				<tr>
						...
						<div style="margin-left: 40px;">
							<ul>
								...
								<li>
										...
										<label><input name="imagelogic" type="checkbox" value="3、B超" disabled="disabled">(3)、B超</label>
					...
					<td style="width:25%">
						<div style="margin-left: 40px;">
							<ul>
								<li><label><input name="Consultation" type="checkbox" value="向患者交代诊疗过程" disabled="disabled"/><font>5、向患者交代诊疗过程</font></label></li>
					...
					<td style="width:25%">
						<div style="margin-left: 40px;">
							<ul>
								...
								<li>
									<span style="font-weight: bold;" class="">10、同意书：</span><br/>
								...
								<!-- <li class="zlCasesLi">
									<label class="zlCasesLiText"><input name="Consultation" type="checkbox" value="制定手术方案和治疗计划" /><font class="diagnosis_case">12、制定手术方案和治疗计划</font></label>
									<div class="caseContiner" style="display:none;">
										<div class="zlCases"></div>
										<div class="selectCases">
