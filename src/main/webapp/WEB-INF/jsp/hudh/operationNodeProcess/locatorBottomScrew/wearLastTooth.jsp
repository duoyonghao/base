			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="wearTooth" type="checkbox" value="4、戴最终牙" id="wearTooth"/>4、戴最终牙</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<!-- <li><label><input name="small_teeth" type="checkbox" value="5、影像学检查 ：曲面断层 小牙片" id="small_teeth"/>5、影像学检查 ：曲面断层 小牙片</label></li> -->
											<li><label>5、拍X片：
												<label><input name="small_teeth" type="radio" value="曲面断层片" id="small_teeth" />曲面断层片</label>
												<label><input name="small_teeth" type="radio" value="小牙片" id="small_teeth" />小牙片</label>
											</label></li>
											<li><label><input name="isphotograph" type="checkbox" value="6、拍照" id="isphotograph"/>6、拍照</label></li>
											<li><label><input name="announcements" type="checkbox" value="7、交代注意事项：口腔卫生维护、咬合力控制、定期复查、不适随诊" id="announcements"/>7、交代注意事项：口腔卫生维护、<br>&nbsp&nbsp&nbsp咬合力控制、定期复查、不适随诊</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>8、预约下次来院时间：<input class="time_initialize" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;vertical-align: middle;"/></label></li> 
