							...
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>1、来院时间：<input class="time_initialize" name="visit_time" type="text" id="visit_time" value="" style="width: 105px;"/></label></li>
											<li><label>2、检查伤口愈合情况：
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<!-- <li><label><input name="ismodule" type="checkbox" value="4、取模" id="ismodule">4、取模</label></li> -->
											<li><label>4、<input name="panoramic_view_piece" type="checkbox" value="4、取模定咬合" id="panoramic_view_piece"/>取模定咬合</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>5、<input name="transfer" type="checkbox" value="5、面弓转移，上架" id="transfer">面弓转移，上架</label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="basalCrowns" type="checkbox" value="8、试基底冠、比色" id="basalCrowns">8、试基底冠、比色</label></li>
											<li><label><input name="announcements" type="checkbox" value="9、交代注意事项" id="announcements"/>9、交代注意事项</label></li>
											<li><label><input name="complete_case_record" type="checkbox" value="10、完成病历记录" id="complete_case_record"/>10、完成病历记录</label></li>
										</ul>
									</div>	
								</td>
...
function initQmdyh() {
	$.ajax({
		...
		success:function(data){
			//console.log(JSON.stringify("检查口腔清洁度==="+data.checkcavitycleansitu));
			if (nodeSta == 2) {
			...
			$("#checkCavityCleanSitu").val(data.checkcavitycleansitu);//检查种植体骨结合情况
