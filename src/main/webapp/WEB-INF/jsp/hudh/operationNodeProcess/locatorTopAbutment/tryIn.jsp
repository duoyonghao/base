								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="try_in" type="checkbox" value="4、试戴" id="try_in"/>4、试戴</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<!-- <li><label><i style="color: red;font-style: normal;">*</i>8、种植体有无变异：<input name="accord" type="radio" value="有" />有<input name="accord" type="radio" value="无" />无</label></li> -->
											<li>
											...
											<li><label><input name="connectingBridge" type="checkbox" value="9、请上级医师会诊" id="connectingBridge"/>9、请上级医师会诊</label></li>
										</ul>
									</div>
								</td>
							</tr>
...
function initTryIn() {
	$.ajax({
		...
		success:function(data){
			//console.log("试戴=-=-"+JSON.stringify(data));
			if (nodeSta == 2) {
