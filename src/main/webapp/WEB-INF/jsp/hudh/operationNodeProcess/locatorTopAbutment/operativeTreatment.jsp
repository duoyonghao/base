								...
								<td style="width:25%;">
									<div style="z-index: 9999999;">
										<ul>
											...
											<input class="time_select" name="operation_time" type="text" id="operation_time" value="" style="width: 105px;vertical-align: middle;" readonly="readonly" placeholder="请选择日期"/></label></li>
								...
								<td style="width:25%;">
									<div style="">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="try_in" type="checkbox" value="10、术后当天取模、定咬合关系" id="try_in"/>10、术后当天取模、定咬合关系</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="enterLclj" type="checkbox" value="11、临床路径录入" id="enterLclj"/>11、临床路径录入</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="collutory" type="checkbox" value="12、漱口液含漱、抗菌药物使用3-5天" id="collutory"/>12、漱口液含漱、抗菌药物使用3-5天</label></li>
										</ul>
									</div>	
								</td>
								<td style="width:25%;">
...
<%--													<div><label><input name="announcements" type="radio" value="局部" /><font class="attention_topo">局部</font></label></div>--%>
											...
											<li>
												<label><i style="color: red;font-style: normal;">*</i>16、
