							...
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="wearTooth" type="checkbox" value="4、戴最终牙" id="wearTooth"/>4、戴最终牙</label></li>
											<li>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>7、种植体有无变异：<input name="accord" type="radio" value="有" />有<input name="accord" type="radio" value="无" />无</label></li>
										<li><label><input name="connectingBridge" type="checkbox" value="8、请上级医师会诊" id="connectingBridge"/>8、请上级医师会诊</label></li>
...
function initWearTooth() {
	$.ajax({
		...
		success:function(data){
			//console.log("戴牙=-=-=="+JSON.stringify(data));
			if (nodeSta == 2) {
			...
			$("input[name='small_teeth']").each(function(){
				if($(this).val()==select_small_teeth){
