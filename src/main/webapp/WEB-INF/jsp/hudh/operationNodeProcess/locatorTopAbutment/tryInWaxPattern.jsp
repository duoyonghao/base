			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>5、种植体有无变异：<input name="accord" type="radio" value="有" />有<input name="accord" type="radio" value="无" />无</label></li>
											<li><label><input name="connectingBridge" type="checkbox" value="6、请上级医师会诊" id="connectingBridge"/>6、请上级医师会诊</label></li>
										</ul>
									</div>	
								</td>
								<td style="width:25%;">
