								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>		
											...
											<li><label><i style="color: red;font-style: normal;">*</i>7、<input name="panoramic_view_piece" type="checkbox" value="7、取模" id="panoramic_view_piece"/>取模</label></li>
										</ul>
									</div>	
								</td>
										...
										<ul>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>8、是否松动：</span></div>
													<div><label><input name="is_loose" type="radio" value="是" />是</label></div>
													<div><label><input name="is_loose" type="radio" value="否" />否</label></div>
												</div>
											</li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="preoperative_verification" type="checkbox" value="9、根据患者当时病情决定检查项目" id="preoperative_verification"/>9、根据患者当时病情决定检查项目</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i>10、种植体有无变异：<input name="accord" type="radio" value="有" />有<input name="accord" type="radio" value="无" />无</label></li>
										</ul>
									</div>	
								</td>
