			...
			<tbody>
							<tr>
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>6、询问患者舒适度：
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="isphotograph" type="checkbox" value="10、拍照" id="isphotograph"/>10、拍照</label></li>
...
function initWearTooth() {
	$.ajax({
		...
		success:function(data){
			//console.log("调合==="+JSON.stringify(data));
			if (nodeSta == 2) {
			...
			$("#check_wound").val(data.checkWound);//检查咬合情况
