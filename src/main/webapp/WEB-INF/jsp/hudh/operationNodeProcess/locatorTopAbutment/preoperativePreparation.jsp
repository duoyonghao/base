			...
			<tbody>
				<tr>
					<td style="width:25%;">
						<div>
							<ul>
								<!-- <li><label>1、<input name="Consultation" type="checkbox" value="询问既往史" disabled="disabled"/><font class="ask_Previous">询问既往史及体格检查,必要时会诊</font></label></li> -->
								...
								<li>
										...
										<label><input name="imagelogic" type="checkbox" value="1、全景片" disabled="disabled">(1)、全景片</label>
										<label><input name="imagelogic" type="checkbox" value="2、CT" disabled="disabled">(2)、CT</label>
										<label><input name="imagelogic" type="checkbox" value="3、小牙片" disabled="disabled">(3)、小牙片</label><br/>
										<label><input name="imagelogic" type="checkbox" value="4、心电图" disabled="disabled">(4)、心电图</label>
										<label><input name="imagelogic" type="checkbox" value="5、骨密度" disabled="disabled">(5)、骨密度</label>
										<label><input name="imagelogic" type="checkbox" value="6、心脏彩超" disabled="disabled">(6)、心脏彩超</label>
										<label><input name="imagelogic" type="checkbox" value="7、B超" disabled="disabled">(7)、B超</label>
								</li>
								<!-- <li><label>3、<input name="Consultation" type="checkbox" value="口内检查" disabled="disabled"/><font class="examine_diagnose">口腔专科检查</font></label></li> -->
								<!-- <li>
										<span style="font-weight: bold;" class=""><font class="examine_diagnose">3、口腔专科检查：</font></span>
										<label><input name="imagelogic" type="checkbox" value="全口牙及牙周状况检查" disabled="disabled">全口牙及牙周状况检查</label>
										<label><input name="imagelogic" type="checkbox" value="双侧颞下颌关节及咬合关系" disabled="disabled">双侧颞下颌关节及咬合关系</label>
								</li> -->
								...
								<li>
									<!-- <label><input name="Consultation" type="checkbox" value="会诊：内科、综合科" disabled="disabled"/>4、会诊：内科、综合科</label> -->
										<span style="font-weight: bold;" class="">4、会诊：</span>
								...
								<li><label><input name="Consultation" type="checkbox" value="术前讨论" disabled="disabled"/>5、术前讨论(疑难患者)</label></li>
							</ul>
						</div>	
					</td>
						...
						<div style="margin-left: 40px;">
							<ul>
								<li class="positionLi zlCasesLi">
									<label class="zlCasesLiText"><input name="Consultation" type="checkbox" value="制定手术方案和治疗计划" /><font class="diagnosis_case" onclick="showHiddenClick(this,'zlCasesLi');">6、制定手术方案和治疗计划</font></label>
									<div class="caseContiner" style="display:none;">
										<div class="zlCases"></div>
										<div class="selectCases">
											<select id="allCases"></select>
								...
								<li><label><input name="Consultation" type="checkbox" value="向患者交代诊疗过程" disabled="disabled"/><font>7、告知患者手术方案、治疗计划及诊疗流程</font></label></li>	
								<li><label><input name="Consultation" type="checkbox" value="办理病历" disabled="disabled"/>8、办理病历</label></li>
								<!-- <li><label><input name="Consultation" type="checkbox" value="签署知情同意书" disabled="disabled"/><font class="plantKnowbook">9、签署知情同意书</font></label></li> -->
								<li>
									<span style="font-weight: bold;" class="">9、同意书：</span><br/>
					...
					<td style="width:25%;">
						<div style="margin-left: 40px;">
							<ul>
								<li><label><input name="Consultation" type="checkbox" value="拍照" disabled="disabled"/>10、拍照</label></li>
								<li><label><input name="Consultation" type="checkbox" value="制作导板" disabled="disabled"/>11、制作导板</label></li>
								<li><label><input name="Consultation" type="checkbox" value="取研究模型，行模型分析" disabled="disabled"/>12、取研究模型，行模型分析</label></li>
								<!-- <li><label><input name="Consultation" id="" type="checkbox" value="修复方案"/><font class="xiufu_test">13、修复方案</font></label></li> -->	
								<li class="positionLi xffaLi">
									<label><input name="Consultation" id="" type="checkbox" value="修复方案"/><font class="xiufu_test" onclick="showHiddenClick(this,'xffaLi');">13、修复方案</font></label>
									<div class="caseContiner" style="display:none;">
										<div class="zlCases"></div>
										<div class="selectCases">
											<select id="allCases"></select>
								...
								<!-- <li><label><input name="Consultation" type="checkbox" value="安排或预约手术时间" disabled="disabled"/>12、安排或预约手术时间</label></li> -->
								<li><label><input name="Consultation" type="checkbox" value="口腔清洁" disabled="disabled"/>14、口腔清洁（必要时牙周治疗）</label></li>
							</ul>
						</div>
					</td>
					...
					<td style="width:25%;">
						<div style="margin-left: 40px;">
							<ul>
								...
								<li><label>15、<input name="Consultation" type="checkbox" value="检验：血常规、血糖、感染性疾病、凝血4项" disabled="disabled"/>检验：血常规、血糖、感染性疾病、凝血功能4项</label></li>
								...
								<li><label>17、安排预约手术时间：<input class="time_initialize operation_time" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 105px;vertical-align: middle;"/></label></li> 
								<li>
									<div class="preparation-ul" id="tooth_textureShow">
										...
										<label><input name="tooth_texture" type="checkbox" value="半口-可摘型德国GEGO牙桥" >(1)、半口-可摘型德国GEGO牙桥</label>
										<label><input name="tooth_texture" type="checkbox" value="半口-可摘型维他灵牙桥" >(2)、半口-可摘型维他灵牙桥</label><br/>
										<label><input name="tooth_texture" type="checkbox" value="半口-可摘型纯钛牙桥" >(3)、半口-可摘型纯钛牙桥</label>
										<label><input name="tooth_texture" type="checkbox" value="半口-固定版树脂牙桥" >(4)、半口-固定版树脂牙桥</label>
										<label><input name="tooth_texture" type="checkbox" value="半口-固定版氧化锆牙桥" >(5)、半口-固定版氧化锆牙桥</label>-->
									</div>
								</li>
							</ul>
						</div>
...
// 			var disease_id = select_imagelogic.split(";");
			...
			if (before_Modulo_bite) {
				$("#before_Modulo_bite").attr("checked","checked").attr("disabled","disabled");
			}
			...
			//会诊赋值
			var Advisory = patientObj.advisory;
			...
			var texture_html="<span style='font-weight: bold;'>18、牙冠材质：</span>";
			for(var i = 0; i < disease_id.length-1; i++){
				/* $("input[name='tooth_texture']").each(function(){
					if($(this).val()==disease_id[i] || disease_id[i].indexOf($(this).val())>0){
					   $(this).attr("checked","checked").attr("disabled","disabled");
					}
				}) */
				if(i%2==0){
					texture_html+="<label>("+(i+1)+")"+disease_id[i]+"</label>";
				}else{
					texture_html+="<label>("+(i+1)+")"+disease_id[i]+"</label><br/>";
				}
			}
			$("#tooth_textureShow").html(texture_html);
