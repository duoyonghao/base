								...
								<td style="width:25%;">
									<div>
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>3、检查种植区清洁情况：
								...
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="opration_record" type="checkbox" value="9、术者完成手术记录" id="opration_record"/>9、术者完成手术记录</label></li>
										</ul>
									</div>	
								</td>
								<td style="width:25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="complete_case_record" type="checkbox" value="10、临床路径录入" id="complete_case_record"/>10、临床路径录入</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i>11、种植体有无变异：<input name="accord" type="radio" value="有" />有<input name="accord" type="radio" value="无" />无</label></li>
