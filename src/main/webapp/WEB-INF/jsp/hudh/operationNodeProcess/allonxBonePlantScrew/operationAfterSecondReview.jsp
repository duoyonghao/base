								...
								<td style="width: 25%;">
									<div>
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>2、检查术区愈合情况：
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="accord" type="checkbox" value="4、精细调和、封洞 " id="accord"/>4、拍X光片：拆线后1个月复查，<br>术后3个月复查（根据患者当时病情决定检查项目） </label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="clean_toothbridge" type="checkbox" value="5、根据患者当时病情决定检查项目" id="clean_toothbridge"/>5、根据患者当时病情决定检查项目</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="nostitches" type="checkbox" value="7、请上级会诊"  id="nostitches">7、请上级会诊</label></li>
