							...
							<tr>
								<td style="width: 25%;">
									<div>
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>3、检查种植体情况：
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="try_in" type="checkbox" value="4、试戴蜡型" id="try_in"/>4、试戴蜡型</label></li>
