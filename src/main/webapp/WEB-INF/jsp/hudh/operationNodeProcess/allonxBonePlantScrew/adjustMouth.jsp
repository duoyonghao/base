							...
							<tr>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>3、检查咬合情况：
											...
											<li><label><i style="color: red;font-style: normal;">*</i>4、询问患者舒适度：
													<select id="wearTooth" name="wearTooth" style="width: 80px;">
														<option>-请选择-</option>
														<option>优</option>
														<option>良</option>
														<option>中</option>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="try_in" type="checkbox" value="5、调合" id="try_in"/>5、调合</label></li> 
										</ul>
									</div>	
								</td>
