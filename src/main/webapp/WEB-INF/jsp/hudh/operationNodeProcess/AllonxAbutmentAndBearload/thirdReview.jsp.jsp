				...
				<tr>			
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>1、<input name="Consultation" type="checkbox" value="1、检查咬合"/>检查咬合</label></li>
								<li><label>2、<input name="Consultation" type="checkbox" value="2、清洁牙桥"/>清洁牙桥</label></li>
								<li><label>3、<input name="Consultation" type="checkbox" value="3、卫生宣教"/>卫生宣教</label></li>
							</ul>
						</div>	
					</td>
					<td style="vertical-align: top;">
