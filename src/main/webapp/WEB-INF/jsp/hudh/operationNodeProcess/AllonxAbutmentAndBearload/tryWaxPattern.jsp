					...
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								...
								<li><label>2、<input name="Consultation" type="checkbox" value="2、试戴蜡型"/>试戴蜡型</label></li>
								<li><label>3、<input name="Consultation" type="checkbox" value="3、交代注意事项"/>交代注意事项</label></li>
							</ul>
						</div>	
					</td>
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>4、<input name="Consultation" type="checkbox" value="4、预约下次来院时间"/>预约下次来院时间</label></li>
								<li><label>5、<input name="Consultation" type="checkbox" value="5、完成病历记录"/>完成病历记录</label></li>
							</ul>
						</div>	
					</td>
				</tr>
