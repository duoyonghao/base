				...
				<tr>			
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>1、<input name="Consultation" type="checkbox" value="1、拆线、检查螺丝是否松动"/>拆线、检查螺丝是否松动</label></li>
								<li><label>2、<input name="Consultation" type="checkbox" value="2、精细调和、封洞"/>精细调和、封洞</label></li>
								<li><label>3、<input name="Consultation" type="checkbox" value="3、清洁牙桥、卫生宣教"/>清洁牙桥、卫生宣教</label></li>
								<li><label>4、<input name="Consultation" type="checkbox" value="4、戴保护垫"/>戴保护垫</label></li>
							</ul>
						</div>	
					</td>
					<td style="vertical-align: top;">
