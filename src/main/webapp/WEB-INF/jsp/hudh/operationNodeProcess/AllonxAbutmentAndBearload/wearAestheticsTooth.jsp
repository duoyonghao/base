					...
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								...
								<li><label>2、<input name="Consultation" type="checkbox" value="2、戴美学临时牙"/>戴美学临时牙</label></li>
								<li>
									<label>3、拍X片：
								...
								<li><label>4、<input name="Consultation" type="checkbox" value="4、拍照"/>拍照</label></li>
							</ul>
						</div>	
					</td>
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>5、<input name="Consultation" type="checkbox" value="5、交代注意事项：口腔卫生维护、咬合力控制、定期复查、不适随诊"/>交代注意事项：口腔卫生维护、咬合力控制、定期复查、不适随诊</label></li>
								<li><label>6、<input name="Consultation" type="checkbox" value="6、预约下次来院时间"/>预约下次来院时间</label></li>
								<li><label>7、<input name="Consultation" type="checkbox" value="7、完成病历记录"/>完成病历记录</label></li>
							</ul>
						</div>	
					</td>
				</tr>
