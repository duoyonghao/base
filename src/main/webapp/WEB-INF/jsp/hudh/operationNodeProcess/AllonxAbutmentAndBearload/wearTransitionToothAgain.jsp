				...
				<tr>			
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>1、<input name="Consultation" type="checkbox" value="1、检查种植体及口腔清洁情况"/>检查种植体及口腔清洁情况</label></li>
								<li><label>2、<input name="Consultation" type="checkbox" value="2、戴过渡牙"/>戴过渡牙</label></li>
								<li><label>3、<input name="Consultation" type="checkbox" value="3、美学牙返回工厂"/>美学牙返回工厂</label></li>
								<li>
									<label>4、拍X片：
										<input name="xrayfilms" type="checkbox" value="1、曲面断层片">1、曲面断层片
										<input name="xrayfilms" type="checkbox" value="2、小牙片">2、牙片
									</label>
								</li>
							</ul>
						</div>	
					...
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>5、<input name="Consultation" type="checkbox" value="5、拍照"/>拍照</label></li>
								<li><label>6、<input name="Consultation" type="checkbox" value="6、交代注意事项：口腔卫生维护、咬合力控制、定期复查、不适随诊"/>交代注意事项：口腔卫生维护、咬合力控制、定期复查、不适随诊</label></li>
								<li><label>7、<input name="Consultation" type="checkbox" value="7、预约下次来院时间"/>预约下次来院时间</label></li>
								<li><label>8、<input name="Consultation" type="checkbox" value="8、完成病历记录"/>完成病历记录</label></li>
							</ul>
						</div>	
					</td>
				</tr>
