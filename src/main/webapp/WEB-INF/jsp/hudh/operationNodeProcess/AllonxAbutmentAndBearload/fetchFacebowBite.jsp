				...
				<tr>			
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>1、<input name="Consultation" type="checkbox" value="1、取面弓定咬合"/>取面弓定咬合</label></li>
								<li><label>2、<input name="Consultation" type="checkbox" value="2、面弓转移，上架"/>面弓转移，上架</label></li>
								<li><label>3、<input name="Consultation" type="checkbox" value="3、试基底冠、比色"/>试基底冠、比色</label></li>
							</ul>
						</div>	
					</td>
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								...
								<li><label>6、<input name="Consultation" type="checkbox" value="6、完成病历记录"/>完成病历记录</label></li>
							</ul>
						</div>	
					</td>
				</tr>
