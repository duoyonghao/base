							...
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>1、二期拆线时间：<input name="twoDateStitchesTime" type="text" id="twoDateStitchesTime" value="" style="width: 105px;"/></label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="collutory" type="checkbox" value="7、影像学检查 ：曲面断层片 小牙片" id="collutory"/>7、影像学检查 ：曲面断层片 小牙片</label></li>
										</ul>
									</div>	
								</td>
