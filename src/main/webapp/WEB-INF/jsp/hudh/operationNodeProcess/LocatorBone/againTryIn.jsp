								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="toTryAgain" type="checkbox" value="4、再次试戴" id="toTryAgain"/>4、再次试戴</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="complete_case_record" type="checkbox" value="6、完成病例记录" id="complete_case_record"/>6、完成病例记录</label></li>
										</ul>
									</div>
								</td>
...
function initReviewTime() {
	$.ajax({
		...
		success:function(data){
			...
			var checkCavityCleanSitu = $("#checkCavityCleanSitu").find("input[type='checkbox']");
			select_observe_wound = data.observe_wound;
			if (select_observe_wound) {
				$("#checkCavityCleanSitu").attr("checked","checked");
			}
			...
			var toTryAgain = $("#toTryAgain").find("input[type='checkbox']");
			select_toTryAgain = data.totryagain;
			if (select_toTryAgain) {
				$("#toTryAgain").attr("checked","checked");
			}
