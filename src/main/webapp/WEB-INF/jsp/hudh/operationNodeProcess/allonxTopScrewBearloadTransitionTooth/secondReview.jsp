			...
			<tbody>
							<tr>
										...
										<ul>
											...
											<li>
												<div class="preparation-ul">
													<span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>4、有无变异：</span>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											 <li><label><input name="nostitches" type="checkbox" value="5、请上级会诊"  id="nostitches">5、请上级会诊</label></li>
											 <li><label><i style="color: red;font-style: normal;">*</i><input name="is_stitches" type="checkbox" value="6、拆线"  id="is_stitches">6、拆线</label></li>
