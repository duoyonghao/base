			...
			<tbody>
							<tr>
								<td style="width: 25%;">
									<div>
										<ul>
											...
											<li>
												<label><i style="color: red;font-style: normal;">*</i>2、检查伤口愈合情况：
											  ...
											  <li>
											  	<label><i style="color: red;font-style: normal;">*</i>3、术区清洁情况：
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="ismodule" type="checkbox" value="5、取模" id="ismodule">5、取模</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="panoramic_view_piece" type="checkbox" value="6、定咬合" id="panoramic_view_piece"/>6、定咬合</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="transfer" type="checkbox" value="7、面弓转移，上架" id="transfer">7、面弓转移，上架</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="basalCrowns" type="checkbox" value="8、试基底冠" id="basalCrowns">8、试基底冠</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="colorimetric" type="checkbox" value="9、比色" id="colorimetric"/>9、比色</label></li>
											<li>
												<div class="preparation-ul">
													<span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>10、有无变异：</span>
													<label><input name="is_loose" type="radio" value="有" />有</label>
													<label><input name="is_loose" type="radio" value="无" />无</label>
												</div>
											</li>
											<li><label><input name="nostitches" type="checkbox" value="11、请上级会诊"  id="nostitches">11、请上级会诊</label></li>
										</ul>
									</div>	
								</td>
								<td style="width: 25%;">
