			...
			<tbody>
				<tr>			
							...
							<ul>
								<li>
									<label>1、拍X片：
										...
										<input name="xrayfilms" type="checkbox" value="2、小牙片">2、小牙片
									</label>
								</li>
								<li><label>2、<input name="Consultation" type="checkbox" value="2、检查术区愈合及种植体骨结合情况"/>检查术区愈合及种植体骨结合情况</label></li>
								<li><label>3、<input name="Consultation" type="checkbox" value="3、完成二期手术"/>完成二期手术</label></li>
					...
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>5、<input name="Consultation" type="checkbox" value="5、漱口液含漱"/>漱口液含漱</label></li>
								<li><label>6、<input name="Consultation" type="checkbox" value="6、预约下次来院时间"/>预约下次来院时间</label></li>
								<li><label>7、<input name="Consultation" type="checkbox" value="7、术者完成手术记录"/>术者完成手术记录</label></li>
								<li><label>8、<input name="Consultation" type="checkbox" value="8、临床路径录入"/>临床路径录入</label></li>
							</ul>
						</div>	
					</td>
				</tr>
