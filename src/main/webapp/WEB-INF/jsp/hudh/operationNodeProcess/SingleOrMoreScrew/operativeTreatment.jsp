								...
								<td style="width:18%;">
									<div style="z-index: 9999999 ;">
										<ul>
											...
											<li><label>3、<input name="preoperative_verification" type="checkbox" value="3、术前核查" id="preoperative_verification"/><font class="operation_examine">术前核查</font></label></li>
											<li>
								...
								<td style="width:20%;">
									<div style="">
										<ul>
											...
											<li><label>15、<input name="opration_record" type="checkbox" value="15、术者完成手术记录" id="opration_record"/><font class="operation_record">术者完成手术记录</font></label></li>
										</ul>
									</div>	
								</td>
								<td style="width:15%;">
