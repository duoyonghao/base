								...
								<td style="width:25%;">
									<div style="">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>4、<input name="checkOcclusion" type="checkbox" value="4、检查咬合情况" id="checkOcclusion"/>检查咬合情况</label></li>
										</ul>
									</div>	
								</td>
									...
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>5、询问患者舒适度：
											 ...
											 <li><label><i style="color: red;font-style: normal;">*</i>6、<input name="try_in" type="checkbox" value="5、调和" id="try_in"/>调和</label></li>
											 <li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>7、有无变异：</span></div>
