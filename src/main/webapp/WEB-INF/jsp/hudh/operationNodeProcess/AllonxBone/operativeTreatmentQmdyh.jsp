			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="abutment_station" type="checkbox" value="4、确定咬合关系、咬合记录" id="abutment_station">4、确定咬合关系、咬合记录</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="healing_cap_station" type="checkbox" value="5、制作过渡义齿" id="healing_cap_station"/>5、制作过渡义齿</label></li>
											<li><label><input name="postoperation_user_deugs" type="checkbox" value="6、试戴过渡义齿" id="postoperation_user_deugs"/>6、试戴过渡义齿</label></li>
										</ul>
									</div>	
								</td>
