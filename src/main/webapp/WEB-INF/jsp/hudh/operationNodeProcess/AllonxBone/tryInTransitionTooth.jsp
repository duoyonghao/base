			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="tryInTransitionDenture" type="checkbox" value="4、戴过渡义齿" id="tryInTransitionDenture"/>4、戴过渡义齿</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="panoramic_view_piece" type="checkbox" value="5、拍全景片" id="panoramic_view_piece"/>5、拍全景片</label></li>
