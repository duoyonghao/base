								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="askUserSituation" type="checkbox" value="2、询问使用情况" id="askUserSituation"/>2、询问使用情况</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="checkWearToothSitu" type="checkbox" value="5、检查戴牙情况" id="checkWearToothSitu"/>5、检查戴牙情况</label></li>
										</ul>
									</div>	
								</td>
...
function initReviewTime() {
	$.ajax({
		...
		success:function(data){
			...
			var checkWearToothSitu = $("#checkWearToothSitu").find("input[type='checkbox']");
			select_checkWearToothSitu = data.checkweartoothsitu;
			if (select_checkWearToothSitu) {
				$("#checkWearToothSitu").attr("checked","checked");
			}
