			...
			<tbody>
							<tr>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="wearTooth" type="checkbox" value="4、完成病历记录" id="wearTooth"/>4、戴牙</label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="panoramic_view_piece" type="checkbox" value="5、拍全景片（必要时小牙片）" id="panoramic_view_piece"/>5、拍全景片（必要时小牙片）</label></li>
