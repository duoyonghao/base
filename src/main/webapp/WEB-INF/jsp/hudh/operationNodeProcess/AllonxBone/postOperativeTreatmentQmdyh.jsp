							...
							<tr>
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label>1、时间：<input name="operation_time" type="text" id="operation_time" placeholder="2019-01-02 12:00" value="" style="width: 105px;"/></label></li>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="confirmOcclusalRelationship" type="checkbox" value="3、确定咬合关系、咬合记录" id="confirmOcclusalRelationship">3、确定咬合关系、咬合记录</label></li>
											<li><label><input name="makeTransitionDenture" type="checkbox" value="4、制作过渡义齿" id="makeTransitionDenture"/>4、制作过渡义齿</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											<li><label><input name="tryInTransitionDenture" type="checkbox" value="5、试戴过渡义齿" id="tryInTransitionDenture"/>5、试戴过渡义齿</label></li>
										</ul>
									</div>	
								</td>
