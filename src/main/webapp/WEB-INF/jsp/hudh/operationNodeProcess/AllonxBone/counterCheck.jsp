								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="is_stitches" type="checkbox" value="2、询问使用情况" id="is_stitches">2、询问使用情况</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="is_stitches" type="checkbox" value="4、检查咬合情况" id="is_stitches">4、检查咬合情况</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="collutory" type="checkbox" value="5、调合" id="collutory"/>5、调合</label></li>
