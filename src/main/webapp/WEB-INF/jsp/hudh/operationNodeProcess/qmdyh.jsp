								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="panoramic_view_piece" type="checkbox" value="3、定咬合" id="panoramic_view_piece"/>3、定咬合</label></li>
										</ul>
									</div>	
								</td>
								...
								<td>
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><input name="transfer" type="checkbox" value="5、面弓转移，上架" id="transfer">5、面弓转移，上架</label></li>
											<li><label><input name="basalCrowns" type="checkbox" value="6、试基底冠" id="basalCrowns">6、试基底冠</label></li>
										</ul>
									</div>	
								</td>
