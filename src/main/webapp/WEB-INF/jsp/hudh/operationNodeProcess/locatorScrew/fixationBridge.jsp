				...
				<tr>			
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>1、<input name="Consultation" type="checkbox" value="1、固定牙桥"/>固定牙桥</label></li>
								<li><label>2、<input name="Consultation" type="checkbox" value="2、检查术区愈合及术区清洁情况"/>检查术区愈合及术区清洁情况</label></li>
								<li><label>3、<input name="Consultation" type="checkbox" value="3、非微创拆线"/>非微创拆线</label></li>
								<li><label>4、<input name="Consultation" type="checkbox" value="4、根据患者当时病情决定检查项目"/>根据患者当时病情决定检查项目</label></li>
							</ul>
						</div>	
					</td>
					<td style="vertical-align: top;">
						<div style="vertical-align: top;">
							<ul>
								<li><label>5、<input name="Consultation" type="checkbox" value="5、交代注意事项"/>交代注意事项</label></li>
								<li><label>6、<input name="Consultation" type="checkbox" value="6、预约下次来院时间"/>预约下次来院时间</label></li>
								<li><label>7、<input name="Consultation" type="checkbox" value="7、完成病历记录及临床路径录入"/>完成病历记录及临床路径录入</label></li>
							</ul>
						</div>	
					</td>
				</tr>
