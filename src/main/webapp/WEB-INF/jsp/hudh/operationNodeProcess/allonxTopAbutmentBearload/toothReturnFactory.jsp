								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="wearTooth" type="checkbox" value="4、换回第一副临时牙" id="wearTooth"/>4、换回第一副临时牙</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="small_teeth" type="checkbox" value="5、美学牙返回工厂" id="small_teeth"/>5、美学牙返回工厂</label></li>
										</ul>
									</div>	
								</td>
