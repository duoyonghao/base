							...
							<tr>
								<td style="width: 25%;">
									<div>
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="is_stitches" type="checkbox" value="2、拆线" id="is_stitches"/>2、拆线</label></li>
											<li>
												<div class="preparation-ul">
													<div><span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>3、检查螺丝是否松动：</span></div>
													<div><label><input name="anesthesiaMethod" type="radio" value="是" />是</label></div>
													<div><label><input name="anesthesiaMethod" type="radio" value="否" />否</label></div>
												</div>
											</li>
											<li><label><i style="color: red;font-style: normal;">*</i>4、观察口腔清洁情况：
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="accord" type="checkbox" value="5、精细调和、封洞 " id="accord"/>5、精细调和、封洞 </label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="clean_toothbridge" type="checkbox" value="6、清洁牙桥" id="clean_toothbridge"/>6、清洁牙桥 </label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="health_education" type="checkbox" value="7、卫生宣教" id="health_education"/>7、卫生宣教 </label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="neonychium" type="checkbox" value="8、戴保护垫" id="neonychium"/>8、戴保护垫</label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li>
												<div class="preparation-ul">
													<span style="font-weight: bold;" class=""><i style="color: red;font-style: normal;">*</i>9、有无变异：</span>
													<label><input name="is_loose" type="radio" value="有" />有</label>
													<label><input name="is_loose" type="radio" value="无" />无</label>
												</div>
											</li>
											<li><label><input name="nostitches" type="checkbox" value="10、请上级会诊"  id="nostitches">10、请上级会诊</label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="announcements" type="checkbox" value="11、交代注意事项" id="announcements"/>11、交代注意事项</label></li>
										</ul>
									</div>	
								</td>
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>12、预约下次来院时间：<input class="" onfocus="popup()" name="next_hospital_time" type="text" value="" id="next_hospital_time" style="width: 108px;vertical-align: middle;"/></label></li> 
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
			//console.log(JSON.stringify(data)+"---------------hha");
			if (nodeSta == 2) {
			...
			//检查螺丝是否松动
			var anesthesiamethod = data.anesthesiamethod;
			var disease_id = anesthesiamethod.split(";");
