							...
							<tr>
								<td style="width：25%">
									<div >
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>2、观察伤口情况：
											...
											<li><label><i style="color: red;font-style: normal;">*</i>3、观察口腔清洁情况：
								...
								<td style="width：25%">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="wearTooth" type="checkbox" value="4、戴过渡牙" id="wearTooth"/>4、戴过渡牙</label></li>
											<li>
