							...
							<tr>
								<td style="width: 25%;">
									<div>
										<ul>
											...
											<li><label><i style="color: red;font-style: normal;">*</i>2、检查咬合情况：
											...
											<li><label><i style="color: red;font-style: normal;">*</i><input name="clean_toothbridge" type="checkbox" value="3、清洁牙桥" id="clean_toothbridge"/>3、清洁牙桥 </label></li>
										</ul>
									</div>	
								</td>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i>4、检查口腔清洁情况：
