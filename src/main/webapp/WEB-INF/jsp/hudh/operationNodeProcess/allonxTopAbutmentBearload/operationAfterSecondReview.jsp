			...
			<tbody>
							<tr>
								...
								<td style="width: 25%;">
									<div style="margin-left: 68px;">
										<ul>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="clean_toothbridge" type="checkbox" value="7、清洁牙桥" id="clean_toothbridge"/>7、清洁牙桥 </label></li>
											<li><label><i style="color: red;font-style: normal;">*</i><input name="health_education" type="checkbox" value="8、卫生宣教" id="health_education"/>8、卫生宣教 </label></li>
...
function initFirstReview() {
	$.ajax({
		...
		success:function(data){
			console.log(JSON.stringify(data)+"-------------fads");
			if (nodeSta == 2) {
