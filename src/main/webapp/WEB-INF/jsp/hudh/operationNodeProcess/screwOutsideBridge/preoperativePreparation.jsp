			...
			<tbody>
				<tr>
					<td>
						<div style="margin-left: 40px;">
							<ul>
								...
								<li><label><input name="Consultation" type="checkbox" value="2、口内检查" disabled="disabled"/>2、口腔专科检查</label></li>
								<li><label><input name="Consultation" type="checkbox" value="3、术前讨论" disabled="disabled"/>3、术前讨论</label></li>
								<li class="zlCasesLi">
									<label class="zlCasesLiText"><input name="Consultation" type="checkbox" value="制定手术方案和治疗计划" /><font class="diagnosis_case">4、制定手术方案和治疗计划</font></label>
					...
					<td>
						<div style="margin-left: 40px;">
							<ul>
								<li><label><input name="Consultation" type="checkbox" value="11、会诊：内科、综合科" disabled="disabled"/>11、会诊：内科、综合科</label></li>
					...
					<td>
						<div style="margin-left: 40px;">
							<ul>
								<li>
										<span style="font-weight: bold;" class="">15、影像学检查：</span>
								...
								<li>
									<div class="preparation-ul">
										<span style="font-weight: bold;" class="">16、基台放置：</span>
