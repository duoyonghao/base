...
var apppath = apppath();
var pageurl = apppath+'/YkzzManufacturersAct/findAllManufacturers.act';
var $table = $('#table');
...
var manuBtn = {
		add : function (){
			layer.open({
		        ...
		        //点击遮罩关闭层
		        area: ['550px', '250px'],
		        content: apppath + '/HUDH_YkzzViewAct/toSaveManufac.act'
		    });
		},
		edit : function (){
			...
			if(!id) {
				...
				layer.open({
			        ...
			        //点击遮罩关闭层
			        area: ['550px', '200px'],
			        content: apppath + '/HUDH_YkzzViewAct/toUpdateManufac.act?id=' + id
			    });
			}
		},
		deletes : function (){
...
function deletes(id){
	$.ajax({
		url: apppath + "/YkzzManufacturersAct/deleteManufacturersById.act",
		type:"POST",
		dataType:"json",
		async:false,
		data:{"id":id},
