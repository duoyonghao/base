...
$(function (){
	if(!id){
		...
		$.ajax({
			url: apppath + "/HUDH_YkzzManuAct/findYkzzManuById.act",
			type:"POST",
			dataType:"json",
			async:false,
			data:{"id":id},
			success:function(result){
				var ykzzManu = result.ykzzManu;
				if(ykzzManu) {
					$("#manuCode").val(ykzzManu.manuCode);
					$("#manuName").val(ykzzManu.manuName);
					$("#orderno").val(ykzzManu.orderno);
				}
			}
		});
	}
	...
	$("#tijiao").on("click",function (){
		...
		$.ajax({
			url: apppath + "/HUDH_YkzzManuAct/updateYkzzManuById.act",
			type:"POST",
			dataType:"json",
			async:false,
			data:{"id":id,
