...
$(function() {
	$("#leftFrame").attr("src","<%=contextPath%>/WXTemplateItemAct/toSendLeft.act?openid=" + openid);
	$("#contentFrame").attr("src","<%=contextPath%>/WXTemplateItemAct/toSend2.act?openid=" + openid);
});

function refreshWindow(tempObj) {
    parent.sendTemplateMsg(tempObj);
    parent.layer.close(frameindex);
}
</script>
</head>
<frameset rows="*"  cols="25%,*" frameborder="0" border="0" framespacing="0">	
