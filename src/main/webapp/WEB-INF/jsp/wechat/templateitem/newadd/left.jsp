...
function getTemplateMsgList() {
    var pageUrl = "WXTemplateMsgAct/selectList.act?1=1";
    ...
    if (rtData) {
        ...
        function(index) {
            ...
            var li = "<li onclick='toNewPage(\"" + liObj.seqId + "\",\"" + liObj.templateId + "\")' style='cursor:pointer;' >" + liObj.title + "</li>";
            liHtml += li;
        });
        $("#ul").html(liHtml);
    }
...
function toNewPage(seqId, templateId) {
    var url = contextPath + '/WXTemplateItemAct/toAddNew.act?templateSeqid=' + seqId + '&templateId=' + templateId;
