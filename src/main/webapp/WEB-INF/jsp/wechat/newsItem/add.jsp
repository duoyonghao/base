...
<div class="main_bd">
	...
	<div class="media_edit_area" id="js_appmsg_editor">
		<div class="appmsg_editor" style="margin-top: 0px;">
			<div class="inner">
				<form id="form1">
					<input id="newsid" name="newsid" type="hidden" value=""> <input
					...
					<table style="width: 100%" cellpadding="0" cellspacing="1"
						...
						<tr id="contentTr">
							...
							<td class="value"><textarea name="content" id="content"></textarea>
								<script type="text/javascript">
						        var editor = UE.getEditor('content',{initialFrameHeight:320,initialFrameWidth:650});
						    </script></td>
						</tr>
						<tr>
							<td align="right"><label class="Validform_label">
				...
				<div class="btnGroup" style="text-align: center;">
					<button id="save" class="kqdsCommonBtn" onclick="submit();">提交</button>
				</div>
			</div>
...
var organization = $.getUrlVar('organization');
