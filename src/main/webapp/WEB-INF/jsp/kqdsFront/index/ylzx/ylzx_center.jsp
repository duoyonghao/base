...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%=contextPath%>/static/plugin/layer-v2.4/layer/skin/blueSkin/skin_style.css"/>
    <link rel="stylesheet" type="text/css"
    ...
    <script type="text/javascript"
            src="<%=contextPath%>/static/js/bootstrap/bootstrap-table/bootstrap-table-export.js"></script>
    ...
    <div id="main">
        ...
        <div class="centerWrap">
            <div class="columnWrap">
                ...
                <div class="columnBd">
                    <ul id="menuul">
                        <li onclick="netOrderTable();" id="ylhz_wdyy" class="hide">网电预约&nbsp;&nbsp;<span id="wdataCount"
                                                                                                         class="notRead">0</span>
                        </li>
                        <li onclick="hospitalOrderTable();" id="ylhz_mzyy" class="hide">门诊预约&nbsp;&nbsp;<span
                                id="mdataCount" class="notRead">0</span></li>
                        <li onclick="initTable(0);" id="ylhz_ddzl" class="hide">等待治疗&nbsp;&nbsp;<span id="tdataCountd"
                                                                                                      class="notRead">0</span>
                        </li>
                        <li onclick="getOrderlist(1);" id="ylhz_ddjz" class="hide">等待结账&nbsp;&nbsp;<span id="ddataCount"
                                                                                                         class="notRead">0</span>
                        </li>
                        <li onclick="getPayOrderlist();" id="ylhz_yjz" class="hide">已结账&nbsp;&nbsp;<span id="ydataCount"
                                                                                                         class="notRead">0</span>
                        </li>
                        <li onclick="initTable(5);" id="ylhz_jrhz" class="hide">今日患者&nbsp;&nbsp;<span id="tdataCountj"
                                                                                                      class="notRead">0</span>
                        </li>
                    </ul>
                    <div class="tableBox">
...
// 		btnList	+= '{"qx":"tgjh","name":"推广计划"},';
        ...
        btnList += '{"qx":"hzjd_ylzx","name":"创建档案"},';
