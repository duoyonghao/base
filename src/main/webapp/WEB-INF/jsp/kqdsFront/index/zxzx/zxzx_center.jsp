...
<head>
    ...
    <style type="text/css">
        ...
        .operateModel table tr td:hover {
            color: #0e7cc9;
        }
    ...
    <div id="main">
        ...
        <div class="centerWrap">
            <div class="columnWrap">
                ...
                <div class="columnBd">
                    <ul id="menuul">
                        <li onclick="netOrderTable();" id="zxjz_wdyy" class="hide">网电预约&nbsp;&nbsp;<span id="wdataCount"
                                                                                                         class="notRead">0</span>
                        </li>
                        <li onclick="hospitalOrderTable();" id="zxjz_mzyy" class="hide">门诊预约&nbsp;&nbsp;<span
                                id="mdataCount" class="notRead">0</span></li>
                        <li onclick="initTable(0);" id="zxjz_ddzl" class="hide">等待治疗&nbsp;&nbsp;<span id="tdataCountd"
                                                                                                      class="notRead">0</span>
                        </li>
                        <li onclick="getOrderlist(1);" id="zxjz_ddjz" class="hide">等待结账&nbsp;&nbsp;<span id="ddataCount"
                                                                                                         class="notRead">0</span>
                        </li>
...
<script type="text/javascript">
    ...
    function getButtonPower() {
        ...
        /* 按钮 */
        var btnList = '[';
        btnList += '{"qx":"hzjd_zxzl","name":"创建档案"},';
