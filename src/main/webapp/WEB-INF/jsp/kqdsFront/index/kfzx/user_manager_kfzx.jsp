        ...
        <div class="centerWrap">
            ...
            <div class="searchWrap">
                    ...
                    <section>
                        <ul class="conditions">
                            ...
                            <li class="toggleTr">
                                ...
                                <select class="dict searchSelect" name="customer" id="customer" data-bv-notempty
                                        data-bv-notempty-message="客服" data-live-search="true" title="请选择"></select>
                            </li>
                            <!-- <li>
                            ...
                            <li class="toggleTr" id="tool">
                                ...
                                <!-- 								</select> -->
                                <select class="patients-source select2 dict searchSelect" resource="hzly"
                                        name="devchannel" id="devchannel"
                            ...
                            <li class="toggleTr" id="toolSon">
                                <span>子分类</span>
                                <select class="select2 dict searchSelect" name="nexttype" id="nexttype"
                                        data-live-search="true" title="请选择">
                                </select>
                            ...
                            <li class="toggleTr">
                                ...
                                <select class="dict searchSelect" tig="SLGJ" id="gongju" data-live-search="true"
                                        title="请选择"></select>
                            </li>
                            <%} %>
                            <li class="toggleTr">
                            ...
                            <li class="toggleTr">
                                ...
                                <input type="text" id="yewuDesc" name="yewuDesc" value=""
                                       onClick="javascript:single_select_user(['yewu', 'yewuDesc'],'',1);"
                                       readonly></input>
                            </li>
                            <li class="label">
                                ...
                                <ul class="labelUl">
                                    ...
                                    <li class="labelLi">
                                        ...
                                        <div class="form-group labelDetails needTwoIdDetail">
                                            <select id="needTwoId" name="needTwo" tig="" class="dict selectpicker"
                                                    multiple data-live-search="true" title="请选择"
                                                    onchange="needTwoSelectOnchang();"></select>
                                        </div>
                                    </li>
                                    <li class="labelLi">
                                        <span class="labeltitle">三级标签:</span>
                                        <div class="form-group labelDetails needThreeIdDetail">
                                            <select id="needThreeId" name="needThree" tig="" class="dict selectpicker"
                                                    multiple data-live-search="true" title="请选择"
                                                    onchange="needThreeSelectOnchang();"></select>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="labelUl">
                                    ...
                                    <li class="labelLi">
                                        ...
                                        <div class="form-group labelDetails societyTwoIdDetail">
                                            <select id="societyTwoId" name="societyTwo" tig="" class="dict selectpicker"
                                                    multiple data-live-search="true" title="请选择"
                                                    onchange="societyTwoSelectOnchang();"></select>
                                        </div>
                                    </li>
                                    <li class="labelLi">
                                        <span class="labeltitle">三级标签:</span>
                                        <div class="form-group labelDetails societyThreeIdDetail">
                                            <select id="societyThreeId" name="societyThree" tig=""
                                                    class="dict selectpicker" multiple data-live-search="true"
                                                    title="请选择" onchange="societyThreeSelectOnchang();"></select>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="labelUl">
                                    ...
                                    <li class="labelLi">
                                        ...
                                        <div class="form-group labelDetails expenseTwoIdDetail">
                                            <select id="expenseTwoId" name="expenseTwo" tig="" class="dict selectpicker"
                                                    multiple data-live-search="true" title="请选择"
                                                    onchange="expenseTwoSelectOnchang();"></select>
                                        </div>
                                    </li>
                                    <li class="labelLi">
                                        <span class="labeltitle">三级标签:</span>
                                        <div class="form-group labelDetails expenseThreeIdDetail">
                                            <select id="expenseThreeId" name="expenseThree" tig=""
                                                    class="dict selectpicker" multiple data-live-search="true"
                                                    title="请选择" onchange="expenseThreeSelectOnchang();"></select>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="labelUl">
                                    ...
                                    <li class="labelLi">
                                        ...
                                        <div class="form-group labelDetails starsLevelTwoIdDetail">
                                            <select id="starsLevelTwoId" name="starsLevelTwoId" tig=""
                                                    class="dict selectpicker" multiple data-live-search="true"
                                                    title="请选择" onchange="starsLevelTwoSelectOnchang();"></select>
                                        </div>
                                    </li>
                                    <li class="labelLi">
                                        <span class="labeltitle">三级标签:</span>
                                        <div class="form-group labelDetails starsLevelThreeIdDetail">
                                            <select id="starsLevelThreeId" name="starsLevelThree" tig=""
                                                    class="dict selectpicker" multiple data-live-search="true"
                                                    title="请选择" onchange="starsLevelThreeSelectOnchang();"></select>
                                        </div>
                                    </li>
                                </ul>
                                <ul class="labelUl">
                                    ...
                                    <li class="labelLi">
                                        ...
                                        <div class="form-group labelDetails unsatisfiedTwoIdDetail">
                                            <select id="unsatisfiedTwoId" name="unsatisfiedTwoId" tig=""
                                                    class="dict selectpicker" multiple data-live-search="true"
                                                    title="请选择" onchange="unsatisfiedTwoSelectOnchang();"></select>
                                        </div>
                                    </li>
                                    <!-- 				    				<li  class="labelLi"> -->
                                    <!-- 						    			<span class="labeltitle">三级标签:</span>   -->
                                ...
                                <ul class="labelUl">
                                    <li class="labelLi">
                                        ...
                                        <div class="form-group labelDetails askpersonSearch">
                                            <select name="askpersonSearch" id="askpersonSearch" class="selectpicker"
                ...
                <div class="btnBar" style="border-top:none;" id="recommendedBarDiv">
                    ...
                    <a href="javascript:void(0);" class="kqdsCommonBtn hide" id="kf_tjtg"
                       onclick="goAddRenwu()">添加推广</a>
                    <a href="javascript:void(0);" class="kqdsCommonBtn hide" id="kf_tjhf"
                       onclick="goAddVisit()">添加回访</a>
                    ...
                    <a href="javascript:void(0);" class="kqdsCommonBtn hide" id="zhiding_kefu"
                       onclick="setKeFu();">指定客服</a>
