...
<!-- 		    						<select class="dict" tig="SLGJ" id="gongju" ></select> -->
			    		...
			    		<div class="btnBar" id ="recommendedBarDiv">
...
var pageurl = '<%=contextPath%>/KQDS_UserDocumentAct/userManger4Wdzx.act';
var listbutton;
var onclickrowOobj = "";
var nowday;
var selectedrows = "";
...
$(function() {
	...
	togglemodel.initial('wdzx',pageurl);/*wl 初始化 开关模块 */
    //3、加载表格
    initTable(1);
    ...
    $('#table').bootstrapTable({
        ...
        onLoadSuccess: function(data) { //加载成功时执行
            ...
            for (var i = 0; i < tableList.rows.length; i++) {
                if (tableList.rows[i].doorstatus == "已上门") {
                    sms = sms + 1;
                } else {
                    wsms = wsms + 1;
                }
                if (tableList.rows[i].cjstatus == "已成交") {
                    cjs = cjs + 1;
                } else {
                    wcjs = wcjs + 1;
                }
...
function goAddVisit() {
    if (onclickrowOobj == null || onclickrowOobj == "" || onclickrowOobj == "null" || onclickrowOobj == "undefined") {
        ...
        layer.open({
            ...
            shade: 0.6,
            area: ['550px', '480px'],
            content: contextPath+'/KQDS_VisitAct/toVisitAddf.act?lytype=usermanager&type=khgl&usercode=' + onclickrowOobj.usercode 
        });
    }
}
//修改关联人
...
// 	console.log(sectionName,"sectionName")
	if(sectionName == "正畸网电部"){
		layer.open({
	        type: 2,
	        id:'create-recordFather',
	        title: '患者建档',
	        shadeClose: false,
	        shade: 0.6,
	        area: ['740px', '90%'],
	...
	if(sectionName == "种植网电咨询部"){
	    layer.open({
	        ...
	        shade: 0.6,
	        area: ['740px', '90%'],
	        content: contextPath + '/KQDS_UserDocumentAct/toHzjd_Net.act'    
	    });
	}
	layer.open({
        type: 2,
 ...
 */
 function updateJdr(){
	 selectedrows = getIdSelections();
	    if (selectedrows.length == 0) {
	        layer.alert('请勾选复选框，选择需要修改建档人的患者(可多选)' );
	    } else {
	    	 //修改建档人
	        layer.open({
	            type: 2,
	            ...
	            shade: 0.6,
	            area: ['740px', '90%'],
	            content: contextPath + '/KQDS_UserDocumentAct/toWdzx_xgjdr.act?selectedrows=' + selectedrows
	        });
	    }
}
...
function hzjdedit() {
    ...
    if (onclickrowOobj == null || onclickrowOobj == "" || onclickrowOobj == "null" || onclickrowOobj == "undefined") {
        ...
        layer.open({
            ...
            shade: 0.6,
            area: ['740px', '90%'],
//            content: contextPath + '/KQDS_UserDocumentAct/toHzjd_Net_REVAMP.act?usercode=' + onclickrowOobj.usercode
...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        ...
        }else if(listbutton[i].qxName == "xgjd"){
        	menubutton1 += '<a href="javascript:void(0);" class="kqdsCommonBtn" onclick="updateJdr();">修改建档人</a>&nbsp;';
        }
    }
