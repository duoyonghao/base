...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "zhcx_fycx") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_Zhcx.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "zhcx_mxcx") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_Sfmx.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "zhcx_qfcx") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_Qfcx.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "zhcx_skmx") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_Sfmx_all.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "zhcx_yjfa") {//添加预交方案查询
        	 menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_YJfa.act">' + listbutton[i].name + '</li>';
		}
    }
