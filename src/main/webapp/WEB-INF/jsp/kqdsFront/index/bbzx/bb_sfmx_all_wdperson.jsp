...
var menuid = "<%=menuid%>";
var qxnameArr = ['xfmx_all_wd_scbb'];
...
function setHeight() {
    ...
    $("#table").bootstrapTable("resetView",{
    	height:$(window).outerHeight()-$(".searchWrap").outerHeight()-$("#buttonBar").outerHeight()-20
    });
...
function getPayOrderlist(url) {
    ...
    $('#table').bootstrapTable({
        ...
        },
        {
            ...
            formatter: function(value, row, index) {
                if (value) {
                    return '<span style="width:140px;float:left;position:relative;top:-1px;text-align:left;" title="' + value + '">' + value + '</span>';
                } else {
                    return '';
                }
            }
