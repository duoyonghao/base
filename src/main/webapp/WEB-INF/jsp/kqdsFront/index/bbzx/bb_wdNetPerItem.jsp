...
<div id="container">
    ...
    <div class="table-responsive table2excel tableBox"  style="overflow: auto;">
     	 <table class="tableBody showTable table-striped table-condensed table-bordered" style="width: 100%">
     	 		<thead>
	     	 		<tr>
				 		<th  style="text-align: center" ><span>咨询人员</span></th>
				 		...
				 		<th  style="text-align: center" ><span>到诊成功率(%)</span></th>
...
var pageurl = contextPath + '/KQDS_ScbbAct/getWdOrderPerItemtj.act';
var nowday;
var menuid = "<%=menuid%>";
        ...
        if (data != null) {
            if (data.length > 0) {
                ...
                for (var i = 0; i < data.length; i++) {
                    if (data[i].zxxm) {
                        content += '<tr>';
                        content += '<td style="text-align: center"><span>' + data[i].username + '</span></td>';
                        ...
                        content += '<tr>';
                        content += '<td style="text-align: center" colspan="2"><span>合计</span></td>';
                        content += '<td style="text-align: center"><span>' + data[i].ldnums + '</span></td>';
                       ...
                       /*  content += '<td style="text-align: center"><span>' + data[i].cjnums + '</span></td>';
                        ...
                        content += '<tr>';
                        content += '<td style="text-align: center" colspan="2"><span>小计</span></td>';
                        content += '<td style="text-align: center"><span>' + data[i].ldnums + '</span></td>';
