...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "zxqktj_zxyqktjb") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_AskCgl.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "zxqktj_zxqkaxmtjb") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_AskSort.act">' + listbutton[i].name + '</li>';
        }
    }
