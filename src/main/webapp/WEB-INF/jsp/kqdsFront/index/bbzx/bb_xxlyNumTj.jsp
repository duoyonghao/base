            ...
            <div class="formBox">
                ...
                <div class="kv">
			     ...
			     <div class="kv" style="width:250px; margin:0 auto;text-align:center; ">
				        <a href="#" class="kqdsSearchBtn" id="query">查询</a>
			    </div>
			    
            </div>
        </div> 
    <div class="tableHd">患者来源人数</div>
    ...
    <div class=" table2excel tableBox"  style="position:relative;">
    	<div class="tableHeader" style="position:absolute; top:0;left:0;height:55px;overflow:hidden;">
    		<table id="tableHeader" class="table-striped table-condensed table-bordered" style="visibility:hidden;">
     	 		<tr>
			 		<td  style="text-align: center" rowspan="2">患者来源类型</td>
			 		<td  style="text-align: center" rowspan="2">患者来源</td>
			 		<td  style="text-align: center" rowspan="2">来源人次</td>
			 		<td  style="text-align: center" rowspan="2">占总人次(%)</td>
			 		<td  style="text-align: center" rowspan="2">成交人次</td>
			 		<td  style="text-align: center" rowspan="2">占成交人次(%)</td>
			 		<td  style="text-align: center" rowspan="2">未成交人次</td>
			 		<td  style="text-align: center" rowspan="2">占未成交人次(%)</td>
			 		...
			 		<td  style="text-align: center" colspan="2">复查</td>
...
var pageurl = contextPath+'/KQDS_ScbbAct/selectCountXxlyNum.act';
var nowday;
var menuid = "<%=menuid%>";
