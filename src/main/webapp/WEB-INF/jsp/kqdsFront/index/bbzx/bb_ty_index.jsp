...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "bbzx_skcx") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_Rsktj_Search.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "bbzx_yjjcx") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_Ty_Yjjcx.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "bbzx_hjzlqktj") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_Ty_Hjzlqktj.act">' + listbutton[i].name + '</li>';
        }
    }
