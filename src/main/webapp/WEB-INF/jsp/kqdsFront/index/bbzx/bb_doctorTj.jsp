...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "ysqktj_ysqktj") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_DoctorQkTj.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "ysqktj_ysyjtj") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_DoctorYjTj.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "ysqktj_clcbtj") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_DoctorClcbTj.act">' + listbutton[i].name + '</li>';
        }
    }
