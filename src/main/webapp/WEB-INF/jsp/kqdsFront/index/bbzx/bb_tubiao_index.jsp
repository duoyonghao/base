...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "tbtj_zxcjl") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_RegCjlHigh.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "tbtj_yysml") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_YysmlHigh.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "tbtj_ghrstj") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_RegHigh.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "tbtj_xffltj") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_QzHigh.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "tbtj_qyyjqk") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_ScbbAct/toBb_QyyjHigh.act">' + listbutton[i].name + '</li>';
