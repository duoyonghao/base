...
<!-- 									</select> -->
				    			...
				    			<li class="toggleTr">
				    				<span>建档人</span>
				    				 <input type="hidden" name="jdr" id="jdr" placeholder="建档人" title="建档人" class="form-control" value=""/>
									 <input type="text"  id="jdrDesc" name="jdrDesc" placeholder="建档人" readonly  onClick="javascript:single_select_user(['jdr', 'jdrDesc'],'single',1);">	
				    			</li>
				    			<li class="toggleTr" id="tool">
				    				<span>患者来源</span>
				    				<select id="devchannel" name="devchannel" class="patients-source select2 dict searchSelect" resource="hzly"  data-live-search="true" onchange="getSubDictSelectSearch('devchannel','nexttype');" title="请选择"></select>
