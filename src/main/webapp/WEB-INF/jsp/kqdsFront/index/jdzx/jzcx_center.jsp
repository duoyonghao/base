	                ...
	                <div class="formBox">
	                	<section>
				    		<ul class="conditions">
				    			...
				    			<li class="toggleTr">
				    				<span>接诊咨询</span>
				    				 <select id="askpersonSearch" name="askpersonSearch" class="patients-source select2 dict searchSelect"  data-live-search="true" title="请选择"></select>
...
<!-- 									</select> -->
				    			...
				    			<li class="toggleTr">
				    				<span>医生</span>
				    				 <select id="doctorSearch" name="doctorSearch" class="patients-source select2 dict searchSelect"  data-live-search="true" title="请选择"></select>
...
<!-- 			    					<select class="dict" tig="SLGJ" id="gongju" ></select> -->
				    			...
				    			<li class="toggleTr" id="tool">
				    				<span>患者来源</span>
				    				<select id="devchannelSearch" name="devchannelSearch" class="patients-source select2 dict searchSelect" tig="hzly"  data-live-search="true" onchange="getSubDictSelectSearch('devchannelSearch','nexttype1');" title="请选择"></select>
...
<!-- 									</select> -->
				    			...
				    			<li class="toggleTr hide" id="jzcx_askperson">
					    			<span>第一咨询</span>
					    			<select class="patients-source select2 dict searchSelect" data-live-search="true" title="请选择" title="咨询" placeholder="咨询" name="firstAskperson" id="firstAskperson"></select>
				    			</li>	
			    			</ul>
			    		</section>
