...
<%
    ...
    if (reqUrl.contains("user_manager_jq.jsp")) {
        is_Wd_oper = "wd";
    } else {
        is_Wd_oper = "";
    }
    ...
    <div class="columnBd" id="rightmenu">
        <ul class="menu">
            <li class="current" target="tabIframe"
                src="<%=baseheader%>/KQDS_UserDocumentAct/toGrxx.act">
            ...
            %>
            <li target="tabIframe"
                src="<%=baseheader%>/KQDS_Net_OrderAct/toNetorderInsertOrupdate.act?source=<%=staticIsUserMgrPage%>">
            ...
            <li target="tabIframe"
                ...
                <img class="middleImageIcon"
                     src="<%=baseheader%>/static/image/kqdsFront/img/icon/consultRecordIcon.png"/>
                咨询记录
            </li>
            ...
            <li target="tabIframe"
                ...
                <img class="middleImageIcon"
                     src="<%=baseheader%>/static/image/kqdsFront/img/icon/returnVisitManageIcon.png"/>
                回访管理
            </li>
            <li target="tabIframe"
        ...
        <div class="tabContainer">
            <iframe id="tabIframe" name="tabIframe"
                    src="<%=baseheader%>/KQDS_UserDocumentAct/toGrxx.act"
                    width="100%" height="100%" frameborder="0" class="tabIframe"></iframe>
        </div>
    </div>
</div>
