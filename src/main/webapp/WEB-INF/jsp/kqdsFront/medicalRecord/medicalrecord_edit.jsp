...
<div id="container">
	    ...
	    <div class="tableBox">
			<form class="form-horizontal" id="form2">
	            ...
	            <div class="tableHd">
					...
					<a href="javascript:void(0);" class="optA clearRow"  onclick="delRow();">清除行</a>
					<a href="javascript:void(0);" class="optA addRow"    onclick="addRow();">增加行</a>
				</div>
			    <!--初诊 -->
	...
	<div id="formbtn" class="formBox">
            <div class="kv form-group" style="width:100%;">
           		病历分类：
               	<select class="dict" tig="blfl" name="blfl" id="blfl" style="width:100px"></select>
               	&nbsp;&nbsp;
               	病&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;程：
           	...
           	<div class="kv form-group"  style="width:100%;">
				...
				<input type="text" class="greyInp"  id="doctorDesc" name="doctorDesc" placeholder="医生" readonly style="width: 100px;" onClick="javascript:single_select_user(['doctor', 'doctorDesc'],'single');"  ></input>	
			
               	&nbsp;&nbsp;
               	护&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;士：
               	<input type="hidden" name="nurse" id="nurse"  class="form-control" />
				<input type="text"  class="greyInp"  id="nurseDesc" name="nurseDesc" placeholder="护士" readonly style="width: 100px;"onClick="javascript:single_select_user(['nurse', 'nurseDesc'],'single');"  ></input>	
            </div>
    </div>
...
function getdata() {
    ...
    function(data) {
        ...
        getSubDictSelectByParentCode(davalul.blfl,'bc'); // 根据分类，初始化病程
        ...
        // 恢复病历时，自动赋值
        if (davalul.doctor) {
            $("#doctor").val(davalul.doctor); // ### 青岛特定需求，给医生护士赋值
            bindPerUserNameBySeqIdTB("doctorDesc", davalul.doctor);
        }
        if (davalul.nurse) {
            $("#nurse").val(davalul.nurse);
            bindPerUserNameBySeqIdTB("nurseDesc", davalul.nurse);
        }
    },
    function() {
        layer.alert('查询出错！'  );
...
function baocun() {
    var url = '<%=contextPath%>/KQDS_MedicalRecordAct/updateBl.act';
