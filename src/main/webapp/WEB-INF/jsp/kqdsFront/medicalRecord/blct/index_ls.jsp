...
$(function(){
	...
	if(data){
		...
		for (var i = 0; i < tabList.length; i++) {
			...
			var tabUrl = "<%=contextPath%>/YZBlctAct/toBlctList.act?organization=" + tabList[i].deptCode;
		...
		var tabUrl = "<%=contextPath%>/YZBlctAct/toBlctList.act?organization=";
