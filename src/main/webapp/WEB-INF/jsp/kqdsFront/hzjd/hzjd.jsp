			...
			<table class="tableContent"><!--tableContent的样式 -->
				<tbody>
					...
					<tr>
						...
						<td class="relative">
							<div class="form-group">
							 	<select id="devchannel" name="devchannel" class="select2 dict searchSelect"  data-live-search="true" resource="hzly" title="请选择" onchange="getSubDictSelectSearch('devchannel','nexttype','add');"></select>
...
$('#submit').on('click', function(){
	...
	//患者标签参数
     ...
     var params = { labelAllArr : labelAllArr,
    		 		exploit:exploit,
    		 		exploit1:exploit1,
    		 		exploitId:exploitId,
            ...
            layer.alert('创建成功', {
            	 closeBtn: 0,  
                     ...
                     function() {
                         ...
                         // 根据姓名、手机号查询刚刚创建的患者            
                         var usercode=r.usercode;
//                          var retusername = $("#username").val();
//                          var retphonenumber1 =  $("#phonenumber1").val();
//                          var retphonenumber2 =  $("#phonenumber2").val();
//                          var thisusercode = getUsercodeByPhoneAndNameTB(retusername, retphonenumber1, retphonenumber2);
                         parent.layer.open({
                             type: 2,
                             title: '就诊挂号',
                             shadeClose: false,
                             shade: 0.6,
                             area: ['950px', '530px'],
                             content: contextPath + '/KQDS_REGAct/toAddReg.act?usercode=' + usercode
                         });
