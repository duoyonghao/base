              ...
              <table class="kqds_table">
			    		<tr>
			    			...
			    			<td style="width:80%;text-align:left;"> 
		    					<input type="text" class="form-control" name="jfmoney" id="jfmoney"><span style="color:red;">&nbsp;*&nbsp;输入项必须为负数</span>
			                </td>
			    		</tr>
			    		<tr>
			    			<td>备注：</td>
...
function submitu(){
	...
	var jftype = $("#jftype").val();
	if(jfmoney == "" || jfmoney == null) {
		layer.alert('请输入减少的积分金额' );
		return false;
	}
	if(Number(jfmoney)>=0){
		layer.alert('输入项必须为负数' );
		return false;
	}
