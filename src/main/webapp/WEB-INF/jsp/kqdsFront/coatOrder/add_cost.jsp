...
<div id="container" >
			...
			<div class="formBox">
				<section>
					<ul class="conditions" style="height: 90px">
						...
						<li>
							...
							<input type="text" id="introducerDesc" name="introducerDesc" placeholder="介绍人"  readonly></input>
						</li>
						<!--<li>
							<span>会员信息</span>
				...
				<!-- <div class="kv">
					...
					<div class="kv-v">
						...
						<li>
							<a href="javascript:void(0);" class="kqdsCommonBtn" onclick="saveform1()">保存资料</a><!-- 调用add_cost.js中的方法 -->
	...
	<div id="fyxq"> <!-- 费用详情 -->
		<div class="tableHd" style="padding: 0 20px;line-height: 40px;font-size: 14px;color: #FFFFFF;background: #00A6C0 ;">费用详情</div>
	    <div class="tableBox">
	        <table id="tablefyxq" class="table-striped table-condensed table-bordered"></table>
	    </div>
		<div id="xqxmqd"><!-- 费用详情对应的费用明细 -->
			<div class="tableHd" style="padding: 0 20px;line-height: 40px;font-size: 14px;color: #FFFFFF;background: #00A6C0 ;">详细项目清单</div>
		...
		<div class="costHd"> <!-- Header -->
			...
			<div class="kv">
				...
				<!-- <div class="kv-v"> -->
					...
					<select class="dict" tig="HYKFL" name="memberlevel" id="memberlevel" disabled="disabled"></select>
					<input type="text" id="hyzk" value="无折扣" style="line-height:22px;width:105px; color:#333;" readonly/>
					<input type="text" id="yue" value="余额：0 ￥" style="line-height:22px; width:125px; color:#333;" readonly/>
				<!-- </div> -->
			</div>
		</div>
				...
				<section>
					<ul class="conditions">
						<li>
							...
							<select name="askperson" id="askperson" class="searchSelect" data-live-search="true"></select>
...
<!-- 							<select name="doctor" id="doctor" ></select> -->
							...
							<input type="text" id="doctorDesc" name="doctorDesc" placeholder="医生" readonly onClick="javascript:single_select_user(['doctor', 'doctorDesc'],'single','0','1,4');"  > --> <!-- 只显示医生、护士部门的，洗牙有时候是护士洗的 -->
						</li>
						<li>
...
<!-- 							<select id="nurse" name="nurse"></select> -->
						...
						<li>
							...
							<select name="techperson" id="techperson" class="searchSelect" data-live-search="true"></select>
<!-- 							<select id="techperson" name="techperson"></select> -->
						</li>
						<li>
							<label style="font-weight: normal;vertical-align: middle;"><input type="checkbox" id="yhstatus" name="yhstatus">项目信息</label> <!-- 勾选状态后，分别点击不同的收费项目，会展示不同的项目介绍和优惠信息 -->
						</li>
					</ul>
				</section>
			</div>
...
$(function() {
    ...
    $("#yhxxDiv").hide();
    //咨询 下拉列表
    initPersonSelectByDeptType("askperson","<%=ConstUtil.DEPT_TYPE_0 %>"); /** 当前部门的  **/
    ...
    var baseinfo = getBaseInfoByUserCode(static_usercode); /** 该请求和上面的getHzNameByusercodeTB()方法存在重复，可优化！  **/
    hykdiscount = baseinfo.discount;
    var zong = Number(baseinfo.money) + Number(baseinfo.givemoney); /** 这儿是该患者对应所有会员卡的金额 **/
    $('#ye').val(zong);
    zTreeInit();
