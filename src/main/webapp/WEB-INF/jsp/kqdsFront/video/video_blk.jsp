...
<div id="container" style="height:94%">
    <div class="infoBd" style="height:100%;width:98%;">
        <div class="photoWrap" id="tFocus" style="width:95%;">
        ...
        <div class="bottomBar" style="width:95%">
        	<table width="100%">
        		<tr>
        			<td align="left">
        				<ul name="yxflul" ></ul>
        ...
        if (list != null) {
            if (list.length > 0) {
                ...
                for (var j = 0; j < list.length; j++) {
                    ...
                    // 拼接 ul 和 select 
                    ulstr += '<li value="' + optionStr.seqId + '" style="cursor: pointer;">' + optionStr.dictName + '</li>';
                }
...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        ...
        if (listbutton[i].qxName == "yxzl_xztp") { // 不是撤销挂号
            menubutton1 += ' <button onclick="selectFile();" style="right:0px;border-color:#0e7cc9;margin-right:3px;" class="btn btn-default">选择图片</button>';
            menubutton1 += ' <button id="delBtn" style="right:0px;border-color:#0e7cc9;margin-right:10px;" class="btn btn-default">删除图片</button>';
        }
        // 内窥镜
        if (listbutton[i].qxName == "yxzl_nkj") {
            menubutton1 += ' <button id="ctlBtn" style="right:0px;border-color:#0e7cc9;margin-right:10px;" class="btn btn-default"> 内  窥  镜 </button>';
        }
    }
    // 选择图片
