   ...
   <!--查询条件-->
    ...
    <div class="tableBox" align="center">
    	<table style="width:90%;text-align: center;"> 
       		<tr>
      			<td style="width:28%" colspan="2"><span style="color:red;">退费-充值小计:<lable id="tdmoney">0</lable></span></td>
      			<td style="width:28%" colspan="2"><span style="color:red;">退费-赠送小计:<lable id="tdgivemoney">0</lable></span></td>
      			<td style="width:28%" colspan="2"><span style="color:red;">退费小计:<lable id="tdtotal">0</lable></span></td>
      			<td style="width:16%"></td>
      		</tr>
      		<tr>	
      			<td style="width:13%"><span style="color:#00A6C0;"><%=SysParaUtil.getFkfsNameByMemberField(request, "xjmoney") %>退费小计:<lable id="tdxj">0</lable></span></td>
      			<td style="width:13%"><span style="color:#00A6C0;"><%=SysParaUtil.getFkfsNameByMemberField(request, "zfbmoney") %>退费小计:<lable id="tdzfb">0</lable></span></td>
      			<td style="width:13%"><span style="color:#00A6C0;"><%=SysParaUtil.getFkfsNameByMemberField(request, "wxmoney") %>退费小计:<lable id="tdwx">0</lable></span></td>
      			<td style="width:13%"><span style="color:#00A6C0;"><%=SysParaUtil.getFkfsNameByMemberField(request, "yhkmoney") %>退费小计:<lable id="tdyhk">0</lable></span></td>
      			<td style="width:13%"><span style="color:#00A6C0;"><%=SysParaUtil.getFkfsNameByMemberField(request, "mmdmoney") %>退费小计:<lable id="tdmmd">0</lable></span></td>
      			<td style="width:13%"><span style="color:#00A6C0;"><%=SysParaUtil.getFkfsNameByMemberField(request, "bdfqmoney") %>退费小计:<lable id="tdbdfq">0</lable></span></td>
      			<td style="width:13%"><span style="color:#00A6C0;"><%=SysParaUtil.getFkfsNameByMemberField(request, "qtmoney") %>退费小计:<lable id="tdqt">0</lable></span></td>
       		</tr> 
       	</table>
    </div>
</div>
...
function() {
    ...
    // 默认A5打印
    var hyurl = contextPath + '/KQDS_Print_SetAct/toHyczPrintPage.act?printpage='+printSet.printurl+'&printType=' + printSet.printtype + '&cztime=' + onclickrowobj.createtime + '&memberno=' + onclickrowobj.cardno + '&username=' + onclickrowobj.username + '&money=' + onclickrowobj.cmoney + '&givemoney=' + onclickrowobj.cgivemoney + '&totalmoney=' + onclickrowobj.ctotal + '&ymoney=' + onclickrowobj.ymoney + '&recordId=' + onclickrowobj.seqId + '&usercode=' + onclickrowobj.usercode + '&ygivemoney=' + onclickrowobj.ygivemoney + '&ytotalmoney=' + onclickrowobj.ytotal + '&cost_organization=' + onclickrowobj.organization;
