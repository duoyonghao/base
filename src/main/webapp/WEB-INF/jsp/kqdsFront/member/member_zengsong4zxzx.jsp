...
<meta charset="utf-8" />
<title>咨询中心-赠送项目</title><!-- 该页面会查询出之前的赠送记录 -->
		...
		<div class="costHd">
			...
			<div class="kv">
				<label style="margin:0 5px 0 0;">会员卡</label>
					...
					<select class="dict" tig="HYKFL" name="memberlevel" id="memberlevel" disabled="disabled" style="width:120px;"></select>
...
$(function() {
	...
	intMemberCardListByUserCode("hyxxSelect", usercode); // 初始化会员下拉
    inititems(); //加载左侧项目列表
    getitems(); //加载项目列表
});
