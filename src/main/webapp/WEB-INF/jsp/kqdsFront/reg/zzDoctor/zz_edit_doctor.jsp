...
<input type="hidden" id="regno" name="regno" >
	<div class="" style="">
			<div class="filterWrap" style="padding-top:10px;">
				<div class="kv">
					<label>病人编号</label>
					<div class="kv-v">
				...
				<div class="kv">
					...
					<div class="kv-v">
						...
						<input type="text"   id="doctorDesc" name="doctorDesc" placeholder="医生" readonly style="width: 120px;" onClick="javascript:single_select_user(['doctor', 'doctorDesc']);"  ></input>	
					</div>
				</div>
			</div>
		 <div class="tableBox">
		 	<p	class="table-title ">收费项目</p>
		 	<div id="divkdxm">
         ...
         <div class="register-bottom">
		   	<div class="formBox">
					...
					<div class="kv">
					   	<label>转诊原因</label>
				       	<textarea  style="width: 470px;min-height: 120px;padding:5px;" name="remark" id="remark" rows="1" placeholder="" ></textarea>	
						
					</div>
			</div>
         </div>
         <div style="text-align:center;padding:10px 0;border-top:1px solid #ddd;">
         	<a href="javascript:void(0);" class="kqdsSearchBtn" onclick="save();" >保存</a>
...
function save(){
	...
	if(doctor==oldDoctor){
		layer.alert('转诊人不能与原医生相同！' );
		return false;
	}
	var url = '<%=contextPath%>/KQDS_ChangeDoctorAct/zzDoctor.act?regno='+regno+'&oldDoctor='+oldDoctor+'&doctor='+doctor + '&costno='+costno+'&remark='+remark+'&usercode='+usercode+'&username='+username;
	$.axse(url,null,
             function(r){
	    	    if(r.retState=="0"){
...
function setHeight(){
	$("#tabledayin").bootstrapTable("resetView",{
		height:$(window).outerHeight()-$(".filterWrap").outerHeight()-$(".register-bottom").outerHeight()-110
	});
}
</script>
