...
<%
	...
	if(YZUtility.isNullorEmpty(regsortvalue)){
		regsortvalue = "";
	}
...
var regsortvalue = "<%=regsortvalue %>";
var organization="<%=organization%>";
$(function () {
	initDictSelect("regsort", "ghfl"); // 必须请求方式为同步，
	$("#regsort").val(regsortvalue);
});
...
function submitu(){
    ...
    function() {
    	var url = '<%=contextPath%>/KQDS_REGAct/updateRegModify.act';
        $.axseSubmit(url,a, 
   		function(){
