               	...
               	<div class="kv">
					...
					<div class="kv ">
			            ...
			            <div class="kv-v">
							 ...
							 <input type="text"  class="form-control" id="createuserDesc" name="createuserDesc" placeholder="建档人" readonly onClick="javascript:single_select_user(['createuser', 'createuserDesc'],'',1);"  ></input>	
			        	</div>
      	 			 </div>
      	 			 <div class="kv ">
			            <label>关联人</label>
			            <div class="kv-v">
							 <input type="hidden" name="glr" id="glr"  class="form-control" />
							 <input type="text"  class="form-control" id="glrDesc" name="glrDesc" placeholder="关联人" readonly onClick="javascript:single_select_user(['glr', 'glrDesc'],'',1);"  ></input>	
			       		 </div>
			       	</div>
                </div>
            </div>
...
var pageurl = '<%=contextPath%>/KQDS_ChangeWdAct/selectNoPage.act';
//初始化表头，返回空的数据
...
function getlzjl(requrl){
	...
	columns: [
	        	...
	        	{title: '病人编号',field: 'usercode',align: 'center',valign: 'middle'},
                {title: '姓名',field: 'username',align: 'center',valign: 'middle'}, 
                {title: '建档人',field: 'oldper',align: 'center',valign: 'middle',sortable: true,
       			...
       			{title: '建档时间',field: 'jdsj',align: 'center',valign: 'middle',sortable: true,
 	                  formatter:function(value,row,index){  
               	  if(value!=""  && value!=null){
                ...
                {title: '关联人',field: 'toper',align: 'center',valign: 'middle',sortable: true,
       				formatter: function(value, row, index) {
       	                if (value != "" && value != null) {
       	                    return '<span class="name" title="' + value + '">' + value + '</span>';
       	                } else {
         			...
         			{title: '修改原因',field: 'remark',align: 'center',valign: 'middle',sortable: true,
   	                  formatter:function(value,row,index){  
	                	  if(value!=""  && value!=null){
	                		  return '<span class="time">'+value+'</span>';
	                	  }
         		   ...
         		   {title: '修改人',field: 'xgr',align: 'center',valign: 'middle',sortable: true,
         			  formatter: function(value, row, index) {
         	                if (value != "" && value != null) {
         	                    return '<span class="name" title="' + value + '">' + value + '</span>';
         	                } else {
         			...
         			{title: '修改时间',field: 'xgsj',align: 'center',valign: 'middle',sortable: true,
   	                  formatter:function(value,row,index){  
	                	  if(value!=""  && value!=null){
	                		  return '<span class="time">'+value+'</span>';
	                	  }else{
