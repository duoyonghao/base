		...
		<div class="filterWrap">
			<div class="kv searchKv">
				<div class="kv-v">
					...
					<a id="searchHzda" href="javascript:void(0);" style="margin-left:10px;" class="kqdsSearchBtn" onclick="searchHzda()">查 询</a>
				</div>
			</div>
		</div>
		 <div class="tableBox">
		 	<p	class="table-title">查询清单</p>
            <table id="table" class="table-striped table-condensed table-bordered" data-height="380"></table>
         </div>
         <div class="position-bottom" >
         	<!-- <div class="clear2"></div> -->
         	<a class="kqdsCommonBtn" id="zz">转 诊</a>
...
$('#zz').on('click', function(){
	...
	layer.open({
		...
		area : ['550px' , '540px'],
		content: contextPath+'/KQDS_UserDocumentAct/toZzAddWin.act?usercode=' + usercode
	});
});
$('#zzjl').on('click', function(){
	layer.open({
		...
		shadeClose: true, //点击遮罩关闭层
		area : ['90%' , '90%'],
		content: contextPath+'/KQDS_UserDocumentAct/toZzWinPage.act?usercode=' + usercode
	});
});
</script>
