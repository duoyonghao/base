               	...
               	<div class="kv">
					...
					<div class="kv ">
			            ...
			            <div class="kv-v">
							 ...
							 <input type="text"  class="form-control" id="olddoctorDesc" name="olddoctorDesc" placeholder="原咨询" style="cursor:pointer;" onClick="javascript:single_select_user(['olddoctor', 'olddoctorDesc'],'',1);"  ></input>	
			        	</div>
      	 			 </div>
      	 			 <div class="kv ">
			            <label>转诊咨询</label>
			            <div class="kv-v">
							 <input type="hidden" name="toaskperson" id="toaskperson"  class="form-control" />
							 <input type="text"  class="form-control" id="toaskpersonDesc" name="toaskpersonDesc" placeholder="转诊咨询" style="cursor:pointer;"  onClick="javascript:single_select_user(['toaskperson', 'toaskpersonDesc'],'',1);"  ></input>	
			       		 </div>
			       	</div>
                </div>
            </div>
...
var pageurl = '<%=contextPath%>/KQDS_ChangeReceiveAct/selectNoPage.act';
...
function getlzjl(){
	...
	columns: [
		...
		{title: '原咨询',field: 'oldaskperson',align: 'center',valign: 'middle',sortable: true,
		...
		{title: '转诊咨询', field: 'toaskperson',align: 'center', valign: 'middle',sortable: true,
			formatter: function(value, row, index) {
	                if (value != "" && value != null) {
	                    return '<span class="name" title="' + value + '">' + value + '</span>';
	                } else {
