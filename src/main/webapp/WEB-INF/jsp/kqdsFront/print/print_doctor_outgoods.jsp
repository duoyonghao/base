			...
			<table  border=0 cellSpacing=0 cellPadding=0  width="100%"  bordercolor="#000000" style="border-collapse:collapse;margin: auto;">
				<thead>
					...
					<tr class="allborder" style="border-bottom:none;">
						<!-- <th width="9%" align="center" style="font-size:14px;border-bottom:1px solid #333;">类别</th > -->
						<th width="9%" align="center" style="font-size:14px;border-bottom:1px solid #333;">编号</b></th>
						<th width="15%" align="center" style="font-size:14px;border-bottom:1px solid #333;">名称</th>
						<th width="9%" align="center" style="font-size:14px;border-bottom:1px solid #333;">规格</th>
						<th width="5%" align="center" style="font-size:14px;border-bottom:1px solid #333;">单位</th>
						<th width="10%" align="center" style="font-size:14px;border-bottom:1px solid #333;">单价</th>
						<th width="10%" align="center" style="font-size:14px;border-bottom:1px solid #333;">数量</th>
<!-- 						<th width="15%" align="center" style="font-size:14px;border-bottom:1px solid #333;">金额</th> -->
						<th width="9%" align="center" style="font-size:14px;border-bottom:1px solid #333;">领料人</th>
						<th width="9%" align="center" style="font-size:14px;border-bottom:1px solid #333;">患者</th>
					</tr>
				</thead>
...
$(function(){
	...
	if(serverData.printName!=''){
		$("#titles").html(serverData.printName+"领料单");
	}else{
		$("#titles").html("领料单");
	}
	rkOrder();
...
function PrintNoBorderTable(){
	...
	//页眉
	LODOP.ADD_PRINT_TEXT(13,250,200,20,serverData.printName+"领料明细单");  
		...
		if(data&&data.length>0){
			...
			for(var n=0;n<data.length;n++){
				...
				str+="   <span  style=\"text-align: left;float:left;font-size:14px;\">单据编号："+
					""+obj.outcode+"</span >"+
					"<span  style=\"text-align: left;float:left;font-size:14px;\">出库仓库："+
					""+obj.housename+"</span >"+
					"<span  style=\"text-align: left;margin-right: 15px;float:left;font-size:14px;\">领料时间："+
					""+obj.cktime.substring(0,10)+"</span >"+
					"<span  style=\"text-align: center;margin-right: 15px;float:left;font-size:14px;\">出库方式："+
					""+obj.outtype+"</span >"+
					"<span  style=\"text-align: center;margin-right: 15px;float:left;font-size:14px;\">领料人："+
					""+obj.sqdeptid+"</span >"+
					"<span  style=\"text-align: center;margin-right: 15px;float:left;font-size:14px;\">供应商："+
					""+obj.suppliername+"</span >"+
					"<span style=\"text-align: center;float:left;margin-right: 15px;font-size:14px;\">附加说明："+
					""+obj.outremark+"</span >"+
					"<span  style=\"text-align: center;margin-right: 15px;float:left;font-size:14px;\">摘要："+
					""+obj.zhaiyao+"</span >";
			}
			$("#rkorder").append(str);
		}
	...
	$.axse(detailurl, null, function(data) {
		...
		if(data&&data.length>0){
			...
			for(var n=0;n<data.length;n++){
				...
				"	<td  style=\"text-align: center;font-size: 10px\">"+obj.userdocument+"</td >"+
				"  </tr>";
				nums += Number(obj.quantity);
				zmomey += Number(obj.amount);
			}
		$("#tbody").append(str);
		var toolhtml ="<tr>"+
		"   <td  style=\"text-align: center;border-top:1px solid #333;\"></td >"+
		"   <td  style=\"text-align: center;border-top:1px solid #333;\"></td >"+
		"   <td  style=\"text-align: center;border-top:1px solid #333;\"></td >"+
		"   <td  style=\"text-align: center;border-top:1px solid #333;\"></td >"+
		//"	<td  style=\"text-align: center;\"></td >"+
		"	<td  style=\"text-align: center;border-top:1px solid #333;\"></td >"+
		"	<td  style=\"text-align: center;border-top:1px solid #333;font-size:10px;\">小计："+Number(nums)+"</td >"+
		//"	<td  style=\"text-align: center;border-top:1px solid #333;font-size:10px;\">小计："+Number(zmomey).toFixed(2)+"</td>"+
		"	<td  style=\"text-align: center;border-top:1px solid #333;\"></td >"+
		"	<td  style=\"text-align: center;border-top:1px solid #333;\"></td >"+
		"  </tr>";
