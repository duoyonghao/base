...
<%
	...
	String szcardno = request.getParameter("szcardno");
	...
	String tksh = request.getParameter("tksh"); // 转赠申请列表传入 tksh=1
...
<body>
	<div id="printArea" style="text-align: center;margin:0 auto;padding:0 15px;">
		<div style="margin-top: 5px; padding-bottom: 5px;">
			<div style="height:35px;width:100%;text-align: center;">
				<span id="titles" style="font-size: 20px;font-weight:bold; /* margin-top: 30px; margin-bottom: 30px; */ display: block;"></span>
			</div>
			<table style="width:100%;border-bottom:1px solid #333;">
				<tr>
					<th style="width:33%;text-align:left;font-size:14px;">会员卡号： <%=memberno%></th>
					<th style="width:33%;text-align:left;font-size:14px;">会员姓名： <%=username%></th>
					<th style="width:33%;text-align:left;font-size:14px;">转赠时间：<%=cztime%></th>
				</tr>
			</table>
			<!-- <div style="margin-left:30px;border-bottom: 1px solid #999;"></div> -->
			<table style="width: 100%;/* margin: 30px 0 30px 0; */ text-align: left;/* margin-left:20px; */">
				
				<tr>
					<td style="width:33%;text-align:left;font-size:14px;">本次转赠充值金额：￥ <%=money%></td>
					<td style="width:33%;text-align:left;font-size:14px;">本次转赠赠送金额：￥ <%=givemoney%></td>
					<td style="width:33%;text-align:left;font-size:14px;">本次转赠小计：￥ <%=totalmoney%></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="width:33%;text-align:left;font-size:14px;">受赠人卡号： <%=szcardno%></td>
					<td style="width:33%;text-align:left;font-size:14px;">受赠人姓名： <%=szrusername%></td>
