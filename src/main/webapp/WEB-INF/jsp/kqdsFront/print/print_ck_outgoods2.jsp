			...
			<table  border=0 cellSpacing=0 cellPadding=0  width="100%"  bordercolor="#000000" style="border-collapse:collapse;margin: auto;">
				<thead>
					...
					<tr class="allborder" style="border-bottom:none;">
						...
						<th width="5%" align="center" style="font-size:14px;">类别</th >
		...
		if(data&&data.length>0){
			...
			for(var n=0;n<data.length;n++){
				...
				str+="   <span  style=\"text-align: left;float:left;font-size:14px;\">单据编号："+
					...
					""+obj.outtype+"</span >"+
					"<br/>"+"<span  style=\"text-align: center;margin-right: 15px;float:left;font-size:14px;\">领用部门："+
					""+obj.sqdeptid+"</span >"+
	...
	$.axse(detailurl, null, function(data) {
		if(data&&data.length>0){
			...
			for(var n=0;n<data.length;n++){
				var obj =data[n];
				str+="<tr>"+
				"   <td  style=\"text-align: center;font-size:14px;\">"+order+"</td >"+
				"   <td  style=\"text-align: center;font-size:14px;\">"+obj.goodstypename+"</td >"+
				"   <td  style=\"text-align: center;font-size:14px;\">"+obj.addnumber+"</td >"+
				"   <td  style=\"text-align: center;font-size:14px;\">"+obj.addtime.substring(0,10) +"</td >"+
				"   <td  style=\"text-align: center;font-size:14px;\">"+obj.goodscode+"</td >"+
				"   <td  style=\"text-align: center;font-size:14px;\">"+obj.goodsname+"</td >"+
				"   <td  style=\"text-align: center;font-size:14px;\">"+obj.goodsnorms+"</td >"+
				"	<td  style=\"text-align: center;font-size:14px;\">"+obj.goodsunit+"</td >"+
				"	<td  style=\"text-align: center;font-size:14px;\">"+obj.outnum+"</td >"+
				"	<td  style=\"text-align: center;font-size:14px;\">"+obj.ph+"</td >"+
				"	<td  style=\"text-align: center;font-size:14px;\">"+obj.llr+"</td >"+
				"	<td  style=\"text-align: center;font-size:14px;\">"+obj.sqdoctor+"</td >"+
				"  </tr>";
				order=order+1;
				nums += Number(obj.outnum);
				zmomey += Number(obj.ckmoney);
			}
		$("#tbody").append(str);
		var toolhtml ="<tr>"+
