		...
		<td class="submBtnTd" colspan="8">
			...
			<%
				...
				<%
					...
					<input type="button" class="submBtn" id="save" onclick="addblk(1);" value="添加到自用病历库">
					<input type="button" class="submBtn" id="save" onclick="addblk(0);" value="添加到标准病历库">
