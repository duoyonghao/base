...
<title>编辑病历-术后拆线病历</title>
<script type="text/javascript" src="<%=contextPath%>/static/js/kqdsFront/bingli/blk/fucha/fucha.js"></script>
...
<%@include file="../../fucha/inc/chaixian.jsp" %>
