    ...
    <form  id="form1">
	     <table class="kqds_table">
           ...
           <tr>
    			...
    			<td style="text-align:left;" colspan="5"><textarea class="form-control" style="height:200px;" name="detaildesc" id="detaildesc" rows="12"></textarea></td>
    	   </tr>
           <tr>
    			<td colspan="3" style="text-align:left;">未成交原因：
    				<select style="width:150px" class="dict" tig="wcjyy" name="failreason1" id="failreason1" ></select>	
   		 		</td>
...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "zxjl_bc" && isdelreg == 0) {
            menubutton1 += '<a href="javascript:void(0);" class="kqdsSearchBtn" id="issave" onclick="save()">保存</a>';
        }
    }
