...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "ck_baseinfo_ck") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_Ck_HouseAct/toCkHouse.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "ck_baseinfo_sp") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_Ck_GoodsAct/toCkBaseInfoGoods.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "ck_baseinfo_gys") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_Ck_SupplierAct/toSupplier.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "ck_baseinfo_ckbm") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_Ck_CkdeptAct/toCkDept.act">' + listbutton[i].name + '</li>';
        }
    }
