...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "ck_ckmanage_dqkc") {//当前库存
        ...
        } else if (listbutton[i].qxName == "ck_ckmanage_bjcx") {//报警查询
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_Ck_GoodsAct/toCkGjSearch.act">' + listbutton[i].name + '</li>';///KQDS_Ck_GoodsAct/toCkManageWarning.act
        } 
    }
