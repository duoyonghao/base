...
function getButtonPower() {
    ...
    for (var i = 0; i < listbutton.length; i++) {
        if (listbutton[i].qxName == "ck_rkmanage_rkmx") {
            ...
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/KQDS_Ck_Goods_InAct/toCkGoodsIn.act">' + listbutton[i].name + '</li>';
        } else if (listbutton[i].qxName == "ck_rkmanage_rksh") {
            menubutton += ' <li target="tabIframe" src="' + contextPath + '/HUDH_Ck_Goods_In_CheckAct/toGoodsInCheck.act">' + listbutton[i].name + '</li>';
