			            	 ...
			            	 <table class="table-striped table-condensed table-bordered" style="width:100%;">
			            	    <thead style="height:30px; background: #00A6C0 ;color:white;">
									<tr>
										...
										<th style="text-align: center; vertical-align: middle;width:auto; display: none;"><span>有效期</span></th>
	   ...
	   <div class="formBox">
 				<div class="">
               		<div class="kv">
		                ...
		                <div class="kv-v" style="padding-left: 245px" >
...
function resizeTableHeight(){
	var tableHeight=0;
    tableHeight=$(window).outerHeight()-$(".searchWrap").outerHeight()-116;
...
function addDoodsDetail(detail){
	...
	tdindex=detail[i].irows;
 	...
 	//商品有效期 16
 	 tablehtml += '<td style="width:120px;display:none;"><input type="text" readonly="readonly" style="width:100%; text-align:center;height: 20px;" name="yxdate" id="yxdate'+tdindex+'" class="yxdate"></td>';
 	 //新增明细16+1
...
//      initChukuNum(tdindex,detail.goodsid); // 初始化出库批号
