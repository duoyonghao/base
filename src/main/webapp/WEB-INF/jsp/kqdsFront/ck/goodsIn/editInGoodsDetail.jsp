...
var goodsinDetail = "";
var goodsin = "";
var goodsinid = '<%=request.getAttribute("goodsinid")%>';
$(function() {
...
function initGoodsDeatil() {
	var url = contextPath + '/KQDS_Ck_Goods_InAct/selectCkGoodsDetailByInid.act';
	var param = {
		goodsInSeqId : goodsinid
	};
	$.axse(url, param,
		    function(r) {
		       goodsinDetail = r;
		       console.log(goodsinDetail);
		    },
		    function() {
		        layer.alert('请求失败' );
		    });
...
function save(){
    ...
    var url = contextPath + '/KQDS_Ck_Goods_InAct/editGoodsInDetail.act';
    $.axse(url, paramOrder,
    function(r) {
        if (r.retState == "0") {
            layer.alert('操作成功', {
