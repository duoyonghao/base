...
// 	 console.log(JSON.stringify(beforeinprice)+"-----beforeinprice");
	 if(zczhArr){
...
// 	 console.log(JSON.stringify(zczh)+"-----zczh");
// 	 if(jobj.zczh){
// 		 zczh = jobj.zczh;
// 	 }
// 	 if(jobj.cd){
...
//      $("#total1").html(Number(total1)+1);
     ...
     //tablehtml += '<td style="width:100px;"><span id="inprice'+tdindex+'"></span></td>';
     //数量9+1
...
// 	}
    layer.open({
        ...
        //点击遮罩关闭层
        area: ['90%', '450px'],
        content: contextPath + '/KQDS_Ck_HouseAct/toGoodsHouse.act',
    });
}
               ...
               if ($(this).index() == 17) {
                   ...
                   paramDetail.goodsuuid = $(this).text();
	               	...
	               	if(inprice == ""){
	               		...
	               		if(judgeSignFloatNum(inprice)==false && judgeSignFloatNum(inprice)==false){
	               			flagStyle = false;
	               			return false;
	               		}
	               	}
	               	//var inprice = $(this).find("span").html();
                   ...
                   paramDetail.innum = innum;
	               	...
	               	//金额
            	 	/* var rkmoney = $(this).find("input").val();
	               	if(rkmoney == ""){
	               		flag = false;
	               		return false;
	               	}else{
	               		if(judgeSignFloatNum(rkmoney)==false && judgeSignFloatNum(rkmoney)==false){
	               			flagStyle = false;
	               			return false;
	               		}
	               	} */
