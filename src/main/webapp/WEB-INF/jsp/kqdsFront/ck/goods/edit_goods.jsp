	        ...
	        <table class="tableLayout">
		     	<tbody>
		     		...
		     		<tr>
		     			...
		     			<td>
		     				<input type="text" name="goodscode" id="goodscode" style="background: #C7C7C7" readonly="readonly">
		     			</td>
		     			<td>
...
$(function() {
	...
	//仓库，一级、二级分类赋值
	if(onclickrow){
		$("#sshouse").find("option").each(function(i,obj){
			if($(this).text()==onclickrow.sshousename){
				$(this).attr("selected","selected");
				getBaseTypeSelect('basetype', $(this).val());
			}
		});
		$("#basetype").find("option").each(function(i,obj){
			if($(this).text()==onclickrow.firsttype){
				$(this).attr("selected","selected");
				getNextTypeSelect('nexttype', $(this).val());
			}
		});
		$("#nexttype").find("option").each(function(i,obj){
			if($(this).text()==onclickrow.goodstypename){
				$(this).attr("selected","selected");
			}
		});
	}
